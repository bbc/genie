...
describe(`Takes screenshots on multiple viewports ${Cypress.env("THEME")}`, () => {
    sizes.forEach(size => {
        it(`screenshots each screen on the core game flow screens on a ${size} viewport`, () => {
            ...
            cy.get("canvas").screenshot(`[${size}] How To Play Screen`, {
                capture: "viewport",
                timeout: "20000",
            });
            ...
            cy.get("canvas").screenshot(`[${size}] Narrative Screen`, { capture: "viewport", timeout: "20000" });
            cy.genieClick("#narrative__pause");
            cy.safeArea("#pause__play");
            cy.get("canvas").screenshot(`[${size}] Pause Screen`, { capture: "viewport", timeout: "20000" });
            ...
            cy.get("canvas").screenshot(`[${size}] Level Select Screen`, {
                capture: "viewport",
                timeout: "20000",
            });
            ...
            cy.get("canvas").screenshot(`[${size}] Results Screen`, { capture: "viewport", timeout: "20000" });
        });
        ...
        it(`screenshots the single item select screen on a ${size} viewport`, () => {
            ...
            cy.get("canvas").screenshot(`[${size}] Select Screen Single Item`, {
                capture: "viewport",
                timeout: "20000",
            });
        });
        ...
        it(`screenshots the shop screens on a ${size} viewport`, () => {
            ...
            cy.get("canvas").screenshot(`[${size}] Shop front Screen `, {
                capture: "viewport",
                timeout: "20000",
            });
            cy.genieClick("#debug-shop-demo-shop__shop_menu_button");
            cy.safeArea("#debug-shop-demo-shop__back");
            cy.get("canvas").screenshot(`[${size}] Shop management Screen `, {
                capture: "viewport",
                timeout: "20000",
            });
            ...
            cy.genieClick("#debug-shop-demo-shop__shop_menu_button");
            cy.safeArea("#debug-shop-demo-shop__back");
            cy.get("canvas").screenshot(`[${size}] Shop store Screen `, {
                capture: "viewport",
                timeout: "20000",
            });
        });
