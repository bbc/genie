export const BASIS = (function () {
	...
	return function (BASIS) {
		...
		var wasmMemory;
		var wasmTable = new WebAssembly.Table({ initial: 157, maximum: 157 + 0, element: "anyfunc" });
		var ABORT = false;
		var EXITSTATUS = 0;
		...
		var dynCall_iiiiiiiiiiiiiiiiiiii = (Module["dynCall_iiiiiiiiiiiiiiiiiiii"] = function () {
			return (dynCall_iiiiiiiiiiiiiiiiiiii = Module["dynCall_iiiiiiiiiiiiiiiiiiii"] = Module["asm"]["ca"]).apply(
				null,
				arguments,
			);
		});
		var dynCall_iiiiiiiiiiiiiiiiiiiii = (Module["dynCall_iiiiiiiiiiiiiiiiiiiii"] = function () {
			return (dynCall_iiiiiiiiiiiiiiiiiiiii = Module["dynCall_iiiiiiiiiiiiiiiiiiiii"] =
				Module["asm"]["da"]).apply(null, arguments);
		});
		var dynCall_iiiiiiiiiiiiiiiiiii = (Module["dynCall_iiiiiiiiiiiiiiiiiii"] = function () {
			return (dynCall_iiiiiiiiiiiiiiiiiii = Module["dynCall_iiiiiiiiiiiiiiiiiii"] = Module["asm"]["ea"]).apply(
				null,
				arguments,
			);
		});
