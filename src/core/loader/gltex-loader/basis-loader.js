 ...
 *
 * Usage:
 * // basis-loader.js should be loaded from the same directory as
...
import { TranscoderWorker } from "./transcoder-worker.js";
...
if (!IN_WORKER) {
	// Main Thread
	//TODO NT this is why I had to instantiate manually although can we avoid passing by window?
...
//export const basisLoader = new BasisLoader()
