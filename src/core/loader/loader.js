...
export class Loader extends Screen {
	...
	createLoadBar() {
		this.add.image(0, this.loaderConfig?.loadingBarYPos ?? 130, "loader.loadbarBackground");
		this._loadbar = this.add.image(0, this.loaderConfig?.loadingBarYPos ?? 130, "loader.loadbar");
