...
describe("Gel Container", () => {
    ...
    describe("Resizing", () => {
        test("Resizes and positions correctly", () => {
            ...
            expect(gelContainerModule.gelDom.style.top).toEqual("100px");
            expect(gelContainerModule.gelDom.style.left).toEqual("200px");
            expect(gelContainerModule.gelDom.style.transform).toEqual("scale(5)");
        });
    });
});
