...
var fireStatsEvent = function fireStatsEvent(eventName, eventType, screen) {
  var params = {
    metadata: "PAG=[".concat(screen.pageIdx, "]"),
    source: "narrative-".concat(screen.scene.key)
  };
  gmi.sendStatsEvent(eventName, eventType, params);
};

export var Narrative = /*#__PURE__*/function (_Screen) {
  _inherits(Narrative, _Screen);

  var _super = _createSuper(Narrative);
