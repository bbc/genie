...
export var Home = /*#__PURE__*/function (_Screen) {
  ...
  _createClass(Home, [{
    ...
    value: function create() {
      var achievements = this.context.config.theme.game.achievements ? ["achievements"] : [];
      var debug = isDebug() ? ["debug"] : [];
      this.addBackgroundItems();
      var buttons = ["exit", "howToPlay", "play", "audio", "settings"];
