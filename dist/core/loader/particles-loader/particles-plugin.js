...
export var ParticlesPlugin = /*#__PURE__*/function (_Phaser$Plugins$BaseP) {
  _inherits(ParticlesPlugin, _Phaser$Plugins$BaseP);

  var _super = _createSuper(ParticlesPlugin);

  function ParticlesPlugin(pluginManager) {
    var _this;

    _classCallCheck(this, ParticlesPlugin);

    _this = _super.call(this, pluginManager);
    pluginManager.registerFileType("particles", _this.loaderCallback);
    return _this;
  }

  _createClass(ParticlesPlugin, [{
    key: "addToScene",
