!(function (t, e) {
    ...
    function e(r) {
        ...
        return function () {
            ...
            return (e = this), !(i = t) || ("object" != typeof i && "function" != typeof i) ? _(e) : i;
        };
    }
    function l(t, e) {
    ...
    function f(t, e, i, n, s, r, o, a, h) {
        var l, u, c;
        o && (r += 360), (s = O(s));
        for (var d = ((r = O(r)) - s) / a, f = 0; f <= a; f++)
            (c = s + d * f), (l = t + i * Math.cos(c)), (u = e + n * Math.sin(c)), v(l, u, h);
        return h;
    }
    var c = (function () {
            function i(t) {
                B(this, i), (this.scene = t);
            }
            return (
                w(i, null, [
                    {
                ...
                w(r, [
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            var e, i;
                            void 0 === t && (t = 0),
                                (i = "number" == typeof t ? (e = t) : ((e = d(t, "x", 0)), d(t, "y", 0)));
                            var n = this.cornerRadius;
                            return (
                                (n.tl = m(d(t, "tl", void 0), e, i)),
                                (n.tr = m(d(t, "tr", void 0), e, i)),
                                (n.bl = m(d(t, "bl", void 0), e, i)),
                                (n.br = m(d(t, "br", void 0), e, i)),
                                this
                            );
                        },
                    },
    ...
    function P(t, e, i) {
        ...
        if (
            (u &&
                (d = (function (t, e, i, n) {
                    ...
                    for (s = 0, r = e.length; s < r; s++)
                        (o = e[s] * n),
                            (a = s < r - 1 ? e[s + 1] * n : t.length),
                            (h = M(t, o, a, n, !1)) === h.next && (h.steiner = !0),
                            l.push(A(h));
                    for (l.sort(Y), s = 0; s < l.length; s++) L(l[s], i), (i = E(i, i.next));
                    return i;
                })(t, e, d, i)),
            t.length > 80 * i)
        ) {
            (n = r = t[0]), (s = o = t[1]);
            for (var v = i; v < c; v += i)
                (a = t[v]) < n && (n = a), (h = t[v + 1]) < s && (s = h), r < a && (r = a), o < h && (o = h);
            l = 0 !== (l = Math.max(r - n, o - s)) ? 1 / l : 0;
        }
        return z(d, f, i, n, s, l), f;
    }
    function M(t, e, i, n, s) {
        var r, o;
        if (s === 0 < Z(t, e, i, n)) for (r = e; r < i; r += n) o = N(r, t[r], t[r + 1], o);
        else for (r = i - n; e <= r; r -= n) o = N(r, t[r], t[r + 1], o);
        return o && U(o, o.next) && (J(o), (o = o.next)), o;
    }
    function E(t, e) {
        if (!t) return t;
        e = e || t;
        var i,
            n = t;
        do {
            if (((i = !1), n.steiner || (!U(n, n.next) && 0 !== H(n.prev, n, n.next)))) n = n.next;
            else {
                if ((J(n), (n = e = n.prev) === n.next)) break;
                i = !0;
            }
        } while (i || n !== e);
        return e;
    ...
    function z(t, e, i, n, s, r, o) {
        if (t) {
            ...
            for (var a, h, l = t; t.prev !== t.next; )
                if (((a = t.prev), (h = t.next), r ? D(t, n, s, r) : j(t)))
                    e.push(a.i / i), e.push(t.i / i), e.push(h.i / i), J(t), (t = h.next), (l = h.next);
                else if ((t = h) === l) {
                    o
                        ? 1 === o
                            ? z((t = I(t, e, i)), e, i, n, s, r, 2)
                            : 2 === o && R(t, e, i, n, s, r)
                        : z(E(t), e, i, n, s, r, 1);
                    break;
                }
    ...
    function j(t) {
        ...
        if (!(0 <= H(e, i, n))) {
            for (var s = t.next.next; s !== t.prev; ) {
                if (X(e.x, e.y, i.x, i.y, n.x, n.y, s.x, s.y) && 0 <= H(s.prev, s, s.next)) return;
                s = s.next;
            }
            return 1;
        }
        ...
        if (!(0 <= H(s, r, o))) {
            for (
                ...
                if (
                    f !== t.prev &&
                    f !== t.next &&
                    X(s.x, s.y, r.x, r.y, o.x, o.y, f.x, f.y) &&
                    0 <= H(f.prev, f, f.next)
                )
                    return;
                if (
                    ...
                    v !== t.prev &&
                        v !== t.next &&
                        X(s.x, s.y, r.x, r.y, o.x, o.y, v.x, v.y) &&
                        0 <= H(v.prev, v, v.next))
                )
                    return;
                v = v.nextZ;
    ...
    function I(t, e, i) {
        ...
        do {
            ...
            !U(s, r) &&
                ...
                W(s, r) &&
                W(r, s) &&
                (e.push(s.i / i), e.push(n.i / i), e.push(r.i / i), J(n), J(n.next), (n = t = r)),
                (n = n.next);
        } while (n !== t);
        return n;
    }
        ...
        do {
            for (var l = h.next.next; l !== h.prev; ) {
                if (
                    ...
                    var u = G(h, l);
                    return (h = E(h, h.next)), (u = E(u, u.next)), z(h, e, i, n, s, r), void z(u, e, i, n, s, r);
                }
                l = l.next;
            }
            h = h.next;
            ...
            (e = (function (t, e) {
                ...
                for (; n !== l; )
                    s >= n.x &&
                        n.x >= u &&
                        s !== n.x &&
                        X(r < c ? s : o, r, u, c, r < c ? o : s, r, n.x, n.y) &&
                        ((h = Math.abs(r - n.y) / (s - n.x)) < d || (h === d && n.x > i.x)) &&
                        W(n, t) &&
                        ((i = n), (d = h)),
                        (n = n.next);
                return i;
    ...
    function F(t, e, i, n, s) {
        return (
            (t =
                ...
                ((t =
                    858993459 &
                    ((t = 252645135 & ((t = 16711935 & ((t = 32767 * (t - i) * s) | (t << 8))) | (t << 4))) |
                        (t << 2))) |
                    (t << 1))) |
            ((e =
                1431655765 &
                ((e =
                    858993459 &
                    ((e = 252645135 & ((e = 16711935 & ((e = 32767 * (e - n) * s) | (e << 8))) | (e << 4))) |
                        (e << 2))) |
                    (e << 1))) <<
                1)
        );
    ...
    function V(t, e, i, n) {
        return (
            (U(t, e) && U(i, n)) ||
            (U(t, n) && U(i, e)) ||
            (0 < H(t, e, i) != 0 < H(t, e, n) && 0 < H(i, n, t) != 0 < H(i, n, e))
        );
    }
    function W(t, e) {
        return H(t.prev, t, t.next) < 0
            ? 0 <= H(t, e, t.next) && 0 <= H(t, t.prev, e)
            : H(t, e, t.prev) < 0 || H(t, t.next, e) < 0;
    }
    function G(t, e) {
    ...
    (P.deviation = function (t, e, i, n) {
        var s = e && e.length,
            r = s ? e[0] * i : t.length,
            o = Math.abs(Z(t, 0, r, i));
        if (s)
            for (var a = 0, h = e.length; a < h; a++) {
                var l = e[a] * i,
                    u = a < h - 1 ? e[a + 1] * i : t.length;
                o -= Math.abs(Z(t, l, u, i));
            }
        var c = 0;
        for (a = 0; a < n.length; a += 3) {
            var d = n[a] * i,
                f = n[a + 1] * i,
                v = n[a + 2] * i;
            c += Math.abs((t[d] - t[v]) * (t[1 + f] - t[1 + d]) - (t[d] - t[f]) * (t[1 + v] - t[1 + d]));
        }
        return 0 === o && 0 === c ? 0 : Math.abs((c - o) / o);
    }),
        (P.flatten = function (t) {
            for (
                var e = t[0][0].length, i = { vertices: [], holes: [], dimensions: e }, n = 0, s = 0;
                s < t.length;
                s++
            ) {
    ...
    function q(t, e, i, n, s) {
        ...
        t.setPipeline(r),
            ...
            o.copyFrom(n.matrix),
            s
                ? (o.multiplyWithOffset(s, -n.scrollX * e.scrollFactorX, -n.scrollY * e.scrollFactorY),
                  (a.e = e.x),
                  (a.f = e.y))
                : ((a.e -= n.scrollX * e.scrollFactorX), (a.f -= n.scrollY * e.scrollFactorY)),
            o.multiply(a, h);
        var l = e._displayOriginX,
            u = e._displayOriginY,
            c = n.alpha * e.alpha;
        e.isFilled && Q(r, h, e, c, l, u), e.isStroked && et(r, e, c, l, u);
    }
    var $ = Phaser.Renderer.WebGL.Utils,
        Q = function (t, e, i, n, s, r) {
            for (
                var o = $.getTintAppendFloatAlphaAndSwap(i.fillColor, i.fillAlpha * n),
                    a = i.pathData,
                    h = i.pathIndexes,
                    l = 0;
                l < h.length;
                ...
                var u = 2 * h[l],
                    ...
                    w = e.getX(y, m),
                    S = e.getY(y, m);
                t.setTexture2D(), t.batchTri(x, b, k, C, w, S, 0, 0, 1, 1, o, o, o, t.tintEffect);
            }
        },
        tt = Phaser.Renderer.WebGL.Utils,
        et = function (t, e, i, n, s) {
            var r = t.strokeTint,
                o = tt.getTintAppendFloatAlphaAndSwap(e.strokeColor, e.strokeAlpha * i);
            ...
            for (var f = 2; f < h; f += 2) {
                var v = a[f] - n,
                    p = a[f + 1] - s;
                t.setTexture2D(),
                    t.batchLine(c, d, v, p, u, u, l, f - 2, !!e.closePath && f === h - 1),
                    (c = v),
                    (d = p);
            }
        },
        ...
        st = Phaser.Renderer.Canvas.SetTransform,
        rt = {
            renderWebGL: q,
            renderCanvas: function (t, e, i, n, s) {
                var r = t.currentContext;
                if (st(t, r, e, n, s)) {
                    var o = e._displayOriginX,
                        a = e._displayOriginY,
                        h = e.pathData,
                        l = h.length - 1,
                        u = h[0] - o,
                        c = h[1] - a;
                    r.beginPath(), r.moveTo(u, c), e.closePath || (l -= 2);
                    for (var d = 2; d < l; d += 2) {
                        var f = h[d] - o,
                            v = h[d + 1] - a;
                        r.lineTo(f, v);
                    ...
                    r.closePath(),
                        e.isFilled && (it(r, e), r.fill()),
                        e.isStroked && (nt(r, e), r.stroke()),
                        r.restore();
                }
            },
        },
        ...
        at = (function () {
            t(d, Phaser.GameObjects.Shape);
            var c = e(d);
            function d(t, e, i, n, s, r, o, a) {
                var h;
                B(this, d), void 0 === e && (e = 0), void 0 === i && (i = 0);
                var l = ot(r, "iteration", void 0);
                r = ot(r, "radius", r);
                var u = new k(0, 0, n, s, r);
                return (
                    (h = c.call(this, t, "RoundRectangle", u)).setIteration(l),
                    h.setPosition(e, i),
                    void 0 !== o && h.setFillStyle(o, a),
                ...
                w(d, [
                    {
                        ...
                        value: function () {
                            ...
                            if (((i = n.br), ht(i))) {
                                var r = t.width - i.x,
                                    o = t.height - i.y;
                                f(r, o, i.x, i.y, 0, 90, !1, s, e);
                            } else v(t.width, t.height, e);
                            if (((i = n.bl), ht(i))) {
                                (r = i.x), (o = t.height - i.y);
                                f(r, o, i.x, i.y, 90, 180, !1, s, e);
                            } else v(0, t.height, e);
                            if (((i = n.tl), ht(i))) {
                                (r = i.x), (o = i.y);
                                f(r, o, i.x, i.y, 180, 270, !1, s, e);
                            } else v(0, 0, e);
                            if (((i = n.tr), ht(i))) {
                                (r = t.width - i.x), (o = i.y);
                                f(r, o, i.x, i.y, 270, 360, !1, s, e);
                            } else v(t.width, 0, e);
                    ...
                    },
                    {
                        ...
                        set: function (t) {
                            void 0 !== this._iteration
                                ? this._iteration !== t && ((this._iteration = t), this.updateData())
                                : (this._iteration = t);
                        },
                    },
                    {
    ...
    c.register("roundRectangle", function (t, e, i, n, s, r, o) {
        var a = new at(this.scene, t, e, i, n, s, r, o);
        return this.scene.add.existing(a), a;
    }),
        ut(window, "RexPlugins.UI.RoundRectangle", at);
    function ct(t) {
        var e = mt.create(this),
            i = e.getContext("2d");
        t.syncFont(e, i);
        ...
        if (
            ...
            return (o.ascent = h), (o.descent = h + 6), (o.fontSize = o.ascent + o.descent), mt.remove(e), o;
        var u,
            c,
        ...
        for (o.ascent = h - u, p = f - v, g = !1, u = l; h < u; u--) {
            for (c = 0; c < v; c += 4)
                if (255 !== d[p + c]) {
                    g = !0;
                    break;
        ...
        return (o.descent = u - h), (o.fontSize = o.ascent + o.descent), mt.remove(e), o;
    }
    function dt(t) {
    ...
    function pt(t, e, i, n, s) {
        n <= 0 && (i = qt);
        var r = te;
        if ((ee.pushMultiple(r), !t || !t.length)) return r;
        for (var o, a, h, l = t.split(Qt), u = 0, c = l.length; u < c; u++)
            if (((o = l[u]), (h = u === c - 1 ? Jt : Kt), i !== qt)) {
                var d, f;
                if (((a = 0 === u ? n - s : n), o.length <= 100))
                    if ((b = e(o)) <= a) {
                        r.push(ee.newline(o, b, h));
                        continue;
                    }
                for (var v, p = "", g = "", y = 0, m = 0, x = (d = i === $t ? o.split(" ") : o).length; m < x; m++)
                    (f = d[m]),
                        i === $t ? ((p += f), m < x - 1 && (p += " ")) : (p += f),
                        a < (v = e(p)) &&
                            (0 === m
                                ? r.push(ee.newline("", 0, Zt))
                                : (r.push(ee.newline(g, y, Zt)),
                                  (p = f),
                                  i === $t && m < x - 1 && (p += " "),
                                  (v = e(p))),
                            (a = n)),
    ...
    var gt = Phaser.Renderer.WebGL.Utils,
        yt = {
            renderWebGL: function (t, e, i, n, s) {
                if (0 !== e.width && 0 !== e.height) {
                    var r = e.frame,
                        o = r.width,
                        a = r.height,
                        h = gt.getTintAppendFloatAlpha;
                    this.pipeline.batchTexture(
                        ...
                        o,
                        a,
                        h(e._tintTL, n.alpha * e._alphaTL),
                        h(e._tintTR, n.alpha * e._alphaTR),
                        h(e._tintBL, n.alpha * e._alphaBL),
                        h(e._tintBR, n.alpha * e._alphaBR),
                        e._isTinted && e.tintFill,
                        0,
                        0,
                        n,
                        s,
        ...
        mt = Phaser.Display.Canvas.CanvasPool,
        xt = 0,
        bt = 1,
        kt = 2,
        Ct = 0,
        ...
        St = 2,
        Ot = /(?:\r\n|\r|\n)/,
        Tt = Phaser.Utils.Objects.GetAdvancedValue,
        ...
        Et = (function () {
            function n(t, e) {
                B(this, n),
                    ...
                    this._font,
                    this.setStyle(e, !1);
                var i = Pt(e, "metrics", !1);
                this.metrics = i
                    ? { ascent: Pt(i, "ascent", 0), descent: Pt(i, "descent", 0), fontSize: Pt(i, "fontSize", 0) }
                    : ct(this);
            }
            return (
                w(n, [
                    {
                        ...
                        value: function (t, e) {
                            ...
                            Mt))
                                this[s] = ("wrapCallback" === s || "wrapCallbackScope" === s ? Pt : Tt)(
                                    t,
                                    Mt[s][0],
                                    Mt[s][1],
                                );
                            var r = Pt(t, "font", null);
                            this._font = null === r ? this.fontStyle + " " + this.fontSize + " " + this.fontFamily : r;
                            var o = Pt(t, "fill", null);
                        ...
                        value: function (t) {
                            return (
                                "string" == typeof t
                                    ...
                                    : ((this.fontFamily = Pt(t, "fontFamily", "Courier")),
                                      (this.fontSize = Pt(t, "fontSize", "16px")),
                                      (this.fontStyle = Pt(t, "fontStyle", ""))),
                                this.update(!0)
                            );
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            return (
                                "number" == typeof t && (t = t.toString() + "px"), (this.fontSize = t), this.update(!0)
                            );
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            return (
                                "string" == typeof t && (t = zt[t.toLowerCase()] || 0),
                                (this.wrapMode = t),
                                this.update(!0)
                            );
                        },
        ...
        zt = { none: Ct, word: wt, char: St, character: St },
        Bt = {
            draw: function (t, e, i, n) {
                var s = this.penManager;
                this.hitAreaManager.clear();
                var r = this.context;
                r.save(), this.drawBackground(this.defatultStyle.backgroundColor);
                ...
                (u =
                    (l =
                        0 < m && m < y
                            ? ((h = m), "center" === v ? Math.floor((y - h) / 2) : "bottom" === v ? y - h : 0)
                            : ((h = y), 0)) + h),
                    (d =
                        "center" === v
                            ? Math.max((n - h * p) / 2, 0)
                ...
                for (var x = l; x < u; x++)
                    if (0 !== (a = s.getLineWidth(x))) {
                        ...
                        for (var b = g[x], k = 0, C = b.length; k < C; k++) this.drawPen(b[k], c, d);
                    }
                r.restore();
            },
            drawPen: function (t, e, i) {
                ...
                var n = this.canvas,
                    s = this.context;
                s.save();
                var r = this.parser.propToContextStyle(this.defatultStyle, t.prop);
                r.buildFont(),
                    r.syncFont(n, s),
                    r.syncStyle(n, s),
            ...
            drawBackground: function (t) {
                null !== t &&
                    ((this.context.fillStyle = t), this.context.fillRect(0, 0, this.canvas.width, this.canvas.height));
            },
            ...
            drawText: function (t, e, i, n) {
                this.autoRound && ((t = Math.round(t)), (e = Math.round(e)));
                var s = this.context;
                n.strokeThickness && (n.syncShadow(s, n.shadowStroke), s.strokeText(i, t, e)),
        ...
        jt = Phaser.Utils.Objects.GetValue,
        Dt = xt,
        It = bt,
        Rt = (function () {
            function e(t) {
                ...
                w(e, [
                    {
                        ...
                        value: function (t) {
                            (this.text = jt(t, "text", "")),
                                (this.x = jt(t, "x", 0)),
                                (this.y = jt(t, "y", 0)),
                                (this.width = jt(t, "width", 0));
                            var e = jt(t, "prop", null);
                            null === e && (e = {}),
                                (this.prop = e),
                                (this.newLineMode = jt(t, "newLineMode", 0)),
                                (this.startIndex = jt(t, "startIndex", 0));
                        },
                    },
                    {
                        key: "plainText",
        ...
        Yt = Phaser.Utils.Objects.GetFastValue,
        Lt = xt,
        Ft = kt,
        At = new _t(),
        Xt = new _t(),
        Ht = (function () {
            function a(t) {
                B(this, a),
                    ...
                    (this.PensPool = Yt(t, "pensPool", At)),
                    (this.LinesPool = Yt(t, "linesPool", Xt)),
                    (this.tagToText = Yt(t, "tagToText", vt)),
                    (this.tagToTextScope = Yt(t, "tagToTextScope", void 0));
            }
            return (
                w(a, [
                    {
                    ...
                    },
                    {
                        ...
                        value: function (t, e, i, n) {
                            return this.addTextPen("", t, e, i, n, Lt), this;
                        },
                    },
                    {
                        key: "addNewLinePen",
                        value: function () {
                            var t = this.lastPen,
                                ...
                                i = t ? t.y : 0,
                                n = t ? ft(t.prop) : null;
                            return this.addTextPen("", e, i, 0, n, Ft), this;
                        },
                    },
                    {
                        key: "addPen",
                        value: function (t) {
                            ...
                            null == i && ((i = this.LinesPool.pop() || []), this.lines.push(i)),
                                i.push(t),
                                t.newLineMode !== Lt && ((i = this.LinesPool.pop() || []), this.lines.push(i)),
                                (this.maxLinesWidth = void 0);
                        },
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            for (var e = 0, i = this.lines.length; e < i; e++)
                                for (var n = this.lines[e], s = 0, r = n.length; s < r; s++) {
                                    var o = n[s];
                                    t.addPen(o.text, o.x, o.y, o.width, ft(o.prop), o.newLineMode);
                                }
                            return t;
                        },
                    },
                        ...
                        value: function (t, e, i) {
                            ...
                            for (
                                ...
                                ((a = (s = this.pens[c]).endIndex) <= t ||
                                    ...
                                    this.tagToTextScope
                                        ? (u += this.tagToText.call(this.tagToTextScope, r, h, l))
                                        : (u += this.tagToText(r, h, l)),
                                    (l = h),
                                    !(e <= a)));
                                c++
                            );
                    ...
                    },
                    {
                        key: "rawTextLength",
                        get: function () {
                            for (var t = 0, e = this.pens, i = 0, n = this.pens.length; i < n; i++)
                                t += e[i].rawTextLength;
                            return t;
                        },
                    },
            ...
            return (
                w(t, [
                    ...
                    },
                    {
                        key: "clear",
                        value: function () {
                            return Wt.pushMultiple(this.hitAreas), this;
                        },
                    },
                    {
                        key: "add",
                        value: function (t, e, i, n, s) {
                            var r = Wt.pop();
                            return (
                                null === r ? (r = new Vt(e, i, n, s)) : r.setTo(e, i, n, s),
                                (r.key = t),
                    ...
                    },
                    {
                        ...
                        value: function (t, e, i) {
                            ...
                            for (var n, s = this.hitAreas, r = 0, o = s.length; r < o; r++)
                                (n = s[r]), t.lineStyle(1, e).strokeRect(n.x, n.y, n.width, n.height);
        ...
        te = [],
        ee = new _t();
    ee.newline = function (t, e, i) {
        var n = this.pop();
        return null === n && (n = {}), (n.text = t), (n.width = e), (n.newLineMode = i), n;
    };
    var ie = Phaser.Utils.Objects.GetValue,
        ne = Ct,
        se = xt,
        re = (function () {
            function i(t) {
                B(this, i),
                    ...
                    (this.context = ie(t, "context", null)),
                    (this.canvas = this.context.canvas),
                    (this.parser = ie(t, "parser", null)),
                    (this.defatultStyle = ie(t, "style", null)),
                    (this.autoRound = !0),
                    (this.pensPool = ie(t, "pensPool", null)),
                    (this.penManager = this.newPenManager()),
                    (this._tmpPenManager = null),
                    (this.hitAreaManager = new Gt());
                var e = this.context;
                ...
                w(i, [
                        ...
                        value: function (t, e, i, n, s) {
                            ...
                            for (
                                var r,
                                    ...
                                    d = 0,
                                    f = 0,
                                    v = this.parser.splitText(t),
                                    p = 0,
                                    g = v.length;
                                p < g;
                                p++
                            )
                                if (((r = (h = this.parser.tagTextToProp(v[p], o)).plainText), (o = h.prop).img)) {
                                    var y = this.imageManager.getOuterWidth(o.img);
                                    0 < i && e !== ne && i < d + y && (s.addNewLinePen(), (f += n), (d = 0)),
                                        s.addImagePen(d, f, y, ft(o)),
                                        (d += y);
                                } else if ("" !== r) {
                                    var m;
                                    this.context.save(),
                                        (a = this.parser.propToContextStyle(this.defatultStyle, o)).buildFont(),
                                        a.syncFont(u, c),
                                        a.syncStyle(u, c);
                                    for (var x = 0, b = (l = pt(r, this.getTextWidth, e, i, d)).length; x < b; x++)
                                        (m = l[x]),
                                            s.addTextPen(m.text, d, f, m.width, ft(o), m.newLineMode),
                                            m.newLineMode !== se ? ((d = 0), (f += n)) : (d += m.width);
                    ...
                    },
                    {
                        ...
                        value: function (t, e, i, n) {
                            ...
                            return (
                                this.updatePenManager(t, r.wrapMode, r.wrapWidth, r.lineHeight, s),
                    ...
                    },
                    {
                        ...
                        get: function () {
                            ...
                            return 0 < t && (e -= this.defatultStyle.lineSpacing), e;
                        },
                    },
                    {
                        key: "imageManager",
                    ...
                    },
                    {
                        ...
                        get: function () {
                            return (
                                null === this._tmpPenManager && (this._tmpPenManager = this.newPenManager()),
                                this._tmpPenManager
                            );
                        },
                    },
            ...
            setInteractive: function () {
                this.parent
                    ...
                    .on(
                        "pointerup",
                        function (t, e, i, n) {
                            Nt.call(this, "areaup", t, e, i);
                        },
                        this,
                    );
            },
        };
    Object.assign(re.prototype, Bt, oe);
    var ae,
                ...
                w(e, [
                    {
                        ...
                        value: function (t, e) {
                            ...
                            else if (Array.isArray(t)) for (var i = 0, n = (s = t).length; i < n; i++) this._add(s[i]);
                            else {
                                var s = t;
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            return (
                                this.images.hasOwnProperty(t) || (this.textureManager.exists(t) && this.add(t)),
                                this.images[t]
                            );
                        },
                    },
    ...
    var ue = Phaser.DOM.AddToDOM,
        ce = Phaser.Display.Canvas.CanvasPool,
        de = Phaser.GameObjects.GameObject,
        fe = Phaser.Utils.Objects.GetValue,
        ...
        ye = (function () {
            ...
            function u(t, e, i, n, s, r, o) {
                ...
                return (
                    ...
                    (a.height = 1),
                    (a.dirty = !1),
                    0 === a.style.resolution && (a.style.resolution = t.sys.game.config.resolution),
                    ...
                    a.renderer.gl &&
                        (a.renderer.deleteTexture(a.frame.source.glTexture), (a.frame.source.glTexture = null)),
                    ge.hasOwnProperty(r) || (ge[r] = new _t()),
                    (a.canvasText = new re({
                        parent: _(a),
                        context: a.context,
                        parser: o,
                ...
                w(u, [
                    {
                        ...
                        value: function () {
                            this.style.rtl &&
                                ...
                                ue(this.canvas, this.scene.sys.canvas),
                                (this.originX = 1));
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function (t, e, i, n) {
                            if ("object" === b(t)) {
                                var s = t,
                                    r = fe(s, "x", null);
                                i = null !== r ? (t = r) : ((t = fe(s, "left", 0)), fe(s, "right", t));
                                var o = fe(s, "y", null);
                                n = null !== o ? (e = o) : ((e = fe(s, "top", 0)), fe(s, "bottom", e));
                            } else
                                void 0 === t && (t = 0),
                                    void 0 === e && (e = t),
                                    void 0 === i && (i = t),
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            var n,
                                ...
                                r = this.padding;
                            0 === i.fixedWidth
                                ? ((this.width = e.linesWidth + r.left + r.right), (n = e.linesWidth))
                                : ((this.width = i.fixedWidth),
                                  (n = this.width - r.left - r.right) < e.linesWidth && (n = e.linesWidth)),
                                0 === i.fixedHeight
                            ...
                            l.width !== o || l.height !== a
                                ? ((l.width = o), (l.height = a), this.frame.setSize(o, a))
                                : u.clearRect(0, 0, o, a),
                                u.save(),
                                u.scale(h, h),
                            ...
                            return (
                                c &&
                                    !c.customHitArea &&
                                    ((c.hitArea.width = this.width), (c.hitArea.height = this.height)),
                                this
                            );
                        },
                    },
                    ...
                    },
                    {
                        key: "preDestroy",
                        value: function () {
                            this.style.rtl && ve(this.canvas), ce.remove(this.canvas), this.canvasText.destroy();
                        },
                    },
                    {
                        key: "setInteractive",
                        value: function (t, e, i) {
                            return (
                                de.prototype.setInteractive.call(this, t, e, i), this.canvasText.setInteractive(), this
                            );
                        },
                    },
                    {
                        key: "getWrappedText",
                        value: function (t, e, i) {
                            return (t = this.canvasText.getText(t, e, i, !0)).split(pe);
                        },
                    },
                    {
                        key: "getPlainText",
                    ...
                    },
                    {
                        key: "imageManager",
                        get: function () {
                            return (t = this.scene.textures), void 0 === ae && (ae = new le(t)), ae;
                            var t;
                        },
                    },
                ]),
    ...
    var xe = { plainText: null, prevProp: null },
        be = new Et(),
        ke = {},
        Ce = {
            splitText: function (t, e) {
                for (var i, n, s = [], r = 0, o = t.length, a = o; (i = Oe.exec(t)); )
                    (n = i[0]),
                        r < (a = Oe.lastIndex - n.length) && s.push(t.substring(r, a)),
                        void 0 === e && s.push(n),
                        (r = Oe.lastIndex);
                return r < o && s.push(t.substring(r, o)), s;
            },
            tagTextToProp: function (t, e) {
                ...
                null == e && (e = {}),
                    ...
                    (i = Te.test(t)
                        ...
                        ? (we(e, Ge, "i"), "")
                        : ze.test(t)
                        ? ((n = t.match(ze)), we(e, Ne, "size", n[1] + "px"), "")
                        : Be.test(t)
                        ? (we(e, Ge, "size"), "")
                        : _e.test(t)
                        ? ((n = t.match(_e)), we(e, Ne, "color", n[1]), "")
                        : je.test(t)
                        ? (we(e, Ge, "color"), "")
                        : De.test(t)
                        ? ((n = t.match(De)), we(e, Ne, "u", !0), "")
                        : Ie.test(t)
                        ? ((n = t.match(Ie)), we(e, Ne, "u", n[1]), "")
                        : Re.test(t)
                        ? (we(e, Ge, "u"), "")
                        : Ye.test(t)
                        ? (we(e, Ne, "shadow", !0), "")
                        ...
                        ? (we(e, Ne, "stroke", !0), "")
                        : Ae.test(t)
                        ? ((n = t.match(Ae)), we(e, Ne, "stroke", n[1]), "")
                        : Xe.test(t)
                        ? (we(e, Ge, "stroke"), "")
                        : He.test(t)
                        ? ((n = t.match(He)), we(e, Ne, "img", n[1]), "")
                        : Ue.test(t)
                        ? (we(e, Ge, "img"), "")
                        : Ve.test(t)
                        ? ((n = t.match(Ve)), we(e, Ne, "area", n[1]), "")
                        : We.test(t)
                        ? (we(e, Ge, "area"), "")
                        : t);
                var s = xe;
                ...
                return (
                    e.hasOwnProperty("shadow")
                        ...
                        : ((i.shadowColor = "#000"),
                          ...
                          (i.shadowFill = !1)),
                    e.hasOwnProperty("u")
                        ? (!0 === e.u ? (i.underlineColor = t.underlineColor) : (i.underlineColor = e.u),
            ...
            propToTagText: function (t, e, i) {
                for (var n in (null == i && (i = ke), i)) e.hasOwnProperty(n) || (t = "[/" + n + "]" + t);
                var s = "";
                for (var n in e)
                    i[n] !== e[n] &&
                        ("size" === n
        ...
        we = function (t, e, i, n) {
            return e === Ne ? (t[i] = n) : t.hasOwnProperty(i) && delete t[i], t;
        },
        Se = function (t, e) {
            return t && e ? "bold italic" : t ? "bold" : e ? "italic" : "";
        },
        Oe = /\[b\]|\[\/b\]|\[i\]|\[\/i\]|\[size=(\d+)\]|\[\/size\]|\[color=([a-z]+|#[0-9abcdef]+)\]|\[\/color\]|\[u\]|\[u=([a-z]+|#[0-9abcdef]+)\]|\[\/u\]|\[shadow\]|\[\/shadow\]|\[stroke\]|\[stroke=([a-z]+|#[0-9abcdef]+)\]|\[\/stroke\]|\[img=([^\]]+)\]|\[\/img\]|\[area=([^\]]+)\]|\[\/area\]/gi,
        Te = /\[b\]/i,
        Pe = /\[\/b\]/i,
        Me = /\[i\]/i,
        Ee = /\[\/i\]/i,
        ...
        Je = (function () {
            ...
            function o(t, e, i, n, s) {
                return B(this, o), r.call(this, t, e, i, n, s, "rexBBCodeText", Ce);
            }
            return o;
        })();
    c.register("BBCodeText", function (t, e, i, n) {
        var s = new Je(this.scene, t, e, i, n);
        return this.scene.add.existing(s), s;
    }),
        ut(window, "RexPlugins.UI.BBCodeText", Je);
    var Ke = { plainText: null, prevProp: null },
        Ze = new Et(),
        qe = (function () {
            function e(t) {
            ...
            return (
                w(e, [
                    ...
                    },
                    {
                        key: "splitText",
                        value: function (t, e) {
                            for (var i, n, s, r = [], o = 0, a = t.length, h = a; (i = ti.exec(t)); )
                                (n = i[0]),
                                    o < (h = ti.lastIndex - n.length) && r.push(t.substring(o, h)),
                                    void 0 === e
                                        ? r.push(n)
                                        : 1 === e &&
                                          (ei.test(n)
                                              ? ((s = n.match(ii)), r.push(s[2]))
                                              : ni.test(n) && ((s = n.match(si)), r.push(s[2]))),
                                    (o = ti.lastIndex);
                            return o < a && r.push(t.substring(o, a)), r;
                        },
                    },
                    {
                        key: "tagTextToProp",
                        value: function (t) {
                            ...
                            if (ei.test(t)) {
                                ...
                                var r;
                                if (null != (r = t.match(si))) {
                                    var o = r[1];
                                    ((i = $e(o))._style = o), (e = r[2]);
                                }
                            }
                            null == e && (e = t), null == i && (i = {});
                            var a = Ke;
                            ...
                            if (e.hasOwnProperty("img")) i.image = e.img;
                                ...
                                if (
                                    ...
                                    var s = e.hasOwnProperty("size")
                                        ...
                                        ? e.fontSize
                                        : e["font-size"];
                                    "number" == typeof s && (s = s.toString() + "px"), (i.fontSize = s);
                                } else i.fontSize = t.fontSize;
                                if (
                                ...
                                if (e.hasOwnProperty("stroke")) {
                                    ...
                                    (i.stroke = a.hasOwnProperty("color") ? a.color : t.stroke),
                                        (i.strokeThickness = a.hasOwnProperty("thinkness")
                                            ? a.thinkness
                                            : t.strokeThickness);
        ...
        $e = function (t) {
            for (var e, i, n, s = {}, r = 0, o = (t = t.split(";")).length; r < o; r++)
                if (((i = (e = t[r].split(":"))[0]), (n = e[1]), !Qe(i) && !Qe(n))) {
                    switch (i) {
                        case "stroke":
                            var a = n.split(" ");
                            (n = {}),
                                1 <= (l = a.length) && (n.color = a[0]),
                                2 <= l && (n.thinkness = parseInt(a[1].replace("px", "")));
                            break;
                        case "shadow":
                            var h = n.split(" ");
                            (n = {}),
                                1 <= (l = h.length) && (n.color = h[0]),
                                2 <= l && (n.offsetX = parseInt(h[1].replace("px", ""))),
                                3 <= l && (n.offsetY = parseInt(h[2].replace("px", ""))),
                                4 <= l && (n.blur = parseInt(h[3].replace("px", "")));
                            break;
                        case "u":
                        case "underline":
                            var l,
        ...
        Qe = function (t) {
            return 0 === (t = t.replace(ri, "")).length;
        },
        ti = /<\s*class=["|']([^"|']+)["|']\s*\>([\s\S]*?)<\s*\/class\s*\>|<\s*style=["|']([^"|']+)["|']\s*\>([\s\S]*?)<\s*\/style\s*\>/g,
        ei = /<\s*class=/i,
        ii = /<\s*class=["|']([^"|']+)["|']\s*\>([\s\S]*?)<\s*\/class\s*\>/,
        ni = /<\s*style=/i,
        si = /<\s*style=["|']([^"|']+)["|']\s*\>([\s\S]*?)<\s*\/style\s*\>/,
        ri = /^\s+|\s+$/,
            ...
            return (
                w(l, [
                    ...
                    },
                    {
                        key: "preDestroy",
                        value: function () {
                            g(p(l.prototype), "preDestroy", this).call(this),
                                this.parser.destroy(),
                                (this.parser = void 0);
                        },
                    },
    ...
    c.register("tagText", function (t, e, i, n) {
        var s = new ai(this.scene, t, e, i, n);
        return this.scene.add.existing(s), s;
    }),
        ut(window, "RexPlugins.UI.TagText", ai);
    var hi = Phaser.GameObjects.Zone,
        li = Phaser.Utils.Array.Add,
        ui = Phaser.Utils.Array.Remove,
        ci = (function () {
            t(a, hi);
            var o = e(a);
                ...
                w(a, [
                    {
                        key: "destroy",
                        value: function (t) {
                            this.scene && (this.clear(!t), g(p(a.prototype), "destroy", this).call(this, t));
                        },
                    },
                    {
                        key: "contains",
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            for (var e, i = 0, n = this.children.length; i < n; i++)
                                (e = this.children[i]).off("destroy", this.remove, this), t && e.destroy();
        ...
        di = Phaser.GameObjects.Components;
    Phaser.Class.mixin(ci, [di.Alpha, di.Flip]);
    function fi(t) {
        var e;
        return t.hasOwnProperty("rexContainer") && (e = t.rexContainer.parent), e;
    }
    function vi(t) {
        for (var e = fi(t); e; ) e = fi((t = e));
        return t;
    }
    function pi(t) {
        return (
    ...
    var mi = {
            setParent: function (t, e) {
                void 0 === e && (e = this);
                var i = this.getLocalState(t);
                return e ? ((i.parent = e), (i.self = t)) : ((i.parent = null), (i.self = null)), this;
            },
            getParent: function (t) {
                return void 0 === t && (t = this), fi(t);
            },
            getTopmostParent: function (t) {
                return void 0 === t && (t = this), vi(t);
            },
        },
        xi = ci.prototype.add,
        bi = {
            add: function (t) {
                return Array.isArray(t) ? this.addMultiple(t) : pi.call(this, t), this;
            },
            addMultiple: function (t) {
                for (var e = 0, i = t.length; e < i; e++) pi.call(this, t[e]);
                return this;
            },
        },
        ki = ci.prototype.remove,
        Ci = ci.prototype.clear,
        wi = {
            remove: function (t, e) {
                return this.getParent(t) !== this || (this.setParent(t, null), ki.call(this, t, e)), this;
            },
            clear: function (t) {
        ...
        Si = Phaser.Math.RotateAround,
        Oi = {
            worldToLocal: function (t) {
                return (
                    (t.x -= this.x),
                    (t.y -= this.y),
                    Si(t, 0, 0, -this.rotation),
                    (t.x /= this.scaleX),
                    (t.y /= this.scaleY),
                    (t.x *= this.flipX ? -1 : 1),
                    (t.y *= this.flipY ? -1 : 1),
        ...
        Ti = {
            updateChildPosition: function (t) {
                ...
                return (
                    ...
                    void 0 !== t.flipX &&
                        ((t.flipX = this.flipX ? !e.flipX : e.flipX), (t.flipY = this.flipY ? !e.flipY : e.flipY)),
            ...
            resetChildPositionState: function (t) {
                ...
                return (
                    ...
                    (e.y = t.y),
                    this.worldToLocal(e),
                    (e.scaleX = gi(t.scaleX, this.scaleX)),
                    (e.scaleY = gi(t.scaleY, this.scaleY)),
        ...
        Pi = {
            updateChildVisible: function (t) {
                var e = this.getLocalState(t),
                    i = !e.hasOwnProperty("maskVisible") || e.maskVisible;
                return (t.visible = this.visible && e.visible && i), this;
            },
            ...
            setChildMaskVisible: function (t, e) {
                return (
                    void 0 === e && (e = !0), (this.getLocalState(t).maskVisible = e), this.updateChildVisible(t), this
                );
            },
        },
        Mi = {
            ...
            resetChildAlphaState: function (t) {
                return (this.getLocalState(t).alpha = gi(t.alpha, this.alpha)), this;
            },
        ...
        zi = {
            updateChildMask: function (t) {
                return (
                    null == this.mask ||
                        ((this.mask.hasOwnProperty("geometryMask") ? this.mask.geometryMask : this.mask.bitmapMask) !==
                            t &&
                            (t.mask = this.mask)),
                    this
                );
        ...
        _i = {
            ...
            getAllChildren: function (t) {
                ...
                for (var e, i = this.children, n = 0, s = i.length; n < s; n++) {
                    if (((e = i[n]), t.push(e), e.hasOwnProperty("isRexContainerLite")))
                        t.push.apply(t, h(e.getAllChildren()));
                }
                return t;
            },
            contains: function (t) {
            ...
            getByName: function (t, e) {
                ...
                return Bi.GetFirst(this.children, "name", t);
            },
            getRandom: function (t, e) {
                return Bi.GetRandom(this.children, t, e);
            },
            getFirst: function (t, e, i, n) {
                return Bi.GetFirstElement(this.children, t, e, i, n);
            },
            getAll: function (t, e, i, n) {
                return Bi.GetAll(this.children, t, e, i, n);
            },
            count: function (t, e, i, n) {
                return Bi.CountAllMatching(this.children, t, e, i, n);
            },
            swap: function (t, e) {
                return Bi.Swap(this.children, t, e), this;
            },
            moveTo: function (t, e) {
                return Bi.MoveTo(this.children, t, e), this;
            },
            setAll: function (t, e, i, n) {
                return Bi.SetAll(this.children, t, e, i, n), this;
            },
        },
        ji = {
            tweenChild: function (t) {
                ...
                for (var i, n, s = [], r = 0, o = e.length; r < o; r++)
                    (n = e[r]).hasOwnProperty("rexContainer") && ((i = n.scene), s.push(n.rexContainer));
                if (i) {
                    t.targets = s;
                    var a = i.tweens.add(t);
                    return (
                        a.on("update", function (t, e, i) {
                            for (var n, s, r = 0, o = i.length; r < o; r++)
                                switch (((n = i.parent), (s = i.self), e)) {
                                    case "x":
                                    case "y":
                                    case "angle":
                                    case "rotation":
    ...
    var Ii = (function () {
        ...
        function h(t, e, i, n, s, r) {
            ...
            return (
                B(this, h),
                ((o = a.call(this, t, e, i, n, s)).type = "rexContainerLite"),
            ...
            w(h, [
                {
                    ...
                    value: function (t) {
                        this.scene &&
                            ((this.syncChildrenEnable = !1), g(p(h.prototype), "destroy", this).call(this, t));
                    },
                },
                {
                    key: "resize",
                ...
                },
                {
                    key: "rotation",
                    get: function () {
                        return g(p(h.prototype), "rotation", this);
                    },
                    set: function (t) {
                        this.rotation !== t && (s(p(h.prototype), "rotation", t, this, !0), this.syncPosition());
                    },
                },
                {
                    key: "scaleX",
                    get: function () {
                        return g(p(h.prototype), "scaleX", this);
                    },
                    set: function (t) {
                        this.scaleX !== t && (s(p(h.prototype), "scaleX", t, this, !0), this.syncPosition());
                    },
                },
                {
                    key: "scaleY",
                    get: function () {
                        return g(p(h.prototype), "scaleY", this);
                    },
                    set: function (t) {
                        this.scaleY !== t && (s(p(h.prototype), "scaleY", t, this, !0), this.syncPosition());
                    },
                },
                {
                    key: "flipX",
                    get: function () {
                        return g(p(h.prototype), "flipX", this);
                    },
                    set: function (t) {
                        g(p(h.prototype), "flipX", this) !== t &&
                            (s(p(h.prototype), "flipX", t, this, !0), this.syncPosition());
                    },
                },
                {
                    key: "flipY",
                    get: function () {
                        return g(p(h.prototype), "flipY", this);
                    },
                    set: function (t) {
                        g(p(h.prototype), "flipY", this) !== t &&
                            (s(p(h.prototype), "flipY", t, this, !0), this.syncPosition());
                    },
                },
                {
                    key: "visible",
                    get: function () {
                        return g(p(h.prototype), "visible", this);
                    },
                    set: function (t) {
                        g(p(h.prototype), "visible", this) !== t &&
                            (s(p(h.prototype), "visible", t, this, !0), this.syncVisible());
                    },
                },
                {
                    key: "alpha",
                    get: function () {
                        return g(p(h.prototype), "alpha", this);
                    },
                    set: function (t) {
                        g(p(h.prototype), "alpha", this) !== t &&
                            (s(p(h.prototype), "alpha", t, this, !0), this.syncAlpha());
                    },
                },
                {
                    key: "active",
    ...
    Object.assign(Ii.prototype, Di),
        c.register("container", function (t, e, i, n, s) {
            var r = new Ii(this.scene, t, e, i, n, s);
            return this.scene.add.existing(r), r;
        }),
        ut(window, "RexPlugins.UI.Container", Ii);
    var Ri = Phaser.Renderer.WebGL.Utils,
        Yi = {
            renderWebGL: function (t, e, i, n, s) {
        ...
        Ai = {
            updateTexture: function (t, e) {
                ...
                var i = this.input;
                return (
                    i && !i.customHitArea && ((i.hitArea.width = this.width), (i.hitArea.height = this.height)), this
                );
            },
            generateTexture: function (t, e, i, n, s) {
                ...
                var l = (r = a.textures.exists(t)
                    ? a.textures.get(t)
                    : a.textures.createCanvas(t, n, s)).getSourceImage();
                l.width !== n && (l.width = n), l.height !== s && (l.height = s);
                var u = l.getContext("2d");
                return (
                    u.clearRect(0, 0, n, s),
                    u.drawImage(o, e, i, n, s),
                    h.gl && r && h.canvasToTexture(l, r.source[0].glTexture, !0, 0),
                    this
                );
            },
        ...
        Xi = Phaser.Display.Canvas.CanvasPool,
        Hi = Phaser.GameObjects.GameObject,
        Ui = (function () {
            t(a, Hi);
            var o = e(a);
            function a(t, e, i, n, s) {
                ...
                return (
                    ...
                    (r.resolution = t.sys.game.config.resolution),
                    (r.canvas = Xi.create(_(r), r.resolution * n, r.resolution * s)),
                    ...
                    r.renderer.gl &&
                        (r.renderer.deleteTexture(r.frame.source.glTexture), (r.frame.source.glTexture = null)),
                    (r.dirty = !0),
                    t.sys.game.events.on(
                        "contextrestored",
                        function () {
                        ...
                        value: function (t, e) {
                            return (
                                (this.width === t && this.height === e) ||
                                    (this.setSize(t, e).updateDisplayOrigin(),
                                    (t *= this.resolution),
                                    (e *= this.resolution),
                                    (t = Math.max(Math.ceil(t), 1)),
                                    (e = Math.max(Math.ceil(e), 1)),
                                    (this.canvas.width = t),
        ...
        Vi = Phaser.GameObjects.Components;
    Phaser.Class.mixin(Ui, [
        Vi.Alpha,
        Vi.BlendMode,
        Vi.ComputedSize,
        Vi.Crop,
        ...
        c.register("canvas", function (t, e, i, n) {
            var s = new Ui(this.scene, t, e, i, n);
            return this.scene.add.existing(s), s;
        }),
        ut(window, "RexPlugins.UI.Canvas", Ui);
    var Wi = Phaser.Math.DegToRad,
        Gi = Wi(0),
        Ni = Wi(90),
        Ji = Wi(180),
        Ki = Wi(270),
        ...
        qi = Phaser.Utils.Objects.GetValue,
        $i = (function () {
            t(h, Ui);
            var a = e(h);
            function h(t, e, i, n, s, r) {
                ...
                w(h, [
                    {
                        ...
                        value: function (t, e, i) {
                            var n, s;
                            if (
                                ("object" === b(e) && ((i = e), (e = void 0)),
                                (s =
                                    "string" == typeof i
                                        ? void (n = i)
                                        : ((n = qi(i, "maskType", 0)), qi(i, "backgroundColor", void 0))),
                                void 0 === n ? (n = 0) : "string" == typeof n && (n = Qi[n]),
                                (this._textureKey = t),
                                (this._frameName = e),
                                null === n)
                            )
                            ...
                            switch (
                                (y.save(),
                                (y.globalCompositeOperation = r ? "source-over" : "destination-in"),
                                y.beginPath(),
                                n)
                            ) {
                                case 0:
                                    (c = y),
                                        ...
                                        (v = Math.floor(d / 2)),
                                        (p = Math.floor(f / 2)),
                                        c.arc(v, p, Math.min(v, p), 0, 2 * Math.PI);
                                    break;
                                case 1:
                                    (o = y),
                                        (a = m),
                                        ...
                                        (l = Math.floor(a / 2)),
                                        (u = Math.floor(h / 2)),
                                        o.ellipse(l, u, l, u, 0, 0, 2 * Math.PI);
                                    break;
                                case 2:
                                    !(function (t, e, i, n) {
                                        void 0 === n && (n = Math.min(Math.floor(e / 2), Math.floor(i / 2)));
                                        var s,
                                            r,
                                            o,
                                            a = new k(0, 0, e, i, n),
                                        ...
                                        (s = h.br),
                                            ...
                                            (o = a.height - s.y),
                                            Zi(s)
                                                ? t.ellipse(r, o, s.x, s.y, 0, Gi, Ni)
                                                : (t.moveTo(a.width, o),
                                                  t.lineTo(a.width, a.height),
                                                  t.lineTo(r, a.height)),
                                            (r = (s = h.bl).x),
                                            (o = a.height - s.y),
                                            t.lineTo(s.x, a.height),
                                            Zi(s)
                                                ? t.ellipse(r, o, s.x, s.y, 0, Ni, Ji)
                                                : (t.lineTo(0, a.height), t.lineTo(0, o)),
                                            (r = (s = h.tl).x),
                                            (o = s.y),
                                            t.lineTo(0, o),
                                            Zi(s)
                                                ? t.ellipse(r, o, s.x, s.y, 0, Ji, Ki)
                                                : (t.lineTo(0, 0), t.lineTo(r, 0)),
                                            (s = h.tr),
                                            (r = a.width - s.x),
                                            (o = s.y),
                                            t.lineTo(r, 0),
                                            Zi(s)
                                                ? t.ellipse(r, o, s.x, s.y, 0, Ki, Gi)
                                                : (t.lineTo(a.width, 0), t.lineTo(a.width, o)),
                                            t.closePath();
                                    })(y, m, x, qi(i, "radius", void 0));
                            }
                            return (
                                r && (y.fillStyle = s),
                                y.fill(),
        ...
        Qi = { circle: 0, ellipse: 1, roundRectangle: 2 };
    c.register("circleMaskImage", function (t, e, i, n, s) {
        var r = new $i(this.scene, t, e, i, n, s);
        return this.scene.add.existing(r), r;
    }),
        ut(window, "RexPlugins.UI.CircleMaskImage", $i);
    var tn = function (e, t) {
        ...
        en = (function () {
            ...
            function h(t, e, i, n, s, r) {
                ...
                return (
                    B(this, h),
                    ((o = a.call(this, t, e, i, n, s)).type = "rexChart"),
                ...
                w(h, [
                    {
                        ...
                        value: function (t) {
                            this.scene &&
                                ...
                                g(p(h.prototype), "destroy", this).call(this, t));
                        },
                    },
                    {
                        key: "resize",
                        value: function (t, e) {
                            ...
                            if ((g(p(h.prototype), "resize", this).call(this, t, e), this.chart)) {
                                var i = this.chart;
        ...
        nn = {
            setChart: function (t) {
                if (window.Chart)
                    return (
                        this.chart && this.chart.destroy(), (this.chart = new Chart(this.context, tn(this, t))), this
                    );
                return (
                    console.error(
    ...
    Object.assign(en.prototype, nn),
        c.register("chart", function (t, e, i, n, s) {
            var r = new en(this.scene, t, e, i, n, s);
            return this.scene.add.existing(r), r;
        }),
        ut(window, "RexPlugins.UI.Chart", en);
    function sn(t, e, i) {
        return (
            void 0 === i && (i = "image"),
            t[e] ||
    ...
    var on = Phaser.Utils.Objects.IsPlainObject,
        an = Phaser.Utils.Objects.GetValue,
        hn = function (t) {
            return "string" == typeof t && (t = ln[t]), t;
        },
        ln = { scale: 0, repeat: 1 },
        un = {
            setTexture: function (t, e, i, n) {
                yi(e) && ((n = i), (i = e), (e = void 0)),
                    void 0 === e && (e = "__BASE"),
                    (this.textureKey = t),
                ...
                for (var r = s.frames[e], o = r.width, a = 0, h = 0, l = i.length; h < l; h++)
                    void 0 === i[h] ? a++ : "number" == typeof i[h] ? (o -= i[h]) : (o -= i[h].width);
                var u = o / a,
                    c = r.height,
                    d = 0;
                for (h = 0, l = n.length; h < l; h++)
                    void 0 === n[h] ? d++ : "number" == typeof n[h] ? (c -= n[h]) : (c -= n[h].width);
                for (var f, v, p, g, y, m = c / d, x = 0, b = 0, k = 0, C = n.length; k < C; k++) {
                    void 0 === n[k] && (n[k] = m),
                        "number" == typeof n[k] && (n[k] = { height: n[k], stretch: k % 2 }),
                        (p = (f = n[k]).height),
                    ...
                    for (var w = i.length; h < w; h++)
                        void 0 === i[h] && (i[h] = u),
                            "number" == typeof i[h] && (i[h] = { width: i[h], stretch: h % 2 }),
                            (g = (v = i[h]).width),
                            0 === k &&
                                ((this.columns.stretch += 0 | v.stretch),
                                (this.columns.minWidth += 0 < v.stretch ? 0 : g)),
                            1 <= g && 1 <= p
                                ? (y = this.getFrameNameCallback(h, k, e)) && s.add(y, 0, x + r.cutX, b + r.cutY, g, p)
                                : console.warn(
                                      "Size of Grid("
                                          .concat(h, ",")
                                          .concat(k, ") = ")
            ...
            updateTexture: function () {
                ...
                for (var d, f = 0, v = 0, p = 0, g = this.rows.count; p < g; p++) {
                    u = 0 === (h = this.rows.data[p]).stretch ? h.height * r : s * h.stretch;
                    for (var y = (f = 0), m = this.columns.count; y < m; y++)
                        (l = 0 === (a = this.columns.data[y]).stretch ? a.width * i : e * a.stretch),
                            (o = this.getFrameNameCallback(y, p, this.baseFrameName)) &&
                                0 < l &&
                                0 < u &&
                                t.has(o) &&
                                (0 === ((0 === h.stretch && 0 === a.stretch) || 0 === this.getStretchMode(y, p) ? 0 : 1)
                                    ? (d = sn(this, "_image", "image"))
                                          .setTexture(this.textureKey, o)
                                          .setDisplaySize(l, u)
                                    : (d = sn(this, "_tileSprite", "tileSprite"))
                                          .setTexture(this.textureKey, o)
                                          .setSize(l, u)),
            ...
            setStretchMode: function (t) {
                return (
                    on(t)
                        ? ((this.stretchMode.edge = hn(an(t, "edge", 0))),
                          (this.stretchMode.internal = hn(an(t, "internal", 0))))
                        : ((t = hn(t)), (this.stretchMode.edge = t), (this.stretchMode.internal = t)),
                    this
                );
            },
        ...
        cn = Phaser.GameObjects.RenderTexture,
        dn = Phaser.Utils.Objects.IsPlainObject,
                ...
                return (
                    ...
                    dn(e)
                        ? ((e = fn((l = e), "x", 0)),
                          ...
                          (s = fn(l, "height", 1)),
                          (r = fn(l, "key", void 0)),
                          (o = fn(l, "baseFrame", void 0)),
                          (a = fn(l, "columns", void 0)),
                          (h = fn(l, "rows", void 0)))
                        : dn(n)
                        ? ((n = fn((l = n), "width", 1)),
                          (s = fn(l, "height", 1)),
                        ...
                        ? ((r = fn((l = r), "key", void 0)),
                          ...
                          (h = fn(l, "rows", void 0)))
                        : dn(o)
                        ? ((o = fn((l = o), "baseFrame", void 0)),
                          (a = fn(l, "columns", void 0)),
                          (h = fn(l, "rows", void 0)))
                        : yi(o)
                        ? ((l = h), (h = a), (a = o), (o = fn(l, "baseFrame", void 0)))
                        : dn(a) && ((a = fn((l = a), "columns", void 0)), (h = fn(l, "rows", void 0))),
                    ...
                    (u._image = void 0),
                    u.setOrigin(0.5, 0.5),
                    u.setGetFrameNameCallback(fn(l, "getFrameNameCallback", void 0)),
                    u.setStretchMode(fn(l, "stretchMode", 0)),
                    u.setTexture(r, o, a, h),
                    u
                );
            }
            return (
                w(d, [
                    {
                        ...
                        value: function (t) {
                            return void 0 === t && (t = rn), (this.getFrameNameCallback = t), this;
                        },
                    },
                    {
                        key: "resize",
                        value: function (t, e) {
                            return (
                                (this.width === t && this.height === e) ||
                                    (g(p(d.prototype), "resize", this).call(this, t, e), this.updateTexture()),
                                this
                            );
                        },
                    },
    ...
    Object.assign(vn.prototype, un),
        c.register("ninePatch", function (t, e, i, n, s, r, o, a) {
            var h = new vn(this.scene, t, e, i, n, s, r, o, a);
            return this.scene.add.existing(h), h;
        }),
        ut(window, "RexPlugins.UI.NinePatch", vn);
    function pn(t) {
        return t.hasOwnProperty("rexSizer") || (t.rexSizer = {}), t.rexSizer;
    }
    function gn(t, e) {
        void 0 === e && (void 0 === yn && (yn = new Phaser.Geom.Rectangle()), (e = yn));
        var i = t.game.config;
        return e.setTo(0, 0, i.width, i.height), e;
    }
    var yn,
        mn = Phaser.Display.Align,
        xn = {
            center: mn.CENTER,
            left: mn.LEFT_CENTER,
            right: mn.RIGHT_CENTER,
            top: mn.TOP_CENTER,
            bottom: mn.BOTTOM_CENTER,
            "left-top": mn.TOP_LEFT,
            "left-center": mn.LEFT_CENTER,
            "left-bottom": mn.BOTTOM_LEFT,
            "center-top": mn.TOP_CENTER,
            "center-center": mn.CENTER,
            "center-bottom": mn.BOTTOM_CENTER,
            "right-top": mn.TOP_RIGHT,
            "right-center": mn.RIGHT_CENTER,
            "right-bottom": mn.BOTTOM_RIGHT,
        },
        bn = new Phaser.GameObjects.Zone({ sys: { queueDepthSort: vt, events: { once: vt } } }, 0, 0, 1, 1);
    bn.setOrigin(0);
    function kn(t) {
    ...
    var In = 0,
        ...
        Hn = 12,
        Un = [];
    (Un[11] = function (t, e, i, n) {
        return void 0 === i && (i = 0), void 0 === n && (n = 0), Tn(t, Sn(e) + i), On(t, wn(e) + n), t;
    }),
        (Un[Xn] = function (t, e, i, n) {
            return void 0 === i && (i = 0), void 0 === n && (n = 0), Mn(t, Pn(e) - i), On(t, wn(e) + n), t;
        }),
        (Un[Hn] = function (t, e, i, n) {
            return void 0 === i && (i = 0), void 0 === n && (n = 0), zn(t, En(e) + i), On(t, wn(e) + n), t;
        }),
        (Un[Fn] = function (t, e, i, n) {
            var s, r, o;
            return (
                void 0 === i && (i = 0),
                void 0 === n && (n = 0),
        ...
        (Un[Ln] = function (t, e, i, n) {
            return void 0 === i && (i = 0), void 0 === n && (n = 0), Mn(t, Pn(e) - i), Bn(t, _n(e) + n), t;
        }),
        (Un[An] = function (t, e, i, n) {
            return void 0 === i && (i = 0), void 0 === n && (n = 0), zn(t, En(e) + i), Bn(t, _n(e) + n), t;
        }),
        (Un[Rn] = function (t, e, i, n) {
            return void 0 === i && (i = 0), void 0 === n && (n = 0), Tn(t, Sn(e) + i), Dn(t, jn(e) - n), t;
        }),
        (Un[In] = function (t, e, i, n) {
            return void 0 === i && (i = 0), void 0 === n && (n = 0), Mn(t, Pn(e) - i), Dn(t, jn(e) - n), t;
        }),
        (Un[Yn] = function (t, e, i, n) {
            return void 0 === i && (i = 0), void 0 === n && (n = 0), zn(t, En(e) + i), Dn(t, jn(e) - n), t;
        });
    ...
    function Wn(t, e) {
        return (
            ...
            "number" == typeof t
                ...
                : ((e.left = is(t, "left", 0)),
                  (e.right = is(t, "right", 0)),
                  (e.top = is(t, "top", 0)),
                  (e.bottom = is(t, "bottom", 0))),
            e
        );
    }
    function Gn(t, e) {
    ...
    function Zn(t) {
        return Kn(t)
            ...
            : t.scene && Kn(t.scene)
            ? t.scene
            : t.parent && t.parent.scene && Kn(t.parent.scene)
            ? t.parent.scene
            : void 0;
    }
    function qn(t) {
    ...
    var $n = Phaser.Utils.Objects.GetValue,
        Qn = Phaser.GameObjects.Group,
        ts = function (t) {
            return t.add.text(0, 0, "");
        },
        es = new Phaser.Geom.Rectangle(),
        ...
        ss = {
            ...
            addBackground: function (t, e, i) {
                return (
                    ...
                    (this.getSizerConfig(t).padding = Wn(e)),
            ...
            return (
                w(i, [
                    ...
                    },
                    {
                        key: "anchor",
                        value: function () {
                            return (this.viewport = Jn(this.scene, !0)), this.updatePosition(), this;
                        },
                    },
                    {
                        key: "updatePosition",
                        value: function () {
                            ...
                            return (
                                null === this.alignX
                                    ? (t.x = this.anchorX)
                                    : void 0 !== this.alignX &&
                                      (t.x = this.anchorX + t.displayWidth * (t.originX - this.alignX)),
                                null === this.alignY
                                    ? (this.gameObject.y = this.anchorY)
                                    : void 0 !== this.alignY &&
                                      (t.y = this.anchorY + t.displayHeight * (t.originY - this.alignY)),
                                this
                            );
                        },
                    },
        ...
        ls = {
            ...
            removeListener: function () {
                return (
                    this._eventEmitter && this._eventEmitter.removeListener.apply(this._eventEmitter, arguments), this
                );
            },
            removeAllListeners: function () {
                return (
                    this._eventEmitter && this._eventEmitter.removeAllListeners.apply(this._eventEmitter, arguments),
                    this
                );
            },
        ...
        us = Phaser.Scene,
        cs = Phaser.GameObjects.GameObject,
        ds = Phaser.Utils.Objects.GetValue,
        fs = (function () {
            function n(t, e) {
                B(this, n), (this.parent = t), (this.scene = Zn(t));
                var i = ds(e, "eventEmitter", !1);
                ...
                w(n, [
                    {
                        ...
                        value: function () {
                            qn(this.parent)
                                ? this.parent.once && this.parent.on("destroy", this.destroy, this)
                                : Kn(this.parent) && this.parent.events.once("shutdown", this.destroy, this);
                        },
                    },
                    {
                        key: "shutdown",
                        value: function () {
                            return (
                                this.stop(),
                                Kn(this.parent) && this.parent.events.off("shutdown", this.destroy, this),
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            return (
                                this.isRunning ||
                                    ((this.tween = this.scene.tweens.add(t).on("complete", this.complete, this)),
                                    !1 === this.getEventEmitter() && this.setEventEmitter(this.tween)),
                                this
                            );
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function () {
                            return (
                                this.tween &&
                                    (this.getEventEmitter() === this.tween && this.setEventEmitter(!1),
                                    this.tween.remove(),
                                    (this.tween = void 0)),
                                this
                            );
    ...
    function ps(t) {
        return vs(t, "complete");
    }
    function gs(t, e, i, n, s) {
        return (
            !(!t || !t.getBounds) &&
            !(n && !n(t, e, i)) &&
            !!(Ws = t.getBounds(Ws)).contains(e, i) &&
            !(s && !s(t, e, i))
        );
    }
    function ys(t, e, i, n) {
        if (e) return gs(t, e.x, e.y, i, n);
        for (var s = t.scene.input.manager, r = s.pointersTotal, o = s.pointers, a = 0; a < r; a++)
            if (((e = o[a]), gs(t, e.x, e.y, i, n))) return !0;
        return !1;
    }
    function ms(t) {
    ...
    function ks(t, e, i) {
        !t ||
            (void 0 === e && void 0 === i) ||
            (t.resize
                ? (void 0 === e && (e = t.width), void 0 === i && (i = t.height), t.resize(e, i))
                : (void 0 !== e && (t.displayWidth = e), void 0 !== i && (t.displayHeight = i)));
    }
    var Cs = Phaser.Utils.Objects.GetValue,
        ws = Phaser.Utils.Objects.GetAdvancedValue,
        Ss = (function () {
            t(s, fs);
            var n = e(s);
            function s(t, e) {
                ...
                w(s, [
                    {
                        ...
                        value: function (t) {
                            return (
                                this.setMode(Cs(t, "mode", 0)),
                                this.setScaleRange(ws(t, "start", void 0), ws(t, "end", 0)),
                                this.setDelay(ws(t, "delay", 0)),
                                this.setDuration(ws(t, "duration", 1e3)),
                                this.setEase(Cs(t, "ease", void 0)),
                                this
                            );
                        },
                    },
                    ...
                    },
                    {
                        key: "setMode",
                        value: function (t) {
                            return "string" == typeof t && (t = Os[t]), (this.mode = t), this;
                        },
                    },
                    {
                        key: "setScaleRange",
                        value: function (t, e) {
                            return (
                                "number" == typeof t
                                    ...
                                    : ((this.startX = ws(t, "x", this.gameObject.scaleX)),
                                      (this.startY = ws(t, "y", this.gameObject.scaleY))),
                                "number" == typeof e
                                    ? ((this.endX = e), (this.endY = e))
                                    : ((this.endX = ws(e, "x", void 0)), (this.endY = ws(e, "y", void 0))),
                                this
                            );
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            return (
                                void 0 !== this.startX &&
                                    void 0 !== this.endX &&
                                    ((this.gameObject.scaleX = this.startX), (t.scaleX = this.endX)),
                                void 0 !== this.startY &&
                                    void 0 !== this.endY &&
                                    ((this.gameObject.scaleY = this.startY), (t.scaleY = this.endY)),
                                g(p(s.prototype), "start", this).call(this, t),
                                this
                            );
                        },
                    },
                    {
                        ...
                        value: function () {
                            return (
                                g(p(s.prototype), "complete", this).call(this),
        ...
        Os = { stop: 0, destroy: 1, yoyo: 2 },
        Ts = {},
        Ps = Phaser.Utils.Objects.IsPlainObject,
        Ms = {
            popUp: function (t, e, i) {
                ...
                (this._scale = (function (t, e, i, n, s) {
                    ...
                    return (
                        (Ts.end = 1),
                        (Ts.duration = e),
                        (Ts.ease = void 0 === n ? "Cubic" : n),
                        void 0 === s ? (s = new Ss(t, Ts)) : s.resetFromJSON(Ts),
                        s.restart(),
                        s
                    );
            ...
            popUpPromise: function (t, e, i) {
                return this.popUp(t, e, i), ps(this._scale);
            },
            scaleDownDestroy: function (t, e, i, n) {
                ...
                (this._scale = (function (t, e, i, n, s, r) {
                    s instanceof Ss && ((r = s), (s = void 0)), void 0 === s && (s = !0);
                    var o = {};
                    ...
                    return (
                        ...
                        void 0 === r ? (r = new Ss(t, o)) : r.resetFromJSON(o),
                        r.restart(),
                        r
                    );
            ...
            scaleDownDestroyPromise: function (t, e, i, n) {
                return this.scaleDownDestroy(t, e, i, n), ps(this._scale);
            },
            scaleDown: function (t, e, i) {
                return this.scaleDownDestroy(t, e, i, !1), this;
            },
            scaleDownPromise: function (t, e, i) {
                return this.scaleDown(t, e, i), ps(this._scale);
            },
        },
        Es = Phaser.Utils.Objects.GetValue,
        zs = Phaser.Utils.Objects.GetAdvancedValue,
        Bs = (function () {
            t(s, fs);
            var n = e(s);
            function s(t, e) {
                ...
                w(s, [
                    {
                        ...
                        value: function (t) {
                            return (
                                this.setMode(Es(t, "mode", 0)),
                                this.setAlphaRange(zs(t, "start", this.gameObject.alpha), zs(t, "end", 0)),
                                this.setDelay(zs(t, "delay", 0)),
                                this.setDuration(zs(t, "duration", 1e3)),
                                this
                            );
                        },
                    },
                    ...
                    },
                    {
                        key: "shutdown",
                        value: function () {
                            return g(p(s.prototype), "shutdown", this).call(this), (this.gameObject = void 0), this;
                        },
                    },
                    {
                        key: "setMode",
                        value: function (t) {
                            return "string" == typeof t && (t = _s[t]), (this.mode = t), this;
                        },
                    },
                    {
                        key: "setAlphaRange",
                        ...
                        value: function () {
                            return (
                                this.isRunning ||
                                    ...
                                    g(p(s.prototype), "start", this).call(this, {
                                        targets: this.gameObject,
                                        alpha: this.alphaEnd,
                                        delay: this.delay,
                                        duration: this.duration,
        ...
        _s = { stop: 0, destroy: 1, yoyo: 2 },
        js = Phaser.Utils.Objects.IsPlainObject,
        Ds = {},
        Is = {},
        Rs = Phaser.Utils.Objects.IsPlainObject,
        Ys = {
            fadeIn: function (t, e) {
                var i, n, s, r, o, a;
                Rs(t) && (t = t.duration);
                (this._fade =
                    ...
                    (Ds.end = a),
                    (Ds.duration = n),
                    void 0 === r ? (r = new Bs(i, Ds)) : r.resetFromJSON(Ds),
                    r.restart(),
                    r)),
                    this._fade.once(
                        "complete",
            ...
            fadeInPromoise: function (t, e) {
                return this.fadeIn(t, e), ps(this._fade);
            },
            fadeOutDestroy: function (t, e) {
                ...
                (this._fade =
                    ...
                    (r = e),
                    (o = (n = this)._fade),
                    r instanceof Bs && ((o = r), (r = void 0)),
                    void 0 === r && (r = !0),
                    (Is.mode = r ? 1 : 0),
                    (Is.end = 0),
                    (Is.duration = s),
                    void 0 === o ? (o = new Bs(n, Is)) : o.resetFromJSON(Is),
                    o.restart(),
                    o)),
                    this._fade.once(
                        "complete",
            ...
            fadeOutDestroyPromise: function (t, e) {
                return this.fadeOutDestroy(t, e), ps(this._fade);
            },
            fadeOut: function (t) {
                return this.fadeOutDestroy(t, !1), this;
            },
            fadeOutPromise: function (t) {
                return this.fadeOut(t), ps(this._fade);
            },
        },
        Ls = Phaser.Utils.Objects.GetValue,
        Fs = Phaser.Utils.Objects.GetAdvancedValue,
        As = (function () {
            t(s, fs);
            var n = e(s);
            function s(t, e) {
                ...
                w(s, [
                    {
                        ...
                        value: function (t) {
                            if (
                                (this.setMode(Ls(t, "mode", 0)), t && (t.hasOwnProperty("x") || t.hasOwnProperty("y")))
                            ) {
                                var e = Fs(t, "x", void 0),
                                    i = Fs(t, "y", void 0);
                            ...
                            return (
                                this.setDelay(Fs(t, "delay", 0)),
                                this.setDuration(Fs(t, "duration", 1e3)),
                                this.setEase(Ls(t, "ease", void 0)),
                                this
                            );
                        },
                    },
                    ...
                    },
                    {
                        key: "setMode",
                        value: function (t) {
                            return "string" == typeof t && (t = Xs[t]), (this.mode = t), this;
                        },
                    },
                    {
                        ...
                        value: function (t, e) {
                            if ("number" == typeof t || "number" == typeof e)
                                ...
                                var i = t;
                                (this.startX = Fs(i, "startX", void 0)),
                                    (this.startY = Fs(i, "startY", void 0)),
                                    (this.endX = Fs(i, "endX", void 0)),
                                    (this.endY = Fs(i, "endY", void 0));
                            }
                            return this;
                        },
                    },
        ...
        Vs = {
            moveFrom: function (t, e, i, n, s) {
                ...
                (this._easeMove = (function (t, e, i, n, s, r, o) {
                    r instanceof As && ((o = r), (r = void 0)), void 0 === r && (r = !1);
                    var a = {};
                    return (
                        (a.mode = r ? 1 : 0),
                        void 0 !== i && ((a.startX = Hs(i, t.x)), (a.endX = t.x)),
                        void 0 !== n && ((a.startY = Hs(n, t.y)), (a.endY = t.y)),
                        (a.duration = e),
                        (a.ease = void 0 === s ? "Linear" : s),
                        void 0 === o ? (o = new As(t, a)) : o.resetFromJSON(a),
                        o.restart(),
                        o
                    );
            ...
            moveTo: function (t, e, i, n, s) {
                ...
                (this._easeMove = (function (t, e, i, n, s, r, o) {
                    ...
                    return (
                        (a.mode = r ? 1 : 0),
                        void 0 !== i && ((a.startX = t.x), (a.endX = Hs(i, t.x))),
                        void 0 !== n && ((a.startY = t.y), (a.endY = Hs(n, t.y))),
                        (a.duration = e),
                        (a.ease = void 0 === s ? "Linear" : s),
                        void 0 === o ? (o = new As(t, a)) : o.resetFromJSON(a),
                        o.restart(),
        ...
        Js = Phaser.Display.Align.CENTER,
        Ks = function (t, e, i) {
        ...
        Zs = {
            ...
            drawBounds: function (t, e) {
                ...
                if ("number" == typeof e) i = e;
                    ...
                    i = $n(e, "color", 16777215);
                    var a = $n(e, "name", !1);
                    a &&
                        ((n = $n(a, "createTextCallback", ts)),
                        (s = $n(a, "createTextCallbackScope", void 0)),
                        "string" == typeof (r = $n(a, "align", "left-top")) && (r = xn[r]));
                }
                if (n && !t.children) {
                    (t.children = new Qn(o)),
                        t.on("destroy", function () {
                ...
                for (var l, u, c = this.getAllChildren([this]), d = 0, f = c.length; d < f; d++)
                    (l = c[d]).getBounds &&
                        (i && t.lineStyle(1, i).strokeRectShape(l.getBounds(es)),
                        l.name &&
                            n &&
                            (u = s ? n.call(s, o) : n(o)) &&
                            (u.setText(l.name),
                            t.children.add(u),
                            bn.setPosition(es.x, es.y).setSize(es.width, es.height),
                            Vn(u, bn, r)));
                return this;
            },
            ...
            preLayout: function (t) {
                if (!t) {
                    this._layoutInit();
                    for (var e, i = this.getChildrenSizers(), n = 0, s = i.length; n < s; n++)
                        !(e = i[n]).rexSizer.hidden && e.dirty && e.preLayout();
                }
            },
            _layoutInit: Nn,
            layout: function () {
                ...
                if (void 0 !== this.backgroundChildren)
                    for (
                        ...
                        (e = (t = a[d]).rexSizer).hidden ||
                            ((n = h + (i = e.padding).left),
                            (s = l + i.top),
                            (r = u - i.left - i.right),
                            (o = c - i.top - i.bottom),
                            ks(t, r, o),
                            bn.setPosition(n, s).setSize(r, o),
                            Vn(t, bn, Js),
                            this.resetChildPositionState(t));
            },
            postLayout: function () {
            ...
            setAnchor: function (t) {
                return void 0 === this._anchor ? (this._anchor = new hs(this, t)) : this._anchor.resetFromJSON(t), this;
            },
            isInTouching: function (t, e) {
                return void 0 === e && (e = this), ys(e, t);
            },
            pointToChild: function (t, e, i, n, s) {
                if (
                    ...
                    for (var r, o = 0, a = s.length; o < a; o++) if (((r = s[o]), xs(r, t, e, i, n))) return r;
                } else for (var h in s) if (((r = s[h]), xs(r, t, e, i, n))) return r;
                return null;
            },
            setDraggable: function (t, e) {
                ...
                return (
                    "string" === i
                        ? (t = this.getElement(t))
                        : (void 0 !== t && "object" == i) || ((e = t), (t = this)),
                    void 0 === e && (e = !0),
                    t.input && t.input.hasOwnProperty("draggable")
                        ? (t.input.draggable = e)
                        : e && (t.setInteractive(), t.scene.input.setDraggable(t), t.on("drag", Ks, this)),
                    this
                );
            },
        };
    ...
    var qs = Phaser.Utils.Objects.GetValue,
        $s = (function () {
            t(l, Ii);
            var h = e(l);
            function l(t, e, i, n, s, r) {
                var o;
                B(this, l),
                    ((o = h.call(this, t, e, i, 2, 2)).isRexSizer = !0),
                    o.setMinSize(n, s),
                    o.setName(qs(r, "name", "")),
                    (o.rexSizer = {}),
                    (o.backgroundChildren = void 0),
                    (o.sizerChildren = void 0);
                var a = qs(r, "anchor", void 0);
                return (
                    a && o.setAnchor(a),
                    (o.space = Wn(qs(r, "space", 0))),
                    o.setDraggable(qs(r, "draggable", !1)),
                    o.setDirty(!0),
                    o
                );
            }
                ...
                w(l, [
                    {
                        ...
                        value: function (t) {
                            this.scene &&
                                (void 0 !== this.backgroundChildren && (this.backgroundChildren.length = 0),
                                g(p(l.prototype), "destroy", this).call(this, t));
                        },
                    },
                    {
                        key: "setMinSize",
                    ...
                    },
                    {
                        ...
                        get: function () {
                            return (
                                void 0 === this._childrenWidth && (this._childrenWidth = this.getChildrenWidth()),
                                this._childrenWidth
                            );
                        },
                    },
                    ...
                    },
                    {
                        key: "left",
                        get: function () {
                            return this.x - kn(this) * this.originX;
                        },
                        set: function (t) {
                            this.x += t - this.left;
                        },
                    ...
                    },
                    {
                        key: "top",
                        get: function () {
                            return this.y - Cn(this) * this.originY;
                        },
                        set: function (t) {
                            this.y += t - this.top;
                        },
    ...
    Object.assign($s.prototype, Zs);
    function Qs(t, e, i, n, s, r, o) {
        this.pin(t);
        var a = b(e);
        ...
        return (
            "string" == typeof i && (i = xn[i]),
            void 0 === e && (e = 0),
            void 0 === i && (i = ir),
            void 0 === n && (n = 0),
            void 0 === s && (s = !1),
            ((h = this.getSizerConfig(t)).proportion = e),
            (h.align = i),
            (h.padding = Wn(n)),
            (h.expand = s),
    ...
    var tr = Phaser.Utils.Objects.IsPlainObject,
        er = Phaser.Utils.Objects.GetValue,
        ir = Phaser.Display.Align.CENTER,
        nr = { min: 0, full: -1 },
        sr = {
            add: Qs,
            addSpace: function (t) {
                ...
                return (
                    void 0 === t && (t = 1),
                    Qs.call(this, ((e = this.scene), ((i = e.add.zone(0, 0, 1, 1)).isRexSpace = !0), i), t),
                    this
                );
            },
            insert: function (t, e, i, n, s, r, o) {
                return Qs.call(this, e, i, n, s, r, o, t), this;
            },
        },
        rr = Phaser.Utils.Array.Remove,
        or = Ii.prototype.remove,
        ar = Ii.prototype.clear,
        hr = {
            remove: function (t, e) {
                return this.getParentSizer(t) !== this || (rr(this.sizerChildren, t), or.call(this, t, e)), this;
            },
        ...
        lr = {
                ...
                if (0 === this.orientation)
                    for (var o = 0, a = r.length; o < a; o++)
                        (e = r[o]).rexSizer.hidden ||
                            ((n =
                                0 === e.rexSizer.proportion || (t && !e.isRexSpace && 0 < e.rexSizer.proportion)
                                    ? e.isRexSizer
                                        ? Math.max(e.minWidth, e.childrenWidth)
                                        : kn(e)
                                    : 0),
                    ...
                    for (o = 0, a = r.length; o < a; o++)
                        (e = r[o]).hasOwnProperty("rexSizer") &&
                            (e.rexSizer.hidden ||
                                ((n = e.isRexSizer ? Math.max(e.minWidth, e.childrenWidth) : kn(e)),
                                (n += (i = e.rexSizer.padding).left + i.right),
                                (s = Math.max(n, s))));
            ...
            getChildrenHeight: function (t) {
                ...
                if (0 === this.orientation)
                    for (var o = 0, a = r.length; o < a; o++)
                        (e = r[o]).rexSizer.hidden ||
                            ((n = e.isRexSizer ? Math.max(e.minHeight, e.childrenHeight) : Cn(e)),
            ...
            getChildrenProportion: function () {
                for (var t, e, i = 0, n = this.sizerChildren, s = 0, r = n.length; s < r; s++)
                    (t = n[s]).rexSizer.hidden || (0 < (e = t.rexSizer.proportion) && (i += e));
                return i;
            },
            getChildrenSizers: function (t) {
                void 0 === t && (t = []);
            ...
            _layout: function (t, e, i) {
                if (this.rexSizer.hidden || !this.dirty) return this;
                var n;
                if (
                    (this.preLayout(t),
                    void 0 === e && (e = Math.max(this.childrenWidth, this.minWidth)),
                    void 0 === i && (i = Math.max(this.childrenHeight, this.minHeight)),
                    this.resize(e, i),
                    0 < this.childrenProportion)
                ) {
                    var s =
                        0 === this.orientation ? this.width - this.childrenWidth : this.height - this.childrenHeight;
                    n =
                        0 < s
                            ? (s =
                                  0 === this.orientation
                                      ? this.width - this.getChildrenWidth(!1)
                                      : this.height - this.getChildrenHeight(!1)) / this.childrenProportion
                            : 0;
                } else n = 0;
                ...
                for (
                    ...
                    (r = C[E]).rexSizer.hidden ||
                        ((a = (o = r.rexSizer).padding),
                        (m = this),
                        (x = void 0),
                        (b = r.rexSizer),
                        (k = b.padding),
                        0 === m.orientation
                            ? 0 < b.proportion && 0 < m.proportionLength && (x = b.proportion * m.proportionLength)
                            : b.expand && (x = m.innerWidth - k.left - k.right),
                        (d = x),
                        (v = this),
                        (p = void 0),
                        (g = r.rexSizer),
                        (y = g.padding),
                        0 === v.orientation
                            ? g.expand && (p = v.innerHeight - y.top - y.bottom)
                            : 0 < g.proportion && 0 < v.proportionLength && (p = g.proportion * v.proportionLength),
                        (f = p),
                        r.isRexSizer ? r._layout(this, d, f) : ks(r, d, f),
                        void 0 === d && (d = kn(r)),
                        void 0 === f && (f = Cn(r)),
                        (c =
                            0 === this.orientation
                                ? ((h = P + a.left),
                                  (u = 0 === o.proportion || 0 === n ? d : o.proportion * n),
                                  (l = M + a.top),
                                  T - a.top - a.bottom)
                                : ((h = P + a.left),
                                  (u = O - a.left - a.right),
                                  (l = M + a.top),
                                  0 === o.proportion || 0 === n ? f : o.proportion * n)),
                        bn.setPosition(h, l).setSize(u, c),
                        Vn(r, bn, o.align),
                        this.resetChildPositionState(r),
                        0 === this.orientation
                            ? (P += u + a.left + a.right + this.space.item)
                            : (M += c + a.top + a.bottom + this.space.item));
                return this.layoutBackgrounds(), this.postLayout();
            },
            _layoutInit: function () {
                Nn.call(this), (this._childrenProportion = void 0);
            },
        };
    Object.assign(lr, sr, hr);
    var ur = { x: 0, h: 0, horizontal: 0, "left-to-right": 0, y: 1, v: 1, vertical: 1, "top-to-bottom": 1 },
        cr = Phaser.Utils.Objects.IsPlainObject,
                ...
                return (
                    ...
                    cr(e)
                        ? ((e = dr((o = e), "x", 0)),
                          (i = dr(o, "y", 0)),
                          (n = dr(o, "width", void 0)),
                          (s = dr(o, "height", void 0)),
                          (r = dr(o, "orientation", 0)))
                        : cr(n)
                        ? ((n = dr((o = n), "width", void 0)),
                          (s = dr(o, "height", void 0)),
                          (r = dr(o, "orientation", 0)))
                        : cr(r) && (r = dr((o = r), "orientation", 0)),
                    void 0 === r && (r = 0),
                    ((a = h.call(this, t, e, i, n, s, o)).type = "rexSizer"),
                    (a.sizerChildren = []),
                    a.setOrientation(r),
                    a.setItemSpacing(dr(o, "space.item", 0)),
                    a.addChildrenMap("items", a.sizerChildren),
                    a
                );
            }
            return (
                w(l, [
                    {
                        ...
                        value: function (t) {
                            this.scene &&
                                ((this.sizerChildren.length = 0), g(p(l.prototype), "destroy", this).call(this, t));
                        },
                    },
                    {
                        key: "setOrientation",
                        value: function (t) {
                            return "string" == typeof t && (t = ur[t]), (this.orientation = t), this;
                        },
                    },
                    {
                        key: "setItemSpacing",
    ...
    Object.assign(fr.prototype, lr),
        c.register("sizer", function (t, e, i, n, s, r) {
            var o = new fr(this.scene, t, e, i, n, s, r);
            return this.scene.add.existing(o), o;
        }),
        ut(window, "RexPlugins.UI.Sizer", fr);
    function vr() {
        return Array.prototype.reduce.call(arguments, mr, 0);
    }
    function pr(t, e) {
        var i,
            n = t.rexSizer;
    ...
    var mr = function (t, e) {
        ...
        xr = Phaser.Utils.Objects.IsPlainObject,
        br = Phaser.Utils.Objects.GetValue,
        kr = Phaser.Display.Align.CENTER,
        Cr = {
            add: function (t, e, i, n, s, r, o) {
                this.pin(t),
                    xr(e) &&
                        ((e = br((a = e), "column", void 0)),
                        (i = br(a, "row", void 0)),
                        (n = br(a, "align", kr)),
                        (s = br(a, "padding", 0)),
                        (r = br(a, "expand", !1)),
        ...
        wr = Phaser.Utils.Array.Remove,
        Sr = Ii.prototype.remove,
        Or = Ii.prototype.clear,
        Tr = {
            remove: function (t, e) {
                if (this.getParentSizer(t) !== this) return this;
                if (this.isBackground(t)) wr(this.backgroundChildren, t);
                else {
                    var i = this.sizerChildren.indexOf(t);
                    -1 !== i && (this.sizerChildren[i] = null);
                }
                return Sr.call(this, t, e), this;
            },
            ...
            removeAll: function (t) {
                for (var e = 0, i = this.sizerChildren; e < i; e++)
                    this.sizerChildren[e] && this.remove(this.sizerChildren[e], t);
                return this;
            },
            clear: function (t) {
                return (
                    yr(this.sizerChildren, null),
                    this.backgroundChildren && (this.backgroundChildren.length = 0),
                    Or.call(this, t),
                    this
                );
        ...
        Mr = {
            getChildrenWidth: function () {
                ...
                return s + vr.apply(void 0, [this.space.left].concat(h(this.space.column), [this.space.right]));
            },
            getChildrenHeight: function () {
                if (this.rexSizer.hidden) return 0;
                for (var t, e, i, n, s = 0, r = this.sizerChildren, o = 0; o < this.rowCount; o++) {
                    if ((t = 0) === this.rowProportions[o]) {
                        for (var a = 0; a < this.columnCount; a++)
                            (e = r[o * this.columnCount + a]) &&
                                (e.rexSizer.hidden ||
                                    ((n = e.isRexSizer ? Math.max(e.minHeight, e.childrenHeight) : Cn(e)),
                                    (n += (i = e.rexSizer.padding).top + i.bottom),
                                    (t = Math.max(t, n))));
                ...
                return s + vr.apply(void 0, [this.space.top].concat(h(this.space.row), [this.space.bottom]));
            },
            getChildrenSizers: function (t) {
                void 0 === t && (t = []);
            ...
            _layout: function (t, e, i) {
                ...
                if (void 0 === e)
                    if (t && 0 < a) {
                        var l = this.rexSizer.padding;
                        e = t.width - l.left - l.right;
                    } else e = Math.max(this.childrenWidth, this.minWidth);
                if (void 0 === i)
                    if (t && 0 < h) {
                        var l = this.rexSizer.padding;
                        i = t.height - l.top - l.bottom;
                    } else i = Math.max(this.childrenHeight, this.minHeight);
                this.resize(e, i),
                    (n = 0 < a ? (this.width - this.childrenWidth) / a : 0),
                    (s = 0 < h ? (this.height - this.childrenHeight) / h : 0);
                for (
                    var u,
                        c,
                        d,
                    ...
                    (x = 0 === (y = this.rowProportions[O]) ? this.rowHeight[O] : y * s), (k = b);
                    for (var T = 0; T < this.columnCount; T++)
                        (m = 0 === (g = this.columnProportions[T]) ? this.columnWidth[T] : g * n),
                            (r = this.getChildAt(T, O)) &&
                                !r.rexSizer.hidden &&
                                ((v = pr(r, m)),
                                (p = gr(r, x)),
                                r.isRexSizer ? r._layout(this, v, p) : ks(r, v, p),
                                (u = k + (l = (o = r.rexSizer).padding).left),
                                (d = m - l.left - l.right),
                                (c = C + l.top),
                                (f = x - l.top - l.bottom),
                                bn.setPosition(u, c).setSize(d, f),
                                Vn(r, bn, o.align),
                                this.resetChildPositionState(r)),
                            (k += m + w[T]);
                    C += x + S[O];
            ...
            resetGrid: function (t, e, i, n, s) {
                if (
                    ...
                    (this.columnCount = t),
                    (this.rowCount = e),
                    void 0 === this.sizerChildren ? (this.sizerChildren = []) : this.removeAll(),
                ...
                var o = Pr(s, "column", 0);
                if ("number" == typeof o) yr(this.space.column, o);
                else {
                    r = 0;
                ...
                var h = Pr(s, "row", 0);
                if ("number" == typeof h) yr(this.space.row, h);
                else for (r = 0, a = this.space.row.length; r < a; r++) this.space.row[r] = h[r] || 0;
                return this;
            },
        };
    Object.assign(Mr, Cr, Tr);
                ...
                return (
                    ...
                    Er(e)
                        ? ((e = zr((l = e), "x", 0)),
                          (i = zr(l, "y", 0)),
                          (n = zr(l, "width", void 0)),
                          (s = zr(l, "height", void 0)),
                          (r = zr(l, "column", 0)),
                          (o = zr(l, "row", 0)),
                          (a = zr(l, "columnProportions", 0)),
                          (h = zr(l, "rowProportions", 0)))
                        : Er(n)
                        ? ((n = zr((l = n), "width", void 0)),
                          (s = zr(l, "height", void 0)),
                          (r = zr(l, "column", 0)),
                          (o = zr(l, "row", 0)),
                          (a = zr(l, "columnProportions", 0)),
                        ...
                        ? ((r = zr((l = r), "column", 0)),
                          ...
                          (a = zr(l, "columnProportions", 0)),
                          (h = zr(l, "rowProportions", 0)))
                        : Er(a) && ((a = zr((l = a), "columnProportions", 0)), (h = zr(l, "rowProportions", 0))),
                    ((u = c.call(this, t, e, i, n, s, l)).type = "rexGridSizer"),
                    u.resetGrid(r, o, a, h, zr(l, "space", void 0)),
                ...
                w(d, [
                    {
                        ...
                        value: function (t) {
                            this.scene &&
                                ((this.sizerChildren.length = 0), g(p(d.prototype), "destroy", this).call(this, t));
                        },
                    },
                    {
    ...
    Object.assign(Br.prototype, Mr),
        c.register("gridSizer", function (t, e, i, n, s, r, o, a, h) {
            var l = new Br(this.scene, t, e, i, n, s, r, o, a, h);
            return this.scene.add.existing(l), l;
        }),
        ut(window, "RexPlugins.UI.GridSizer", Br);
    function _r(t, e, i, n) {
        return (
            "\n" === t
                ? this.addNewLine()
                : (this.pin(t),
                  Rr(e) && ((e = Yr((s = e), "padding", 0)), (i = Yr(s, "key", void 0)), (n = Yr(s, "index", void 0))),
                  void 0 === e && (e = 0),
                  ((s = this.getSizerConfig(t)).align = Lr),
                  (s.padding = Wn(e)),
    ...
    var jr = function (t) {
            ...
            return kn(t) + e.left + e.right;
        },
        Dr = function (t) {
            var e = t.rexSizer.padding;
            return Cn(t) + e.top + e.bottom;
        },
        Ir = function (t, e, i) {
        ...
        Lr = Phaser.Display.Align.CENTER,
        Fr = {
            add: function (t, e, i) {
                if (yi(t)) for (var n = t, s = 0, r = n.length; s < r; s++) _r.call(this, n[s], e);
                else _r.call(this, t, e, i);
                return this;
            },
            addNewLine: function () {
            ...
            insert: function (t, e, i, n) {
                return _r.call(this, e, i, n, t), this;
            },
        },
        Ar = Phaser.Utils.Array.Remove,
        Xr = Ii.prototype.remove,
        Hr = Ii.prototype.clear,
        Ur = {
            remove: function (t, e) {
                return this.getParentSizer(t) !== this || (Ar(this.sizerChildren, t), Xr.call(this, t, e)), this;
            },
            removeAll: function (t) {
                for (var e = 0, i = this.sizerChildren; e < i; e++) this.remove(this.sizerChildren[e], t);
                return (this.sizerChildren.length = 0), this;
        ...
        Vr = {
            getChildrenWidth: function () {
                return this.rexSizer.hidden
                    ? 0
                    : (0 === this.orientation ? this.maxChildWidth : 0) + this.space.left + this.space.right;
            },
            getChildrenHeight: function () {
                return this.rexSizer.hidden
                    ? 0
                    : (0 === this.orientation ? 0 : this.maxChildHeight) + this.space.top + this.space.bottom;
            },
            getChildrenSizers: function (t) {
                void 0 === t && (t = []);
                for (var e, i = this.sizerChildren, n = 0, s = i.length; n < s; n++)
            ...
            _layout: function (t, e, i) {
                ...
                this.preLayout(t),
                    void 0 === e &&
                        (e = Math.max(this.maxChildWidth + this.space.left + this.space.right, this.minWidth)),
                    void 0 === i &&
                        (i = Math.max(this.maxChildHeight + this.space.top + this.space.bottom, this.minHeight)),
                    (n =
                        0 === this.orientation
                            ? e - this.space.left - this.space.right
                            : i - this.space.top - this.space.bottom);
                var s = function (t) {
                    for (
                        var e,
                            i,
                            ...
                            s,
                            r,
                            o = { lines: [], width: 0, height: 0 },
                            a = this.sizerChildren,
                            h = 0,
                            l = o.lines,
                            u = 0,
                            c = a.length;
                        ...
                        if ("\n" === (e = a[u])) (e = void 0), (r = !(i = 0));
                        else {
                            if (e.rexSizer.hidden) continue;
                            e.isRexSizer && e.layout(), (r = h < (i = (0 === this.orientation ? jr : Dr)(e)));
                        }
                        r &&
                            (s &&
                                ((s.width = t - (h + this.space.item)),
                                (o.width = Math.max(o.width, s.width)),
                                (o.height += s.height + this.space.line)),
                            (s = { children: [], height: 0 }),
                            l.push(s),
                            (h = t)),
                            (h -= i + this.space.item),
                            e &&
                                (s.children.push(e),
                                (n = (0 === this.orientation ? Dr : jr)(e)),
                                (s.height = Math.max(s.height, n)));
                    }
                    return (
                        s &&
                            ((s.width = t - (h + this.space.item)),
                ...
                0 === this.orientation
                    ? (i = Math.max(i, s.height + this.space.top + this.space.bottom))
                    : (e = Math.max(e, s.height + this.space.left + this.space.right)),
                    this.resize(e, i);
                for (
                    var r,
                        o,
                    ...
                    switch (((f = (d = b[k]).children), this.rtl && f.reverse(), (v = n - d.width), this.align)) {
                        case 0:
                            break;
                        case 1:
                            0 === this.orientation ? (m += v) : (x += v);
                            break;
                        case 2:
                            0 === this.orientation ? (m += v / 2) : (x += v / 2);
                            break;
                        case 3:
                            p = Ir(n, v, f.length);
                            break;
                        case 4:
                            0 === (p = Ir(n, v, f.length)) && (0 === this.orientation ? (m += v) : (x += v));
                            break;
                        case 5:
                            0 === (p = Ir(n, v, f.length)) && (0 === this.orientation ? (m += v / 2) : (x += v / 2));
                    }
                    for (var w = 0, S = f.length; w < S; w++)
                        (a = (o = (r = f[w]).rexSizer).padding),
                            0 === this.orientation
                                ? ((h = m + a.left),
                                  0 < w && (h += this.space.item),
                                  (l = x + a.top),
                                  (u = kn(r)),
                                  (c = Cn(r)),
                                  (m = h + u + a.right + p))
                                : ((h = m + a.left),
                                  (l = x + a.top),
                                  0 < w && (l += this.space.item),
                                  (u = kn(r)),
                                  (x = l + (c = Cn(r)) + a.bottom + p)),
                            bn.setPosition(h, l).setSize(u, c),
                            Vn(r, bn, o.align),
                            this.resetChildPositionState(r);
                    0 === this.orientation
                        ? ((m = g), (x += d.height + this.space.line))
                        : ((m += d.height + this.space.line), (x = y));
                }
                return this.layoutBackgrounds(), this.postLayout();
            },
            _layoutInit: function () {
                Nn.call(this), (this._maxChildWidth = void 0), (this._maxChildHeight = void 0);
            },
        };
    Object.assign(Vr, Fr, Ur);
    var Wr = Phaser.Utils.Objects.IsPlainObject,
                ...
                return (
                    ...
                    Wr(e)
                        ? ((e = Gr((r = e), "x", 0)),
                          (i = Gr(r, "y", 0)),
                          (n = Gr(r, "width", void 0)),
                          (s = Gr(r, "height", void 0)))
                        : Wr(n) && ((n = Gr((r = n), "width", void 0)), (s = Gr(r, "height", void 0))),
                    ((o = a.call(this, t, e, i, n, s, r)).type = "rexFixWidthSizer"),
                    (o.sizerChildren = []),
                    o.setOrientation(Gr(r, "orientation", 0)),
                    o.setItemSpacing(Gr(r, "space.item", 0)),
                    o.setLineSpacing(Gr(r, "space.line", 0)),
                    o.setAlign(Gr(r, "align", 0)),
                    o.setRTL(Gr(r, "rtl", !1)),
                ...
                w(h, [
                    {
                        ...
                        value: function (t) {
                            this.scene &&
                                ((this.sizerChildren.length = 0), g(p(h.prototype), "destroy", this).call(this, t));
                        },
                    },
                    {
                        key: "setOrientation",
                    ...
                    },
                    {
                        key: "setAlign",
                        value: function (t) {
                            return "string" == typeof t && (t = Jr[t]), (this.align = t), this;
                        },
                    },
                    {
                        key: "setRTL",
                                ...
                                void 0 === this._maxChildWidth &&
                                    (this._maxChildWidth = function (t) {
                                        ...
                                        for (var e, i, n = 0, s = 0, r = t.length; s < r; s++)
                                            "\n" !== (e = t[s]) &&
                                                ((i = e.isRexSizer ? Math.max(e.minWidth, e.childrenWidth) : kn(e)),
                                                (n = Math.max(i, n)));
                                        return n;
                                    }.call(this)),
                                this._maxChildWidth
                            ...
                            return (
                                void 0 === this._maxChildHeight &&
                                    (this._maxChildHeight = function (t) {
                                        ...
                                        for (var e, i, n = 0, s = 0, r = t.length; s < r; s++)
                                            "\n" !== (e = t[s]) &&
                                                ((i = e.isRexSizer ? Math.max(e.minHeight, e.childrenHeight) : Cn(e)),
                                                (n = Math.max(i, n)));
                                        return n;
                                    }.call(this)),
    ...
    Object.assign(Nr.prototype, Vr),
        c.register("fixWidthSizer", function (t, e, i, n, s) {
            var r = new Nr(this.scene, t, e, i, n, s);
            return this.scene.add.existing(r), r;
        }),
        ut(window, "RexPlugins.UI.FixWidthSizer", Nr);
    var Kr = Phaser.Utils.Objects.IsPlainObject,
        Zr = Phaser.Utils.Objects.GetValue,
        qr = Phaser.Display.Align.CENTER,
        $r = {
            add: function (t, e, i, n, s) {
                ...
                return (
                    ...
                    (r.padding = Wn(n)),
                    Kr(s)
                        ? ((r.expandWidth = Zr(s, "width", !1)), (r.expandHeight = Zr(s, "height", !1)))
        ...
        Qr = Ii.prototype.remove,
        to = Ii.prototype.clear,
        eo = {
            remove: function (t, e) {
                var i;
                if ("string" == typeof t) {
                ...
                return delete this.sizerChildren[i], Qr.call(this, t, e), this;
            },
            removeAll: function (t) {
                var e;
                for (var i in this.sizerChildren)
                    (e = this.sizerChildren[i]), delete this.sizerChildren[i], Qr.call(this, e, t);
                return this;
            },
            clear: function (t) {
                return (
        ...
        io = {
            getChildrenWidth: function () {
                ...
                for (var r in s)
                    (i = (t = s[r]).isRexSizer ? Math.max(t.minWidth, t.childrenWidth) : kn(t)),
            ...
            getChildrenHeight: function () {
                ...
                var t,
                    ...
                    s = this.sizerChildren;
                for (var r in s)
                    (i = (t = s[r]).isRexSizer ? Math.max(t.minHeight, t.childrenHeight) : Cn(t)),
                    ...
                    (r = (s = (n = S[O]).rexSizer).padding),
                        n.isRexSizer
                            ? n._layout(
                                  ...
                                  (m = n.rexSizer),
                                  (x = m.padding),
                                  m.expandWidth && (y = g.innerWidth - x.left - x.right),
                                  y),
                                  ((d = this),
                                  (f = void 0),
                                  (v = n.rexSizer),
                                  (p = v.padding),
                                  v.expandHeight && (f = d.innerHeight - p.top - p.bottom),
                                  f),
                              )
                            : ((c = u = void 0),
                              s.expandWidth && (u = C - r.left - r.right),
                              s.expandHeight && (c = w - r.top - r.bottom),
                              ks(n, u, c)),
                        (o = b + r.left),
                        (h = C - r.left - r.right),
                        (a = k + r.top),
                        (l = w - r.top - r.bottom),
                        bn.setPosition(o, a).setSize(h, l),
                        Vn(n, bn, s.align),
                        this.resetChildPositionState(n);
                return this.layoutBackgrounds(), this.postLayout();
            },
        };
    Object.assign(io, $r, eo);
    function no(t, e) {
        if (Array.isArray(t)) return t.indexOf(e);
        for (var i in t) if (t[i] === e) return i;
        return null;
    }
    var so = Phaser.Utils.Objects.IsPlainObject,
                ...
                return (
                    ...
                    so(e)
                        ? ((e = ro((r = e), "x", 0)),
                          (i = ro(r, "y", 0)),
                          (n = ro(r, "width", void 0)),
                          (s = ro(r, "height", void 0)))
                        : so(n) && ((n = ro((r = n), "width", void 0)), (s = ro(r, "height", void 0))),
                    ((o = a.call(this, t, e, i, n, s, r)).type = "rexOverlapSizer"),
                    (o.sizerChildren = {}),
                    o.addChildrenMap("items", o.sizerChildren),
                    o
                );
                ...
                w(h, [
                    {
                        key: "destroy",
                        value: function (t) {
                            this.scene && (dt(this.sizerChildren), g(p(h.prototype), "destroy", this).call(this, t));
                        },
                    },
                    {
                        key: "childToKey",
                        value: function (t) {
                            if ("string" != typeof t) return no(this.sizerChildren, t);
                            var e = t;
    ...
    Object.assign(oo.prototype, io),
        c.register("overlapSizer", function (t, e, i, n, s) {
            var r = new oo(this.scene, t, e, i, n, s);
            return this.scene.add.existing(r), r;
        }),
        ut(window, "RexPlugins.UI.OverlapSizer", oo);
    function ao(t, e, i, n) {
        var s = new lo(e, i, n);
        return t && !t.isRexSizer && t.setMask(s.createGeometryMask()), this.pin(s), s;
    }
    var ho = Phaser.GameObjects.Graphics,
        lo = (function () {
            t(r, ho);
            var s = e(r);
            function r(t, e, i) {
                ...
                w(r, [
                    {
                        key: "destroy",
                        value: function () {
                            return (this.parent = void 0), g(p(r.prototype), "destroy", this).call(this), this;
                        },
                    },
                    {
                        key: "setPosition",
                        value: function (t, e) {
                            ...
                            return (
                                void 0 === t && (t = i.x),
                                void 0 === e && (e = i.y),
                                g(p(r.prototype), "setPosition", this).call(this, t, e),
                                this
                            );
                        },
                    },
                    {
                        ...
                        value: function (t, e, i) {
                            ...
                            if (
                                ...
                                this.widthSave === t && this.heightSave === e && this.paddingSave === i)
                            )
                                return this;
        ...
        uo = { rectangle: 0, circle: 1 },
        co = Phaser.Utils.Objects.GetValue,
        fo = (function () {
            t(m, fr);
            var y = e(m);
            function m(t, e) {
                var i;
                B(this, m), ((i = y.call(this, t, e)).type = "rexLabel");
                var n = co(e, "background", void 0),
                    s = co(e, "icon", void 0),
                    r = co(e, "iconMask", void 0),
                    o = co(e, "text", void 0),
                    a = co(e, "action", void 0),
                    h = co(e, "actionMask", void 0),
                    l = co(e, "align", void 0),
                    u = co(e, "space.icon", 0),
                    c = co(e, "space.text", 0);
                n && i.addBackground(n),
                    ...
                    s &&
                        (0 === i.orientation ? (o || a) && (f = { right: u }) : (o || a) && (f = { bottom: u }),
                        i.add(s, 0, "center", f),
                ...
                if (o) {
                    var d,
                        f,
                        v,
                        p = co(e, "expandTextWidth", !1),
                        g = co(e, "expandTextHeight", !1);
                    (v =
                        0 === i.orientation
                            ? ((d = p ? 1 : 0), a && (f = { right: c }), g)
                            : ((d = g ? 1 : 0), a && (f = { bottom: c }), p)),
                        i.add(o, d, "center", f, v);
                }
                return (
                    a && (i.add(a), (h = h && i.addChildMask(a, a, 1))),
                    "center" === l && i.addSpace(),
                    i.addChildrenMap("background", n),
                    i.addChildrenMap("icon", s),
                    i.addChildrenMap("iconMask", r),
                    i.addChildrenMap("text", o),
                    i.addChildrenMap("action", a),
                    i.addChildrenMap("actionMask", h),
                    i
                );
            }
            return (
                w(m, [
                    ...
                    },
                    {
                        ...
                        value: function (t, e, i) {
                            if (this.rexSizer.hidden || !this.dirty) return this;
                            g(p(m.prototype), "_layout", this).call(this, t, e, i);
                    ...
                    },
                    {
                        key: "resize",
                        value: function (t, e) {
                            g(p(m.prototype), "resize", this).call(this, t, e);
        ...
        vo = { addChildMask: ao };
    Object.assign(fo.prototype, vo),
        c.register("label", function (t) {
            var e = new fo(this.scene, t);
            return this.scene.add.existing(e), e;
        }),
        ut(window, "RexPlugins.UI.Label", fo);
        ...
        go = (function () {
            function i(t, e) {
                B(this, i),
                    (this.gameObject = t),
                    (this.scene = Zn(t)),
                    this.setEventEmitter(po(e, "eventEmitter", void 0)),
                    (this._enable = void 0),
                    t.setInteractive(po(e, "inputConfig", void 0)),
                ...
                w(i, [
                    {
                        ...
                        value: function (t) {
                            return (
                                ...
                                this.setEnable(po(t, "enable", !0)),
                                this.setMode(po(t, "mode", 1)),
                                this.setClickInterval(po(t, "clickInterval", 100)),
                                this.setDragThreshold(po(t, "threshold", void 0)),
                                this
                            );
                        },
                    },
                    ...
                    },
                    {
                        key: "setMode",
                        value: function (t) {
                            return "string" == typeof t && (t = Oo[t]), (this.mode = t), this;
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function (t, e, i, n) {
                            void 0 === this.pointer &&
                                ((this.pointer = t), 0 === this.mode && this.click(t.downTime, t, n));
                        },
                    },
                    {
                        key: "onRelease",
                        value: function (t, e, i, n) {
                            this.pointer === t &&
                                (1 === this.mode && this.click(t.upTime, t, n), (this.pointer = void 0));
                        },
                    },
                    {
                        key: "onPointOut",
                        ...
                        value: function (t, e, i) {
                            ...
                            return (
                                (void 0 !== n && t - n <= this.clickInterval) ||
                                    ((this.lastClickTime = t), this.emit("click", this, this.gameObject, e, i)),
                                this
                            );
                        },
                    },
    ...
    Object.assign(go.prototype, ls);
    function yo(s, t) {
        (s._buttonBehavior = new go(s, t)),
            s._buttonBehavior
                .on(
                    "click",
                    function (t, e, i, n) {
                        To.call(this, "button.click", e, i, n);
                    },
                    this,
                )
                .on(
            ...
            s
                .on(
                    "pointerover",
                    function (t, e, i, n) {
                        To.call(this, "button.over", s, t, n);
                    },
                    this,
                )
                .on(
    ...
    function mo(t) {
        if (0 === this.buttons.length) {
            ...
            Po.call(this, t, this.buttonProportion, "center", 0, !0),
                this.buttonsExpand || ("center" === this.buttonsAlign && Mo.call(this));
        } else {
            var e = this.sizerChildren.length - 1;
            this.sizerChildren[e].isRexSpace
                ? Eo.call(this, e, t, this.buttonProportion, "center", 0, !0)
                : Po.call(this, t, this.buttonProportion, "center", 0, !0);
        }
        return this.buttons.push(t), yo.call(this, t, this.clickConfig), this;
    }
    function xo(t, e) {
        return (
            (t = this.getButton(t)) &&
                (1 === this.buttons.length ? this.clear(e) : (Bo(this.buttons, t), _o.call(this, t, e))),
            this
        );
    }
    function bo(t) {
    ...
    function Co(t) {
        return !!t && !pn(t).hidden;
    }
    function wo(t, e) {
        void 0 === e && (e = !1);
        var i = Lo(t, "dataManager", void 0),
            s = Lo(t, "setValueCallback", void 0),
            r = Lo(t, "setValueCallbackScope", void 0);
    ...
    function So(t) {
        var e = Fo(t, "type", void 0);
        e && Ao.hasOwnProperty(e) && Ao[e].call(this, t);
    }
    var Oo = { press: 0, pointerdown: 0, release: 1, pointerup: 1 },
        To = function (t, e, i, n) {
            var s;
            if ("number" == typeof e) {
        ...
        Po = fr.prototype.add,
        Mo = fr.prototype.addSpace,
        Eo = fr.prototype.insert,
        zo = {
            addButton: function (t) {
                if (yi(t)) for (var e = t, i = 0, n = e.length; i < n; i++) mo.call(this, e[i]);
                else mo.call(this, t);
                return this;
            },
            addButtons: function (t) {
                for (var e = 0, i = t.length; e < i; e++) mo.call(this, t[e]);
                return this;
            },
        },
        Bo = Phaser.Utils.Array.Remove,
        _o = fr.prototype.remove,
        jo = fr.prototype.clear,
        Do = {
            remove: function (t, e) {
                if (yi(t)) for (var i = t, n = 0, s = i.length; n < s; n++) xo.call(this, i[n], e);
                else xo.call(this, t, e);
                return this;
            },
            clear: function (t) {
                return (this.buttons.length = 0), jo.call(this, t), this;
            },
        ...
        Ro = function (t, e) {
            t && ((pn(t).hidden = e), t.setVisible(!e));
        },
        Yo = {
                ...
                switch (b(t)) {
                    ...
                    case "string":
                        e = (function (t, e) {
                            if (!t) return null;
                            if (yi(t)) {
                                for (var i, n = 0, s = t.length; n < s; n++) if ((i = Io(t[n], e))) return i;
                            } else for (var r in t) if ((i = Io(t[r], e))) return i;
                        })(this.buttons, t);
                        break;
                    default:
            ...
            emitButtonClick: function (t) {
                return To.call(this, "button.click", t), this;
            },
            showButton: function (t) {
                return bo(this.getButton(t)), this;
            },
            hideButton: function (t) {
                return ko(this.getButton(t)), this;
            },
            isButtonShown: function (t) {
                return Co(this.getButton(t)), this;
            },
            forEachButtton: function (t, e) {
                for (var i = 0, n = this.buttons.length; i < n; i++)
                    e ? t.call(e, this.buttons[i], i, this.buttons) : t(this.buttons[i], i, this.buttons);
                return this;
            },
        },
        ...
        Xo = Phaser.Utils.Objects.GetValue,
        Ho = (function () {
            t(a, fr);
            var o = e(a);
            function a(t, e) {
                ...
                "number" == typeof n && (e.space = { item: n }),
                    ...
                    (i.eventEmitter = Xo(e, "eventEmitter", _(i))),
                    (i.groupName = Xo(e, "groupName", void 0)),
                    (i.buttons = []);
                var s = Xo(e, "background", void 0),
                    r = Xo(e, "buttons", void 0);
                return (
                    (i.buttonsExpand = Xo(e, "expand", !1)),
                    (i.buttonsAlign = Xo(e, "align", void 0)),
                    (i.buttonProportion = i.buttonsExpand ? 1 : 0),
                    (i.clickConfig = Xo(e, "click", void 0)),
                    s && i.addBackground(s),
                    r && i.addButtons(r),
                    So.call(_(i), e),
    ...
    Object.assign(Ho.prototype, zo, Do, Yo),
        c.register("buttons", function (t) {
            var e = new Ho(this.scene, t);
            return this.scene.add.existing(e), e;
        }),
        ut(window, "RexPlugins.UI.Buttons", Ho);
    function Uo(t, e) {
        return (t = this.getButton(t)) && (Go(this.buttons, t), No.call(this, t, e)), this;
    }
    var Vo = Br.prototype.add,
        Wo = {
            addButton: function (t, e, i) {
                return (
                    Vo.call(this, t, e, i, void 0, 0, this.buttonsExpand),
                    this.buttons.push(t),
                    yo.call(this, t, this.clickConfig),
                    this
                );
            },
        ...
        No = Br.prototype.remove,
        Jo = Br.prototype.clear,
        Ko = {
            remove: function (t, e) {
                if (yi(t)) for (var i = t, n = 0, s = i.length; n < s; n++) Uo.call(this, i[n], e);
                else Uo.call(this, t, e);
                return this;
            },
            clear: function (t) {
                return (this.buttons.length = 0), Jo.call(this, t), this;
        ...
        qo = (function () {
            ...
            function m(t, e) {
                ...
                (e.row = n),
                    (e.column = s),
                    (e.columnProportions = a),
                    (e.rowProportions = a),
                    ((i = y.call(this, t, e)).type = "rexGridButtons"),
                    (i.eventEmitter = Zo(e, "eventEmitter", _(i))),
                    (i.groupName = Zo(e, "groupName", void 0)),
                    (i.buttons = []);
                var u = Zo(e, "background", void 0);
                i.buttonsExpand = o;
                var c = Zo(e, "space", void 0);
                if (
                    ("number" == typeof c && (c = { itemX: c, itemY: c }),
                    (i.clickConfig = Zo(e, "click", void 0)),
                    u && i.addBackground(u),
                    r)
                )
                    for (var d, f = 0, v = r.length; f < v; f++)
                        for (var p = 0, g = r.length; p < g; p++) (d = r[f][p]) && i.addButton(d, p, f);
                return So.call(_(i), e), i.addChildrenMap("background", u), i.addChildrenMap("buttons", i.buttons), i;
            }
            return m;
        })();
    Object.assign(qo.prototype, Wo, Ko, Yo),
        c.register("gridButtons", function (t) {
            var e = new qo(this.scene, t);
            return this.scene.add.existing(e), e;
        }),
        ut(window, "RexPlugins.UI.GridButtons", qo);
    function $o(t) {
        return ta.call(this, t), this.buttons.push(t), yo.call(this, t, this.clickConfig), this;
    }
    function Qo(t, e) {
        return (
            (t = this.getButton(t)) &&
                (1 === this.buttons.length ? this.clear(e) : (ia(this.buttons, t), na.call(this, t, e))),
            this
        );
    }
    var ta = Nr.prototype.add,
        ea = {
            addButton: function (t) {
                if (yi(t)) for (var e = t, i = 0, n = e.length; i < n; i++) $o.call(this, e[i]);
                else $o.call(this, t);
                return this;
            },
            addButtons: function (t) {
                if (yi(t[0]))
                    for (var e, i = t, n = 0, s = i.length - 1; n <= s; n++) {
                        for (var r = 0, o = (e = i[n]).length; r < o; r++) $o.call(this, e[r]);
                        s < n && ta.addNewLine(this);
                    }
                else for (r = 0, o = t.length; r < o; r++) $o.call(this, t[r]);
                return this;
            },
        },
        ia = Phaser.Utils.Array.Remove,
        na = Nr.prototype.remove,
        sa = Nr.prototype.clear,
        ra = {
            remove: function (t, e) {
                if (yi(t)) for (var i = t, n = 0, s = i.length; n < s; n++) Qo.call(this, i[n], e);
                else Qo.call(this, t, e);
                return this;
            },
            clear: function (t) {
                return (this.buttons.length = 0), sa.call(this, t), this;
            },
            removeButton: function (t, e) {
                return this.remove(t, e), this;
            },
        ...
        oa = Phaser.Utils.Objects.GetValue,
        aa = (function () {
            t(a, Nr);
            var o = e(a);
            function a(t, e) {
                ...
                "number" == typeof n && (e.space = { item: n, line: n }),
                    ...
                    (i.eventEmitter = oa(e, "eventEmitter", _(i))),
                    (i.groupName = oa(e, "groupName", void 0)),
                    (i.buttons = []);
                var s = oa(e, "background", void 0),
                    r = oa(e, "buttons", void 0);
                return (
                    (i.buttonsAlign = oa(e, "align", void 0)),
                    (i.clickConfig = oa(e, "click", void 0)),
                    s && i.addBackground(s),
                    r && i.addButtons(r),
                    So.call(_(i), e),
                    i.addChildrenMap("background", s),
    ...
    Object.assign(aa.prototype, ea, ra, Yo),
        c.register("fixWidthButtons", function (t) {
            var e = new aa(this.scene, t);
            return this.scene.add.existing(e), e;
        }),
        ut(window, "RexPlugins.UI.FixWidthButtons", aa);
    var ha = Phaser.Utils.Objects.GetValue,
        la = (function () {
            t(z, fr);
            var E = e(z);
            function z(t, e) {
                ...
                B(this, z),
                    void 0 === e && (e = {}),
                    (e.orientation = 1),
                    ((i = E.call(this, t, e)).type = "rexDialog"),
                    (i.eventEmitter = ha(e, "eventEmitter", _(i)));
                var n,
                    s,
                    r,
                    o,
                    a = ha(e, "background", void 0),
                    h = ha(e, "title", void 0),
                    l = ha(e, "toolbar", void 0),
                    u = ha(e, "toolbarBackground", void 0),
                    c = ha(e, "leftToolbar", void 0),
                    d = ha(e, "leftToolbarBackground", void 0),
                    f = ha(e, "content", void 0),
                    v = ha(e, "description", void 0),
                    p = ha(e, "choices", void 0),
                    g = ha(e, "choicesBackground", void 0),
                    y = ha(e, "actions", void 0),
                    m = ha(e, "actionsBackground", void 0),
                    x = ha(e, "click", void 0);
                if (
                    (a && i.addBackground(a),
                    l &&
                        (r = new Ho(t, {
                            ...
                            buttons: l,
                            orientation: 0,
                            space: { item: ha(e, "space.toolbarItem", 0) },
                            click: x,
                    ...
                    c &&
                        (o = new Ho(t, {
                            ...
                            buttons: c,
                            orientation: 0,
                            space: { item: ha(e, "space.leftToolbarItem", 0) },
                            click: x,
                            eventEmitter: i.eventEmitter,
                        })),
                    h && !l && !c)
                ) {
                    var b = ha(e, "align.title", "center"),
                        k = ha(e, "space.title", 0);
                    (f || v || p || y) && (S = { bottom: k });
                    var C = ha(e, "expand.title", !0);
                    i.add(h, 0, b, S, C);
                }
                if (l && !h && !c) {
                    k = ha(e, "space.title", 0);
                    (f || v || p || y) && (S = { bottom: k });
                    C = ha(e, "expand.toolbar", !0);
                    i.add(r, 0, "right", S, C);
                }
                if (c && !h && !l) {
                    k = ha(e, "space.title", 0);
                    (f || v || p || y) && (S = { bottom: k });
                    C = ha(e, "expand.leftToolbar", !0);
                    i.add(o, 0, "left", S, C);
                }
                if (h && (l || c)) {
                    var w = new fr(t, { orientation: 0 });
                    o && w.add(o, 0, "right", 0, !1);
                    b = ha(e, "align.title", "left");
                    (C = ha(e, "expand.title", !0)) || ("right" !== b && "center" !== b) || w.addSpace();
                    var S = { left: ha(e, "space.titleLeft", 0), right: ha(e, "space.titleRight", 0) },
                        O = C ? 1 : 0;
                    w.add(h, O, "center", S, C),
                        C || ("left" !== b && "center" !== b) || w.addSpace(),
                        r && w.add(r, 0, "right", 0, !1);
                    k = ha(e, "space.title", 0);
                    (f || v || p || y) && (S = { bottom: k }), i.add(w, 0, "center", S, !0);
                }
                if (f) {
                    b = ha(e, "align.content", "center");
                    var T = ha(e, "space.content", 0);
                    (S = {
                        left: ha(e, "space.contentLeft", 0),
                        right: ha(e, "space.contentRight", 0),
                        bottom: v || p || y ? T : 0,
                    }),
                        (C = ha(e, "expand.content", !0));
                    i.add(f, 0, b, S, C);
                }
                if (v) {
                    b = ha(e, "align.description", "center");
                    var P = ha(e, "space.description", 0);
                    (S = {
                        left: ha(e, "space.descriptionLeft", 0),
                        right: ha(e, "space.descriptionRight", 0),
                        bottom: p || y ? P : 0,
                    }),
                        (C = ha(e, "expand.description", !0));
                    i.add(v, 0, b, S, C);
                }
                if (p) {
                    b = ha(e, "align.choices", "center");
                    n = new Ho(t, {
                        groupName: "choices",
                        background: g,
                        buttons: p,
                        orientation: 1,
                        space: { item: ha(e, "space.choice", 0) },
                        click: x,
                        eventEmitter: i.eventEmitter,
                        type: ha(e, "choicesType", void 0),
                        setValueCallback: ha(e, "choicesSetValueCallback", void 0),
                        setValueCallbackScope: ha(e, "choicesSetValueCallbackScope", void 0),
                    });
                    var M = ha(e, "space.choices", 0);
                    (S = {
                        left: ha(e, "space.choicesLeft", 0),
                        right: ha(e, "space.choicesRight", 0),
                        bottom: y ? M : 0,
                    }),
                        (C = ha(e, "expand.choices", !0));
                    i.add(n, 0, b, S, C);
                }
                if (y) {
                    s = new Ho(t, {
                        ...
                        buttons: y,
                        orientation: 0,
                        space: { item: ha(e, "space.action", 0) },
                        expand: ha(e, "expand.actions", !1),
                        align: ha(e, "align.actions", "center"),
                        click: x,
                        eventEmitter: i.eventEmitter,
                    });
                    S = { left: ha(e, "space.actionsLeft", 0), right: ha(e, "space.actionsRight", 0) };
                    i.add(s, 0, "center", S, !0);
                }
                return (
                    i.addChildrenMap("background", a),
                    i.addChildrenMap("title", h),
    ...
    Object.assign(la.prototype, {
        ...
        c.register("dialog", function (t) {
            var e = new la(this.scene, t);
            return this.scene.add.existing(e), e;
        }),
        ut(window, "RexPlugins.UI.Dialog", la);
    var ua = {
            ...
            showButton: function (t, e) {
                return bo(this.getButton(t, e)), this;
            },
            showLeftButton: function (t) {
                return bo(this.getLeftButton(t)), this;
            },
            showRightButton: function (t) {
                return bo(this.getRightButton(t)), this;
            },
            showTopButton: function (t) {
                return bo(this.getTopButton(t)), this;
            },
            showBottomButton: function (t) {
                return bo(this.getBottomButton(t)), this;
            },
            hideButton: function (t, e) {
                return ko(this.getButton(t, e)), this;
            },
            hideLeftButton: function (t) {
                return ko(this.getLeftButton(t)), this;
            },
            hideRightButton: function (t) {
                return ko(this.getRightButton(t)), this;
            },
            hideTopButton: function (t) {
                return ko(this.getTopButton(t)), this;
            },
            hideBottomButton: function (t) {
                return ko(this.getBottomButton(t)), this;
            },
        ...
        ca = Phaser.Utils.Objects.GetValue,
        da = (function () {
            t(M, Br);
            var P = e(M);
            function M(t, e) {
                ...
                B(this, M),
                    ...
                    (e.column = 3),
                    (e.row = 3),
                    ((i = P.call(this, t, e)).type = "rexTabs"),
                    (i.eventEmitter = ca(e, "eventEmitter", _(i)));
                var n,
                    s,
                    r,
                    o,
                    a = ca(e, "background", void 0),
                    h = ca(e, "panel", void 0),
                    l = ca(e, "leftButtons", void 0),
                    u = ca(e, "leftButtonsBackground", void 0),
                    c = ca(e, "rightButtons", void 0),
                    d = ca(e, "rightButtonsBackground", void 0),
                    f = ca(e, "topButtons", void 0),
                    v = ca(e, "topButtonsBackground", void 0),
                    p = ca(e, "bottomButtons", void 0),
                    g = ca(e, "bottomButtonsBackground", void 0),
                    y = ca(e, "click", void 0);
                if ((a && i.addBackground(a), h && i.add(h, 1, 1, "center", 0, !0), l)) {
                    var m = ca(e, "space.leftButtonsOffset", 0),
                        x = ca(e, "space.leftButton", 0);
                    n = new Ho(t, {
                        groupName: "left",
                        background: u,
                        buttons: l,
                        orientation: 1,
                        space: { item: x },
                        align: ca(e, "align.leftButtons", void 0),
                        click: y,
                        eventEmitter: i.eventEmitter,
                    });
                    var b = { top: m };
                ...
                if (c) {
                    var k = ca(e, "space.rightButtonsOffset", 0),
                        C = ca(e, "space.rightButton", 0);
                    s = new Ho(t, {
                        groupName: "right",
                        background: d,
                        buttons: c,
                        orientation: 1,
                        space: { item: C },
                        align: ca(e, "align.rightButtons", void 0),
                        click: y,
                        eventEmitter: i.eventEmitter,
                    });
                    b = { top: k };
                ...
                if (f) {
                    var w = ca(e, "space.topButtonsOffset", 0),
                        S = ca(e, "space.topButton", 0);
                    r = new Ho(t, {
                        groupName: "top",
                        background: v,
                        buttons: f,
                        orientation: 0,
                        space: { item: S },
                        align: ca(e, "align.topButtons", void 0),
                        click: y,
                        eventEmitter: i.eventEmitter,
                    });
                    b = { left: w };
                ...
                if (p) {
                    var O = ca(e, "space.bottomButtonsOffset", 0),
                        T = ca(e, "space.bottomButton", 0);
                    o = new Ho(t, {
                        groupName: "bottom",
                        background: g,
                        buttons: p,
                        orientation: 0,
                        space: { item: T },
                        align: ca(e, "align.bottomButtons", void 0),
                        click: y,
                        eventEmitter: i.eventEmitter,
                    });
                    b = { left: O };
    ...
    Object.assign(da.prototype, ua),
        c.register("tabs", function (t) {
            var e = new da(this.scene, t);
            return this.scene.add.existing(e), e;
        }),
        ut(window, "RexPlugins.UI.Tabs", da);
    function fa(t, e, i) {
        var n, s, r;
        return (
            t.y === e.y
                ? ((n = Math.min(t.x, e.x)), (s = Math.max(t.x, e.x)), (r = ya(i.x, n, s)))
                : t.x === e.x && ((n = Math.min(t.y, e.y)), (s = Math.max(t.y, e.y)), (r = ya(i.y, n, s))),
            r
        );
    }
    function va(t, e, i) {
        this.enable && ((ma.x = e), (ma.y = i), (this.value = fa(this.getStartPoint(), this.getEndPoint(), ma)));
    }
    function pa(t) {
        this.enable &&
            t.isDown &&
            ((xa.x = t.worldX), (xa.y = t.worldY), (this.value = fa(this.getStartPoint(), this.getEndPoint(), xa)));
    }
    function ga(t, e) {
        void 0 === e && (e = ba);
        var i = this.childrenMap.thumb,
            n = i.x,
            s = i.y;
        return Vn(i, this, t), (e.x = i.x), (e.y = i.y), (i.x = n), (i.y = s), e;
    }
    var ya = Phaser.Math.Percent,
        ma = {},
        xa = {},
        ba = {},
        ka = Phaser.Display.Align.LEFT_CENTER,
        Ca = Phaser.Display.Align.TOP_CENTER,
        wa = {},
        Sa = Phaser.Display.Align.RIGHT_CENTER,
        Oa = Phaser.Display.Align.BOTTOM_CENTER,
        Ta = {},
        Pa = Phaser.Math.Linear,
        Ma = {},
        Ea = Phaser.Display.Align.LEFT_CENTER,
        za = Phaser.Display.Align.TOP_CENTER,
        Ba = Phaser.Utils.Objects.GetValue,
        _a = Phaser.Math.Clamp,
        ja = Phaser.Math.Linear,
        Da = Phaser.Math.Percent,
        Ia = Phaser.Math.Snap.To,
        Ra = (function () {
            t(c, fr);
            var u = e(c);
            function c(t, e) {
                ...
                B(this, c),
                    ...
                    (i.eventEmitter = Ba(e, "eventEmitter", _(i)));
                var n = Ba(e, "background", void 0),
                    s = Ba(e, "track", void 0),
                    r = Ba(e, "indicator", void 0),
                    o = Ba(e, "thumb", void 0);
                n && i.addBackground(n), s && i.add(s, 1, "center", 0, !0), r && i.pin(r), o && i.pin(o);
                var a = Ba(e, "input", 0);
                switch (("string" == typeof a && (a = Ya[a]), a)) {
                    case 0:
                        o && (o.setInteractive(), i.scene.input.setDraggable(o), o.on("drag", va, _(i)));
                        break;
                    case 1:
                        i.setInteractive().on("pointerdown", pa, _(i)).on("pointermove", pa, _(i));
                }
                i.addChildrenMap("background", n),
                    i.addChildrenMap("track", s),
                    i.addChildrenMap("indicator", r),
                    i.addChildrenMap("thumb", o);
                var h = Ba(e, "valuechangeCallback", null);
                if (null !== h) {
                    var l = Ba(e, "valuechangeCallbackScope", void 0);
                    i.eventEmitter.on("valuechange", h, l);
                }
                return (
                    i.setEnable(Ba(e, "enable", void 0)),
                    i.setGap(Ba(e, "gap", void 0)),
                    i.setValue(Ba(e, "value", 0)),
                    i
                );
            }
            return (
                w(c, [
                    ...
                    },
                    {
                        key: "setValue",
                        value: function (t, e, i) {
                            return null == t || (void 0 !== e && (t = Da(t, e, i)), (this.value = t)), this;
                        },
                    },
                    {
                        key: "addValue",
                        value: function (t, e, i) {
                            return void 0 !== e && (t = Da(t, e, i)), (this.value += t), this;
                        },
                    },
                    {
                        key: "getValue",
                    ...
                    },
                    {
                        ...
                        value: function (t, e, i) {
                            if (this.rexSizer.hidden || !this.dirty) return this;
                            var n = this.getElement("track");
                            return (
                                1 === this.orientation ? ks(n, void 0, 0) : ks(n, 0, void 0),
                                g(p(c.prototype), "_layout", this).call(this, t, e, i),
                                this.updateThumb(),
                    ...
                    },
                    {
                        ...
                        set: function (t) {
                            void 0 !== this.gap && (t = Ia(t, this.gap));
                            var e = this._value;
                            (this._value = _a(t, 0, 1)),
                                e !== this._value &&
        ...
        Ya = { drag: 0, click: 1, none: -1 },
        La = {
            getStartPoint: function (t) {
                if ((void 0 === t && (t = wa), this.childrenMap.thumb)) {
                    var e = 0 === this.orientation ? ka : Ca;
                    ga.call(this, e, t);
                } else
                    0 === this.orientation
                        ? ((t.x = this.left + 1), (t.y = this.centerY))
                        : ((t.x = this.centerX), (t.y = this.top + 1));
                return t;
            },
            getEndPoint: function (t) {
                if ((void 0 === t && (t = Ta), this.childrenMap.thumb)) {
                    var e = 0 === this.orientation ? Sa : Oa;
                    ga.call(this, e, t);
                } else
                    0 === this.orientation
                        ? ((t.x = this.right - 1), (t.y = this.centerY))
                        : ((t.x = this.centerX), (t.y = this.bottom - 1));
                return t;
            },
            ...
            updateIndicator: function (t) {
                ...
                ks(n, e, i);
                var a = 0 === this.orientation ? Ea : za;
                Vn(n, this, a), this.resetChildPositionState(n);
            },
        };
    Object.assign(Ra.prototype, La),
        c.register("slider", function (t) {
            var e = new Ra(this.scene, t);
            return this.scene.add.existing(e), e;
        }),
        ut(window, "RexPlugins.UI.Slider", Ra);
    function Fa(t) {
        var e = Xa(t, "scrollMode", 0);
        return "string" == typeof e && (e = Aa[e]), e;
    }
    var Aa = { v: 0, vertical: 0, h: 1, horizontal: 1 },
        Xa = Phaser.Utils.Objects.GetValue,
        Ha = function (t, e, i) {
        ...
        Ua = (function () {
            function o(t) {
                B(this, o);
                var e = Ha(t, "states", void 0);
                e && this.addStates(e);
                var i = Ha(t, "extend", void 0);
                if (i) for (var n in i) (this.hasOwnProperty(n) && void 0 !== this[n]) || (this[n] = i[n]);
                var s = Ha(t, "eventEmitter", void 0),
                    r = Ha(t, "EventEmitterClass", void 0);
            ...
            return (
                w(o, [
                    ...
                    },
                    {
                        key: "resetFromJSON",
                        value: function (t) {
                            this.setEnable(Ha(t, "enable", !0)), this.start(Ha(t, "start", void 0));
                            var e = Ha(t, "init", void 0);
                    ...
                    },
                    {
                        key: "addState",
                        value: function (t, e) {
                            var i = Ha(e, "next", void 0);
                            i && (this["next_" + t] = i);
                            var n = Ha(e, "exit", void 0);
                            n && (this["exit_" + t] = n);
                            var s = Ha(e, "enter", void 0);
    ...
    var Va = (function () {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var t,
                                e = this.parent;
                            return (
                                e.dragState.isUp && (t = e.outOfBounds ? "BACK" : e.slidingEnable ? "SLIDE" : "IDLE"), t
                            );
                        },
                    },
                    {
        ...
        Wa = Phaser.Utils.Objects.GetValue,
        Ga = Phaser.Math.Distance.Between,
        Na = (function () {
            function i(t, e) {
                B(this, i),
                    (this.gameObject = t),
                    (this.scene = Zn(t)),
                    this.setEventEmitter(Wa(e, "eventEmitter", void 0)),
                    (this._enable = void 0),
                    t.setInteractive(Wa(e, "inputConfig", void 0)),
                    this.resetFromJSON(e),
                    this.boot();
            }
            return (
                w(i, [
                    {
                        ...
                        value: function (t) {
                            return (
                                ...
                                (this.localY = void 0),
                                (this.justMoved = !1),
                                this.setEnable(Wa(t, "enable", !0)),
                                (this.holdThreshold = Wa(t, "holdThreshold", 50)),
                                this
                            );
                        },
                    },
                    ...
                    },
                    {
                        ...
                        set: function (t) {
                            this._enable !== t &&
                                (t || ((this.isInTouched = !1), (this.pointer = void 0)), (this._enable = t));
                        },
                    },
                    {
                        key: "isDown",
                    ...
                    },
                    {
                        ...
                        get: function () {
                            return this.x === this.preX && this.y === this.preY
                                ? 0
                                : Ga(this.preX, this.preY, this.x, this.y) / (0.001 * this.dt);
                        },
                    },
                    {
                        key: "speedX",
    ...
    Object.assign(Na.prototype, ls);
    var Ja = Phaser.Utils.Objects.GetValue,
        Ka = (function () {
            function e(t) {
                ...
                w(e, [
                    {
                        ...
                        value: function (t) {
                            return (
                                this.setValue(Ja(t, "value", 0)),
                                this.setSpeed(Ja(t, "speed", 0)),
                                this.setAcceleration(Ja(t, "acceleration", 0)),
                                this
                            );
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            return (
                                0 !== this.acceleration &&
                                    ((this.speed += this.acceleration * t), this.speed < 0 && (this.speed = 0)),
                                this
                            );
                        },
                    },
        ...
        Za = (function () {
            function t() {
                B(this, t), this.value, this.dir, (this.movement = new Ka());
            }
            return (
                w(t, [
                    {
        ...
        $a = (function () {
            function a(t, e) {
                B(this, a),
                    (this.gameObject = t),
                    (this.scene = Zn(t)),
                    this.setEventEmitter(qa(e, "eventEmitter", void 0));
                var i = qa(e, "enable", !0),
                    n = { enable: i, eventEmitter: !1 };
                this._state = new Va(this, n);
                var s = { inputConfig: qa(e, "inputConfig", void 0), enable: i, eventEmitter: !1 };
                (this.dragState = new Na(t, s)),
                    (this._enable = void 0),
                    (this._value = void 0),
                    (this._slowDown = new Za());
                var r = qa(e, "valuechangeCallback", null);
                if (null !== r) {
                    var o = qa(e, "valuechangeCallbackScope", void 0);
                    this.on("valuechange", r, o);
                }
                if (null !== (r = qa(e, "overmaxCallback", null))) {
                    o = qa(e, "overmaxCallbackScope", void 0);
                    this.on("overmax", r, o);
                }
                if (null !== (r = qa(e, "overminCallback", null))) {
                    o = qa(e, "overminCallbackScope", void 0);
                    this.on("overmin", r, o);
                }
                ...
                w(a, [
                    {
                        key: "resetFromJSON",
                        value: function (t) {
                            this.setOrientationMode(qa(t, "orientation", 0)),
                                this.setDragThreshold(qa(t, "threshold", 10)),
                                this.setSlidingDeceleration(qa(t, "slidingDeceleration", 5e3)),
                                this.setBackDeceleration(qa(t, "backDeceleration", 2e3));
                            var e = qa(t, "bounds", void 0);
                            return (
                                e ? this.setBounds(e) : this.setBounds(qa(t, "max", 0), qa(t, "min", 0)),
                                this.setValue(qa(t, "value", this.maxValue || 0)),
                                this.setEnable(qa(t, "enable", !0)),
                                this
                            );
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            return "string" == typeof t && (t = Qa[t]), (this.orientationMode = t), this;
                        },
                    },
                    {
                        key: "setDragThreshold",
    ...
    Object.assign($a.prototype, ls);
    var Qa = { y: 0, v: 0, vertical: 0, x: 1, h: 1, horizontal: 1 },
        th = Phaser.Utils.Objects.GetValue,
        eh = { right: 0, left: 1, bottom: 0, top: 1 },
        ...
        nh = (function () {
            ...
            function v(t, e) {
                ...
                B(this, v), void 0 === e && (e = {});
                var n = Fa(e);
                (e.orientation = 0 === n ? 1 : 0), ((i = f.call(this, t, e)).type = ih(e, "type", "rexScrollable"));
                var s = ih(e, "background", void 0),
                    r = function (t) {
                        var e,
                            i,
                            n,
                            s = this.scene,
                            r = Fa(t),
                            o = new fr(s, { orientation: r }),
                            a = th(t, "child.gameObject", void 0),
                            h = th(t, "slider", void 0),
                            l = th(t, "scroller", !0);
                        if (a) {
                            var u,
                                c = th(t, "space.child", 0);
                            if (((this.childPadding = {}), "number" != typeof c)) {
                                var d = c;
                                0 === r
                                    ? ((c = th(d, "right", 0)),
                                      (this.childPadding.top = th(d, "top", 0)),
                                      (this.childPadding.bottom = th(d, "bottom", 0)))
                                    : ((c = th(d, "bottom", 0)),
                                      (this.childPadding.top = th(d, "left", 0)),
                                      (this.childPadding.bottom = th(d, "right", 0)));
                            } else (this.childPadding.top = 0), (this.childPadding.bottom = 0);
                            if (h)
                                !0 === h && (h = {}),
                                    "string" == typeof (i = th(h, "position", 0)) && (i = eh[i]),
                                    (u =
                                        0 === r
                                            ? 0 === i
                                                ? { left: c }
                                            ...
                                            ? { top: c }
                                            : { bottom: c }),
                                    (h.orientation = 0 === o.orientation ? 1 : 0),
                                    (e = new Ra(s, h));
                            l && (!0 === l && (l = {}), (l.orientation = r), (n = new $a(a, l))),
                                e && 1 === i && o.add(e, 0, "center", u, !0);
                            var f = th(t, "child.proportion", 1),
                                v = th(t, "child.expand", !0);
                            o.add(a, f, "center", 0, v), e && 0 === i && o.add(e, 0, "center", u, !0);
                        }
                        return (
                            e &&
                                e.on(
                            ...
                            this.addChildrenMap("child", a),
                            this.addChildrenMap("slider", e),
                            this.addChildrenMap("scroller", n),
                            o
                        );
                    }.call(_(i), e),
                    o = ih(e, "header", void 0),
                    a = ih(e, "footer", void 0);
                if ((s && i.addBackground(s), o)) {
                    var h = ih(e, "align.header", "center"),
                        l = ih(e, "space.header", 0);
                    c = 0 === n ? { bottom: l } : { right: l };
                    var u = ih(e, "expand.header", !0);
                    i.add(o, 0, h, c, u);
                }
                if ((r && i.add(r, 1, "center", 0, !0), a)) {
                    h = ih(e, "align.footer", "center");
                    var c,
                        d = ih(e, "space.footer", 0);
                    c = 0 === n ? { top: d } : { left: d };
                    u = ih(e, "expand.footer", !0);
                    i.add(a, 0, h, c, u);
                }
                return (
                    i.addChildrenMap("background", s), i.addChildrenMap("header", o), i.addChildrenMap("footer", a), i
                );
            }
            return (
                w(v, [
                    {
                        ...
                        value: function (t, e, i) {
                            return (
                                this.rexSizer.hidden ||
                                    !this.dirty ||
                                    (g(p(v.prototype), "_layout", this).call(this, t, e, i), this.resizeController()),
                                this
                            );
                        },
                    },
    ...
    Object.assign(nh.prototype, sh);
    var rh = {
            enableData: function () {
                return void 0 === this.data && (this.data = {}), this;
            },
            getData: function (t, e) {
                return this.enableData(), void 0 === t ? this.data : Ha(this.data, t, e);
            },
            ...
            clearData: function () {
                return this.data && dt(this.data), this;
            },
            ...
            return (
                w(i, [
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            return (
                                this.container && this.parentContainer.setChildLocalPosition(this.container, t, e), this
                            );
                        },
                    },
                    {
    ...
    function hh(t, e, i) {
        if (e) {
            ...
            for (var n, s, r = t.getBounds(), o = ah(e), a = 0, h = i.length; a < h; a++)
                if (!(n = i[a]).hasOwnProperty("isRexContainerLite") && n !== o && t.getLocalState(n).visible)
                    if (n.getBounds)
                        switch (((s = n.getBounds(s)), mh(r, s))) {
                            case 4:
                                xh(t, n);
                                break;
                            case 0:
                                gh(r, s) || yh(r, s) ? bh(t, n, e) : kh(t, n);
                                break;
                            default:
                                bh(t, n, e);
                        }
    ...
    var fh = Phaser.Utils.Objects.GetValue,
        vh = Phaser.Utils.Array.SpliceOne,
        ph = (function () {
            function i(t, e) {
                B(this, i), (this.parent = t), (this.cells = []), (this.cellPool = new _t()), this.resetFromJSON(e);
            }
            return (
                w(i, [
                    {
                        ...
                        value: function (t) {
                            return (
                                ...
                                this.setDefaultCellHeight(fh(t, "cellHeight", 30)),
                                this.setDefaultCellWidth(fh(t, "cellWidth", 30)),
                                this.initCells(fh(t, "cellsCount", 0)),
                                this.setColumnCount(fh(t, "columns", 1)),
                                this
                            );
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            ...
                            return (
                                i === this.cells.length
                                    ? (this.cells.length = t)
                                    : (1 === e ? vh(this.cells, t) : this.cells.splice(t, e), this.buildCellIndex(t)),
                                this.resetTotalRowsHeight(),
                                this
                            );
                        },
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            return null === e ? (e = new oh(this)) : e.setParent(this), (e.index = t), e;
                        },
                    },
                    {
                        key: "buildCellIndex",
                    ...
                    },
                    {
                        ...
                        set: function (t) {
                            this._nonZeroDeltaHeightCount !== t &&
                                ((this._nonZeroDeltaHeightCount = t), this.resetTotalRowsHeight());
                        },
                    },
                    {
        ...
        gh = Phaser.Geom.Intersects.RectangleToRectangle,
        yh = Phaser.Geom.Rectangle.Overlaps,
        mh = function (t, e) {
            var i = 0,
                n = e.top,
                s = e.bottom,
        ...
        Th = {
            setTableOY: function (t) {
                ...
                this.clampTableOXYMode &&
                    (e.rowCount < e.heightToRowIndex(this.instHeight, !0) ? (t = 0) : s ? (t = i) : r && (t = n));
                return (
            ...
            maskCells: function () {
                ...
                if (1 === this.maskUpdateMode && (0 === this.alpha || !this.visible)) return this;
                for (var t, e = [], i = this.visibleCells.entries, n = 0, s = i.length; n < s; n++)
                    (t = i[n].getContainer()) &&
                        (t.hasOwnProperty("isRexContainerLite") ? t.getAllChildren(e) : e.push(t));
                return hh(this, this.cellsMask, e), this;
            },
            updateTable: function (t) {
                return (
                    void 0 === t && (t = !1),
                    t && (Sh.call(this), uh.call(this)),
                    Sh.call(this),
                    function () {
                            ...
                            for (
                                ...
                                if (this.table.isValidCellIdx(r)) {
                                    ...
                                    this.visibleCells.set(f),
                                        this.preVisibleCells.contains(f) || ch.call(this, f),
                    ...
                    uh.call(this),
                    0 === this.maskUpdateMode && this.maskCells(),
                    this
                );
            },
            ...
            insertNewCells: function (t, e) {
                return (
                    "object" === b(t) && (t = t.index),
                    void 0 === e && (e = 1),
                    e <= 0 || ((t = Oh(t, 0, this.cellsCount)), this.table.insertNewCells(t, e)),
                    this
                );
            },
            removeCells: function (t, e) {
                if (("object" === b(t) && (t = t.index), void 0 === e && (e = 1), t < 0 && ((e += t), (t = 0)), e <= 0))
                    return this;
                if (t > this.cellsCount) return this;
                for (var i, n = t, s = t + e; n < s; n++)
                    (i = this.getCell(n, !1)) &&
                        (this.visibleCells.contains(i) && (lh.call(this, i), this.visibleCells.delete(i)),
            ...
            updateVisibleCell: function (t) {
                var e = this.table.getCell(t, !1);
                return e && e.container && ch.call(this, e), this;
            },
        },
        Ph = Phaser.GameObjects.Group,
        Mh = Phaser.GameObjects.Components,
        Eh = Phaser.Structs.Set,
        ...
        Bh = (function () {
            ...
            function f(t, e, i, n, s, r) {
                ...
                B(this, f),
                    ...
                    (o._tableOX = 0),
                    (o._tableOY = 0),
                    (o.visibleCells = new Eh()),
                    (o.preVisibleCells = new Eh()),
                    (o.execeedTopState = !1),
                    (o.execeedBottomState = !1),
                    (o.execeedLeftState = !1),
                    (o.execeedRightState = !1),
                    zh(r, "reuseCellContainer", !1) && (o.cellContainersPool = new Ph(t));
                var a = zh(r, "cellVisibleCallback", null);
                if (null !== a) {
                    var h = zh(r, "cellVisibleCallbackScope", void 0);
                    o.on("cellvisible", a, h);
                }
                if (null !== (a = zh(r, "cellInvisibleCallback", null))) {
                    h = zh(r, "cellInvisibleCallbackScope", void 0);
                    o.on("cellinvisible", a, h);
                }
                if (
                    (o.setCellsMask(zh(r, "mask", !0)),
                    o.setScrollMode(zh(r, "scrollMode", 0)),
                    o.setClampMode(zh(r, "clamplTableOXY", !0)),
                    0 === o.scrollMode)
                ) {
                    var l = zh(r, "cellWidth", void 0);
                    if (((o.expandCellSize = void 0 === l), void 0 === l)) {
                        var u = zh(r, "columns", 1);
                        r.cellWidth = o.width / u;
                    }
                } else {
                    l = zh(r, "cellHeight", void 0);
                    var c = zh(r, "cellWidth", void 0);
                    (o.expandCellSize = void 0 === l), (r.cellWidth = l), (r.cellHeight = c);
                }
                return (o.table = new ph(_(o), r)), o.updateTable(), o;
            }
            return (
                w(f, [
                    {
                        ...
                        value: function (t) {
                            this.scene &&
                                (1 === this.maskUpdateMode &&
                                    this.scene.game.events.off("poststep", this.maskCells, this),
                                this.table.destroy(t),
                                (this.table = void 0),
                                this.cellContainersPool &&
                                    (this.cellContainersPool.destroy(!0), (this.cellContainersPool = void 0)),
                                g(p(f.prototype), "destroy", this).call(this, t));
                        },
                    },
                    {
                        key: "setScrollMode",
                        value: function (t) {
                            return "string" == typeof t && (t = jh[t.toLowerCase()]), (this.scrollMode = t), this;
                        },
                    },
                    {
                        key: "setClampMode",
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            if (
                                ...
                                var s = new lo(this, 0, i);
                                (this.cellsMask = s.createGeometryMask()),
                                    this.add(s),
                                    "string" == typeof n && (n = Dh[n]),
                                    1 === n && this.scene.game.events.on("poststep", this.maskCells, this);
                            }
                            return this;
                        },
                    },
                    {
                        ...
                        value: function (t, e) {
                            return (
                                (this.width === t && this.height === e) ||
                                    (g(p(f.prototype), "resize", this).call(this, t, e),
                                    this.cellsMask && ks(ah(this.cellsMask), t, e),
                                    this.expandCellSize &&
    ...
    Object.assign(Bh.prototype, Mh.GetBounds, Th);
    function _h(t, e, i, n, s, r) {
        var o;
    ...
    var jh = { v: 0, vertical: 0, h: 1, horizontal: 1 },
        Dh = { update: 0, everyTick: 1 },
        Ih = function (t) {
            ...
            if (i !== e.input.lastOverCellIndex) {
                ...
                (e.input.lastOverCellIndex = i),
                    _h(this.eventEmitter, "cell.out", e, n, void 0, t),
                    _h(this.eventEmitter, "cell.over", e, i, void 0, t);
            }
        },
        Rh = function (t) {
            var e = this.childrenMap.child,
                i = e.input.lastOverCellIndex;
            (e.input.lastOverCellIndex = void 0), _h(this.eventEmitter, "cell.out", e, i, void 0, t);
        },
        Yh = Phaser.Utils.Objects.GetValue,
        Lh = Phaser.Utils.Objects.GetValue,
        Fh = (function () {
            function i(t, e) {
                B(this, i),
                    (this.parent = t),
                    (this._isRunning = !1),
                    (this.tickingState = !1),
                    this.setEventEmitter(Lh(e, "eventEmitter", void 0)),
                    this.setTickingMode(Lh(e, "tickingMode", 1));
            }
            return (
                w(i, [
                    {
                    ...
                    },
                    {
                        key: "setTickingMode",
                        value: function (t) {
                            "string" == typeof t && (t = Ah[t]), (this.tickingMode = t);
                        },
                    },
                    {
                        key: "startTicking",
    ...
    Object.assign(Fh.prototype, ls);
    var Ah = { no: 0, lazy: 1, always: 2 },
        ...
        Hh = (function () {
            ...
            function r(t, e) {
                ...
                return (
                    ...
                    (i.gameObject = t) && t.setInteractive(Xh(e, "inputConfig", void 0)),
                    (i._enable = void 0),
                    i.resetFromJSON(e),
                    i.boot(),
                    i
                ...
                w(r, [
                    {
                        ...
                        value: function (t) {
                            return (
                                this.setEnable(Xh(t, "enable", !0)),
                                void 0 === this.gameObject
                                    ? (this.bounds = Xh(t, "bounds", void 0))
                                    : (this.bounds = void 0),
                                (this.tracerState = Uh),
                                (this.pointer = void 0),
                    ...
                    },
                    {
                        key: "boot",
                        value: function () {
                            g(p(r.prototype), "boot", this).call(this),
                                this.gameObject
                    ...
                    },
                    {
                        ...
                        value: function () {
                            this.gameObject
                                ...
                                (this.lastPointer = void 0),
                                (this.movedState = !1),
                                g(p(r.prototype), "shutdown", this).call(this);
                        },
                    },
                    {
                        key: "destroy",
                        ...
                        value: function (t, e) {
                            this.enable &&
                                ...
                                ((this.bounds && !this.bounds.contains(t.x, t.y)) ||
                                    ...
                                    (this.movedState = !1),
                                    (this.tracerState = Vh),
                                    void 0 === this.gameObject && (this.isTouchingAnyObject = 0 < e.length),
                                    this.onDragStart()));
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            return (
                                this.tracerState === Vh && this.onDragEnd(),
                                (this.pointer = void 0),
                                (this.tracerState = Uh),
                                this
                            );
                    ...
                    { key: "postUpdate", value: function () {} },
                    {
                        key: "startTicking",
                        value: function () {
                            g(p(r.prototype), "startTicking", this).call(this),
                                this.scene.events.on("preupdate", this.preUpdate, this),
                    ...
                    },
                    {
                        key: "stopTicking",
                        value: function () {
                            g(p(r.prototype), "stopTicking", this).call(this),
                                this.scene &&
        ...
        Vh = 1,
        Wh = "IDLE",
        Gh = Phaser.Utils.Objects.GetValue,
        Nh = Phaser.Math.Distance.Between,
        Jh = (function () {
            t(o, Hh);
            var r = e(o);
            function o(t, e) {
                            ...
                            RECOGNIZED: {
                                enter: function () {
                                    n.start(),
                                        ...
                                        n.emit("".concat(n.tapsCount, "tap"), n, n.gameObject, n.lastPointer);
                                },
                            },
                        },
                        init: function () {
                ...
                return i.setRecongizedStateObject(new Ua(s)), i;
            }
            return (
                w(o, [
                    {
                        key: "resetFromJSON",
                        value: function (t) {
                            g(p(o.prototype), "resetFromJSON", this).call(this, t),
                                this.setMaxHoldTime(Gh(t, "time", 250)),
                                this.setTapInterval(Gh(t, "tapInterval", 200)),
                                this.setDragThreshold(Gh(t, "threshold", 9)),
                                this.setTapOffset(Gh(t, "tapOffset", 10));
                            var e = Gh(t, "taps", void 0);
                            return (
                                void 0 !== e
                                    ? this.setTaps(e)
                                    : (this.setMaxTaps(Gh(t, "maxTaps", void 0)),
                                      this.setMinTaps(Gh(t, "minTaps", void 0))),
                                this
                            );
                        },
                    },
                        ...
                        value: function () {
                            switch (this.state) {
                                ...
                                case Zh:
                                    ...
                                    Nh(t.upX, t.upY, t.x, t.y) > this.tapOffset &&
                                        ((this.state = qh), (this.state = Zh));
                                    break;
                                case qh:
                                    this.state = Zh;
                            }
                    ...
                    },
                    {
                        ...
                        value: function () {
                            this.state === Zh &&
                                ...
                                void 0 !== this.maxTaps && this.tapsCount === this.maxTaps && (this.state = qh));
                        },
                    },
                    {
                        key: "onDrag",
                        value: function () {
                            this.state !== Kh && this.pointer.getDistance() > this.dragThreshold && (this.state = Kh);
                        },
                    },
                    {
                        key: "preUpdate",
                        value: function (t) {
                            if (this.state === Zh) {
                                ...
                                if (e.isDown) t - e.downTime > this.holdTime && (this.state = Kh);
                                else
        ...
        Qh = Phaser.Utils.Objects.GetValue,
        tl = (function () {
            t(o, Hh);
            var r = e(o);
            function o(t, e) {
                ...
                w(o, [
                    {
                        ...
                        value: function (t) {
                            return (
                                g(p(o.prototype), "resetFromJSON", this).call(this, t),
                                this.setDragThreshold(Qh(t, "threshold", 9)),
                                this.setMinHoldTime(Qh(t, "time", 251)),
                                this
                            );
                        },
                    },
                    {
                        key: "onDragStart",
                        value: function () {
                            (this.state = il), 0 === this.holdTime && (this.state = nl);
                        },
                    },
                    {
                        key: "onDragEnd",
                    ...
                    },
                    {
                        key: "onDrag",
                        value: function () {
                            this.state !== el && this.pointer.getDistance() > this.dragThreshold && (this.state = el);
                        },
                    },
                    {
                        key: "preUpdate",
                        value: function (t) {
                            this.state === il && t - this.pointer.downTime >= this.holdTime && (this.state = nl);
                        },
                    },
                    {
                        key: "setDragThreshold",
        ...
        rl = Phaser.Math.Distance.Between,
        ol = Phaser.Math.Angle.Between,
        al = {
            getDt: function () {
                return this.scene.sys.game.loop.delta;
            },
            getVelocity: function () {
                ...
                return rl(e.x, e.y, t.x, t.y) / (0.001 * this.getDt());
            },
            ...
            getVelocityAngle: function () {
                var t = this.pointer.position,
                    e = this.pointer.prevPosition;
                return ol(e.x, e.y, t.x, t.y);
            },
        },
        hl = { "up&down": 0, "left&right": 1, "4dir": 2, "8dir": 3 },
        ll = {},
        ul = Phaser.Utils.Objects.GetValue,
        cl = Phaser.Math.RadToDeg,
        dl = (function () {
            t(o, Hh);
            var r = e(o);
            function o(t, e) {
                ...
                return i.setRecongizedStateObject(new Ua(s)), i.clearDirectionStates(), i;
            }
            return (
                w(o, [
                    {
                        ...
                        value: function (t) {
                            return (
                                g(p(o.prototype), "resetFromJSON", this).call(this, t),
                                this.setDragThreshold(ul(t, "threshold", 10)),
                                this.setMinDragVelocity(ul(t, "velocityThreshold", 1e3)),
                                this.setDirectionMode(ul(t, "dir", "8dir")),
                                this
                            );
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function () {
                            this.state === pl &&
                                (this.vaildDrag ||
                                    (this.vaildDrag =
                                        0 === this.dragThreshold || this.pointer.getDistance() >= this.dragThreshold),
                                this.vaildDrag && this.dragVelocity > this.minDragVelocity && (this.state = gl));
                        },
                    },
                    {
                        key: "postUpdate",
                        value: function () {
                            this.state === gl && (this.state = vl);
                        },
                    },
                    {
                        key: "setDragThreshold",
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            return "string" == typeof t && (t = hl[t]), (this.dirMode = t), this;
                        },
                    },
                    {
                        ...
                        value: function () {
                            return (
                                ...
                                })(cl(this.getVelocityAngle()), this.dirMode, this),
                                this
                            );
                        },
                    },
        ...
        t.setInteractive(),
            function (e) {
                e.on(
                    "pointerdown",
                    function (t) {
                        _h(this.eventEmitter, "cell.down", e, t.x, t.y, t);
                    },
                    this,
                ).on(
                    "pointerup",
                    function (t) {
                        _h(this.eventEmitter, "cell.up", e, t.x, t.y, t);
                    },
                    this,
                );
            }.call(this, t, e),
            function (t) {
                t.on("pointermove", Ih, this).on("pointerover", Ih, this).on("pointerout", Rh, this);
            }.call(this, t, e),
            function (t, e) {
                var i = Yh(e, "button", void 0);
                !1 !== i &&
                    (void 0 === i && (i = {}),
                    (i.threshold = 10),
                    (t._click = new go(t, i)),
                    t._click.on(
                        "click",
                        function (t, e, i) {
                            _h(this.eventEmitter, "cell.click", e, i.x, i.y, i);
                        },
                        this,
                    ));
            }.call(this, t, e),
            function (t, e) {
                var i = $h(e, "tap", void 0);
                !1 !== i &&
                    ((t._tap = new Jh(t, i)),
                    t._tap.on(
                        "tap",
                        function (t, e, i) {
                            ...
                            _h(this.eventEmitter, n, t.gameObject, t.x, t.y, i);
                        },
                        this,
                    ));
            }.call(this, t, e),
            function (n, t) {
                var e = sl(t, "press", void 0);
                !1 !== e &&
                    ((n._press = new tl(n, e)),
                    n._press
                        .on(
                            "pressstart",
                            function (t, e, i) {
                                _h(this.eventEmitter, "cell.pressstart", n, t.x, t.y, i);
                            },
                            this,
                        )
                        .on(
                            "pressend",
                            function (t, e, i) {
                                _h(this.eventEmitter, "cell.pressend", n, t.x, t.y, i);
                            },
                            this,
                        ));
            }.call(this, t, e),
            function (s, t) {
                var e = yl(t, "swipe", void 0);
                !1 !== e &&
                    (void 0 === e && (e = {}),
                    (e.dir = "4dir"),
                    (s._swipe = new dl(s, e)),
                    s._swipe.on(
                        ...
                        function (t, e, i) {
                            ...
                            _h(this.eventEmitter, "cell.swipe".concat(n), s, t.x, t.y, i);
                        },
                        this,
                    ));
            }.call(this, t, e);
    ...
    var vl = "IDLE",
        ...
        ml = Phaser.Utils.Objects.GetValue,
        xl = (function () {
            t(p, nh);
            var v = e(p);
            function p(t, e) {
                ...
                var n = Fa(e),
                    s = ml(e, "table", void 0);
                void 0 === s && (s = {}), (s.scrollMode = n), (s.clamplTableOXY = ml(e, "clamplChildOY", !1));
                var r,
                    o,
                    a,
                    h = ml(s, "width", void 0),
                    l = ml(s, "height", void 0),
                    u = new Bh(t, 0, 0, h, l, s);
                t.add.existing(u),
                    (o =
                        0 === n
                            ? ((r = void 0 === h ? 1 : 0), void 0 === l)
                            : ((r = void 0 === l ? 1 : 0), void 0 === h)),
                    (a = u),
                    Object.defineProperty(a, "childOY", {
                        configurable: !0,
                        get: function () {
                            return a.tableOY;
                        },
                ...
                var c = ml(e, "space", void 0);
                c && (c.child = c.table),
                    (i = v.call(this, t, e)).addChildrenMap("table", u),
                    (i.eventEmitter = ml(e, "eventEmitter", _(i)));
                var d = ml(e, "createCellContainerCallback", vt),
                    f = ml(e, "createCellContainerCallbackScope", void 0);
                return (
                    ...
                    ml(s, "interactive", !0) && fl.call(_(i), u, s),
                    i.setItems(ml(e, "items", [])),
                    i
                );
            }
            return (
    ...
    Object.assign(xl.prototype, bl),
        c.register("gridTable", function (t) {
            var e = new xl(this.scene, t);
            return this.scene.add.existing(e), e;
        }),
        ut(window, "RexPlugins.UI.GridTable", xl);
    function kl(t, e) {
    ...
    var Cl = {
            expandSubMenu: function (t, e) {
                ...
                this.collapseSubMenu(),
                    (i = this.root.toggleOrientation ? (0 === this.orientation ? 1 : 0) : this.orientation);
            ...
            collapse: function () {
                return (
                    ...
                    this.scaleDownDestroy(kl(this, this.root.easeOut)),
                    this.collapseSubMenu(),
                    this
                );
            },
        ...
        Sl = (function () {
            ...
            function b(t, e) {
                var i;
                B(this, b), void 0 === e && (e = {}), e.hasOwnProperty("orientation") || (e.orientation = 1);
                var n,
                    s,
                    r,
                    o,
                    ...
                    u = e._parentButton,
                    c = wl(e, "items", void 0),
                    d = wl(e, "createBackgroundCallback", void 0),
                    f = wl(e, "createBackgroundCallbackScope", void 0);
                e.background =
                    ((n = t),
                    (s = c),
                    (o = f),
                    (r = d) && ((s.scene = n), (a = o ? r.call(o, s) : r(s)), (s.scene = void 0)),
                    a);
                var v = wl(e, "createButtonCallback", void 0),
                    p = wl(e, "createButtonCallbackScope", void 0);
                (e.buttons = (function (t, e, i, n) {
                    ...
                    if (e && i)
                        for (var a = 0, h = e.length; a < h; a++)
                            ((s = e[a]).scene = t),
                                (r = n ? i.call(n, s, a, e) : i(s, a, e)),
                                (s.scene = void 0),
                                o.push(r);
                    return o;
                })(t, c, v, p)),
                    ((i = x.call(this, t, e)).type = "rexMenu"),
                    (i.items = c),
                    (i.root = void 0 === h ? _(i) : h),
                    (i.parentMenu = l),
                    (i.parentButton = u);
                var g = i.root === _(i);
                g &&
                    (void 0 === (m = e.bounds) && (m = gn(t)),
                    (i.bounds = m),
                    (i.expandEventName = wl(e, "expandEvent", "button.click")),
                    (i.toggleOrientation = wl(e, "toggleOrientation", !1)),
                    (i.easeIn = wl(e, "easeIn", 0)),
                    "number" == typeof i.easeIn && (i.easeIn = { duration: i.easeIn }),
                    (i.easeOut = wl(e, "easeOut", 0)),
                    "number" == typeof i.easeOut && (i.easeOut = { duration: i.easeOut }),
                    (i.createBackgroundCallback = d),
                    (i.createBackgroundCallbackScope = f),
                    (i.createButtonCallback = v),
                    (i.createButtonCallbackScope = p),
                    (i._isPassedEvent = !1));
                i.setOrigin(0).layout();
                var y,
                    m = i.root.bounds;
                if (g) i.expandOrientation = [i.y < m.centerY ? 1 : 3, i.x < m.centerX ? 0 : 2];
                else
                    switch (i.root.expandOrientation[l.orientation]) {
                        case 0:
                ...
                w(b, [
                    {
                        ...
                        value: function (t) {
                            return (
                                !!g(p(b.prototype), "isInTouching", this).call(this, t) ||
    ...
    Object.assign(Sl.prototype, Cl),
        c.register("menu", function (t) {
            var e = new Sl(this.scene, t);
            return this.scene.add.existing(e), e;
        }),
        ut(window, "RexPlugins.UI.Menu", Sl);
    function Ol(t) {
        return t instanceof Tl;
    }
    var Tl = Phaser.GameObjects.Text,
                ...
                w(i, [
                    {
                        ...
                        value: function (t) {
                            return (
                                this.setText(Pl(t, "text", "")),
                                this.setStartIdx(Pl(t, "start", 0)),
                                this.setPageIdx(Pl(t, "page", -1)),
                                this
                            );
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function () {
                            return (
                                void 0 === this.lines ||
                                    (0 === this.textObjectType ? (this.lines.length = 0) : this.lines.destroy()),
                                (this.gameObject = void 0),
                                (this.scene = void 0),
                                this
                            );
                    ...
                    },
                    {
                        ...
                        value: function () {
                            return (this.textObjectType = Ol(this.gameObject) ? 0 : 1), this;
                        },
                    },
                    {
                        key: "setText",
                        value: function (t, e) {
                            return (
                                ...
                                0 === this.textObjectType
                                    ...
                                    : (this.lines = this.gameObject.getPenManager(this.text, this.lines)),
                    ...
                    },
                    {
                        key: "appendText",
                        value: function (t) {
                            return this.setText(this.text.concat(zl(t))), this;
                        },
                    },
                    {
                        key: "getPage",
                    ...
                    },
                    {
                        key: "setStartIdx",
                        value: function (t) {
                            return (t = Ml(t, 0, this.totalLinesCount - 1)), (this.startLineIdx = t), this;
                        },
                    },
                    {
                        key: "resetPageIdx",
                    ...
                    },
                    {
                        ...
                        get: function () {
                            ...
                            return 0 < t ? t : this.totalLinesCount;
                        },
                    },
                ]),
                i
        ...
        Bl = Phaser.Utils.Objects.GetFastValue,
        ...
        jl = (function () {
            function i(t, e) {
                B(this, i),
                    (this.gameObject = t),
                    (this.scene = Zn(t)),
                    this.setEventEmitter(_l(e, "eventEmitter", void 0)),
                    (this.timer = null),
                    this.resetFromJSON(e),
                    this.boot();
            }
                ...
                w(i, [
                    {
                        key: "resetFromJSON",
                        value: function (t) {
                            this.setTypeMode(_l(t, "typeMode", 0)),
                                this.setTypeSpeed(_l(t, "speed", 333)),
                                (this.setTextCallback = Bl(t, "setTextCallback", null)),
                                (this.setTextCallbackScope = Bl(t, "setTextCallbackScope", null)),
                                (this.typingIdx = Bl(t, "typingIdx", 0)),
                                (this.text = Dl(Bl(t, "text", ""))),
                                (this.textLen = Bl(t, "textLen", 0)),
                                (this.insertIdx = Bl(t, "insertIdx", null));
                            var e = Bl(t, "elapsed", null);
                    ...
                    },
                    {
                        key: "setTypeMode",
                        value: function (t) {
                            return "string" == typeof t && (t = Il[t]), (this.typeMode = t), this;
                        },
                    },
                    {
                        key: "setTypeSpeed",
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            return (this.text = Dl(t)), (this.textLen = this.getTextLength(this.text)), this;
                        },
                    },
                    {
                        key: "onTyping",
                        value: function () {
                            ...
                            this.setText(t),
                                this.emit("type"),
                                this.isLastChar
                                    ? (this.freeTimer(), this.emit("complete", this, this.gameObject))
    ...
    Object.assign(jl.prototype, ls);
    var Dl = function (t) {
            return Array.isArray(t) ? (t = t.join("\n")) : "number" == typeof t && (t = t.toString()), t;
        },
        Il = { "left-to-right": 0, "right-to-left": 1, "middle-to-sides": 2, "sides-to-middle": 3 },
        ...
        Yl = (function () {
            ...
            function r(t, e) {
                var i;
                B(this, r), void 0 === e && (e = { text: Ll(t) }), ((i = s.call(this, t, e)).type = "rexTextBox");
                var n = i.childrenMap.text;
                return (
                    (i.page = new El(n, Rl(e, "page", void 0))),
                    (i.typing = new jl(n, Rl(e, "type", void 0))),
                    i.typing.on("complete", i.onPageEnd, _(i)).on("type", i.onType, _(i)),
                    (i.textWidth = n.width),
    ...
    c.register("textBox", function (t) {
        var e = new Yl(this.scene, t);
        return this.scene.add.existing(e), e;
    }),
        ut(window, "RexPlugins.UI.TextBox", Yl);
    var Fl = Phaser.Utils.Objects.GetValue,
        Al = Phaser.Math.Percent,
        Xl = Phaser.Math.Linear,
        Hl = (function () {
            t(g, fr);
            var p = e(g);
            function g(t, e) {
                ...
                var n,
                    s = Fl(e, "background", void 0),
                    r = Fl(e, "icon", void 0),
                    o = Fl(e, "iconMask", void 0),
                    a = Fl(e, "slider", void 0),
                    h = Fl(e, "text", void 0),
                    l = Fl(e, "space.icon", 0),
                    u = Fl(e, "space.slider", 0);
                s && i.addBackground(s),
                    r &&
                        (0 === i.orientation ? (a || h) && (c = { right: l }) : (a || h) && (c = { bottom: l }),
                        i.add(r, 0, "center", c),
                        (o = o && i.addChildMask(r, r, 1)));
                if (a) {
                    var c, d;
                    if (
                        ((a.orientation = i.orientation),
                        (a.eventEmitter = _(i)),
                        (a.value = null),
                        a.hasOwnProperty("input") || (a.input = -1),
                        (n = new Ra(t, a)),
                        0 === i.orientation ? h && (c = { right: u }) : h && (c = { bottom: u }),
                        0 === i.orientation)
                    )
                        d = void 0 === Fl(a, "width", void 0) ? 1 : 0;
                    else d = void 0 === Fl(a, "height", void 0) ? 1 : 0;
                    i.add(n, d, "center", c);
                }
                h && i.add(h),
                    i.addChildrenMap("background", s),
                    ...
                    i.addChildrenMap("text", h);
                var f = Fl(e, "valuechangeCallback", null);
                if (null !== f) {
                    var v = Fl(e, "valuechangeCallbackScope", void 0);
                    i.on("valuechange", f, v);
                }
                return i.setEnable(Fl(e, "enable", void 0)), i.setValue(Fl(e, "value", 0)), i;
            }
            return (
                w(g, [
                    {
                        ...
                        value: function (t) {
                            return (
                                this.childrenMap.slider ||
                                    (void 0 === t && (t = !0), (this.childrenMap.slider.enable = t)),
                                this
                            );
                        },
                    },
                    {
                        key: "setValue",
                        value: function (t, e, i) {
                            return void 0 !== e && (t = Al(t, e, i)), (this.value = t), this;
                        },
                    },
                    {
                        key: "addValue",
        ...
        Ul = { addChildMask: ao };
    Object.assign(Hl.prototype, Ul),
        c.register("numberBar", function (t) {
            var e = new Hl(this.scene, t);
            return this.scene.add.existing(e), e;
        }),
        ut(window, "RexPlugins.UI.NumberBar", Hl);
    var Vl = Ii.prototype.setChildVisible,
        Wl = {
            ...
            swapPage: function (t) {
                ...
                e &&
                    (0 === this.swapMode
                        ? (Vl.call(this, e, !1), this.emit("pageinvisible", e, this._previousKey, this))
                        : e.destroy()),
                    t && !this.sizerChildren.hasOwnProperty(t) && this.emit("createpage", t, this),
                    (this._currentKey = t);
                var i = this.currentPage;
                return i && (Vl.call(this, i, !0), this.emit("pagevisible", i, this._currentKey, this)), this;
            },
        },
        Gl = Phaser.Utils.Objects.GetValue,
        Nl = (function () {
            t(s, oo);
            var n = e(s);
            function s(t, e) {
                ...
                w(s, [
                    {
                        key: "setSwapMode",
                        value: function (t) {
                            return "string" == typeof t && (t = Jl[t]), (this.swapMode = t), this;
                        },
                    },
                    {
                        key: "previousKey",
    ...
    Object.assign(Nl.prototype, Wl);
    var Jl = { invisible: 0, destroy: 1 };
    c.register("pages", function (t) {
        var e = new Nl(this.scene, t);
        return this.scene.add.existing(e), e;
    }),
        ut(window, "RexPlugins.UI.Pages", Nl);
    function Kl(t) {
    ...
    var $l = Phaser.Display.Align.TOP_LEFT,
        Ql = {
            addChildMask: ao,
            setTextObject: function (t, e) {
                void 0 === e && (e = !0), this.add(t);
                ...
                return (
                    ...
                    (i.expand = !0),
                    (this.textObject = t),
                    (this.textObjectType = Ol(t) ? 0 : 1),
                    (i.preOffsetY = 0),
                    (i.offsetY = 0),
                    e && (this.textMask = this.addChildMask(this.textObject, this)),
                    this
                );
            },
            setText: function (t) {
            ...
            updateTextObject: function () {
                var t = Math.max(Math.floor(Kl.call(this, -this.textOY)), 0),
                    e = Zl.call(this, t) + this.textOY;
                return (
            ...
            _layout: function (t, e, i) {
                ...
                var o,
                    ...
                    c = this.top;
                return (
                    (n = this.textObject).rexSizer.hidden ||
                        ((o = u + (r = (s = n.rexSizer).padding).left),
                        (a = c + r.top),
                        (h = this.width - r.left - r.right),
                        (l = this.height - r.top - r.bottom),
                        function (t, e, i) {
                            if (((i += this.textLineHeight + this.textLineSpacing), t.width !== e || t.height !== i)) {
                                t.setFixedSize(e, i);
                                var n = t.style,
                                    s = Math.max(e, 0),
                                    r = Math.ceil(Kl.call(this, i)) + 1;
                                0 === this.textObjectType ? (n.wordWrapWidth = s) : (n.wrapWidth = s),
                                    (n.maxLines = r),
                                    this.setText();
                            }
                        }.call(this, n, h, l),
                        ...
                        ql.call(this),
                        this.textMask &&
                            (this.textMask.setPosition().resize(), this.resetChildPositionState(this.textMask))),
                    this.layoutBackgrounds(),
                    this.postLayout()
                );
            },
        },
        tu = Phaser.Utils.Objects.IsPlainObject,
        eu = Phaser.Utils.Objects.GetValue,
        iu = (function () {
            t(c, $s);
            var u = e(c);
                ...
                B(this, c),
                    tu(e)
                        ? ((e = eu((r = e), "x", 0)),
                          (i = eu(r, "y", 0)),
                          (n = eu(r, "width", void 0)),
                          (s = eu(r, "height", void 0)))
                        : tu(n) && ((n = eu((r = n), "width", void 0)), (s = eu(r, "height", void 0))),
                    ((o = u.call(this, t, e, i, n, s, r)).type = "rexTextBlock"),
                    (o.textObject = void 0),
                    (o.textMask = void 0),
                    ...
                    (o.execeedTopState = !1),
                    (o.execeedBottomState = !1),
                    o.setClampMode(eu(r, "clamplTextOY", !0));
                var a = eu(r, "background", void 0),
                    h = eu(r, "text", void 0);
                void 0 === h && (h = nu(t));
                var l = eu(r, "textMask", !0);
                return (
                    a && o.addBackground(a),
                    o.setTextObject(h, l),
                    o.addChildrenMap("background", a),
                    o.addChildrenMap("text", h),
                    o
                );
            }
            return (
                w(c, [
                        ...
                        value: function (t) {
                            this.scene &&
                                ...
                                (this.textMask = void 0) === this.lines ||
                                    (0 === this.textObjectType ? (this.lines.length = 0) : this.lines.destroy()),
                                g(p(c.prototype), "destroy", this).call(this, t));
                        },
                    },
                    {
                        key: "setClampMode",
                    ...
                    },
                    {
                        ...
                        get: function () {
                            return Math.floor(Kl.call(this, this.textObject.height));
                        },
                    },
                    {
                        key: "topTextOY",
                    ...
                    },
                    {
                        key: "textHeight",
                        get: function () {
                            return Zl.call(this, this.linesCount);
                        },
                    },
                    {
                        key: "textObjectHeight",
                        get: function () {
                            return this.textObject.height - this.textLineHeight - this.textLineSpacing;
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        set: function (t) {
                            ...
                            this.clampTextOYMode &&
                                (this.visibleLinesCount > this.linesCount ? (t = 0) : n ? (t = e) : s && (t = i)),
    ...
    Object.assign(iu.prototype, Ql),
        c.register("textBlock", function (t, e, i, n, s, r) {
            var o = new iu(this.scene, t, e, i, n, s, r);
            return this.scene.add.existing(o), o;
        }),
        ut(window, "RexPlugins.UI.TextBlock", iu);
    var su = Phaser.Utils.Objects.GetValue,
        ru = (function () {
            t(v, nh);
            var f = e(v);
            function v(t, e) {
                var i;
                B(this, v), void 0 === e && (e = {});
                var n = su(e, "text", void 0),
                    s = su(e, "textWidth", void 0),
                    r = su(e, "textHeight", void 0),
                    o = su(e, "textMask", !0),
                    a = su(e, "content", ""),
                    h = new iu(t, {
                        width: s,
                        ...
                        textMask: o,
                        content: a,
                        clamplTextOY: su(e, "clamplChildOY", !1),
                    });
                t.add.existing(h);
                var l,
                    u = void 0 === s ? 1 : 0,
                ...
                (l = h),
                    ...
                    (e.scrollMode = 0),
                    (e.type = "rexTextArea"),
                    (e.child = { gameObject: h, proportion: u, expand: c });
                var d = su(e, "space", void 0);
    ...
    Object.assign(ru.prototype, ou),
        c.register("textArea", function (t) {
            var e = new ru(this.scene, t);
            return this.scene.add.existing(e), e;
        }),
        ut(window, "RexPlugins.UI.TextArea", ru);
    var au = Phaser.Utils.Objects.GetValue,
        hu = Phaser.Display.Align.TOP_LEFT,
        lu = { update: 0, everyTick: 1 },
        uu = {
            addChildMask: ao,
            ...
            maskChildren: function (t) {
                return void 0 === t && (t = this.getAllChildren()), hh(this, this.childrenMask, t), this;
            },
            layoutChildrenMask: function () {
                if (void 0 === this.childrenMask) return this;
                var t = ah(this.childrenMask);
                return t.setPosition().resize(), this.resetChildPositionState(t), this;
            },
        },
        cu = {
            setChild: function (t, e, i) {
                ...
                return (
                    ...
                    !0 === i
                        ...
                        : !1 === i
                        ? (n = !1)
                        : ((n = au(i, "mask", !0)), (s = au(i, "padding", 0)), (r = au(o, "updateMode", 0))),
                    (this.maskUpdateMode = r),
                    n &&
                        ("string" == typeof r && (r = lu[r]),
                        1 === r && this.scene.game.events.on("poststep", this.maskChildren, this),
                        this.enableChildrenMask(s)),
                    this
                );
            },
            getChildrenWidth: function () {
            ...
            resetChildPosition: function () {
                ...
                0 === this.scrollMode ? (e += this.childOY) : (t += this.childOY),
                    ...
                    0 === this.maskUpdateMode && this.maskChildren();
            },
            _layout: function (t, e, i) {
                if (this.rexSizer.hidden || !this.dirty) return this;
                this.preLayout(t),
                ...
                return (
                    r.rexSizer.hidden ||
                        (0 === this.scrollMode ? (n = this.width) : (s = this.height),
                        r.isRexSizer ? r._layout(this, n, s) : ks(r, n, s),
    ...
    Object.assign(cu, uu);
    var du = Phaser.Utils.Objects.IsPlainObject,
        fu = Phaser.Utils.Objects.GetValue,
        vu = (function () {
            t(c, $s);
            var u = e(c);
            function c(t, e, i, n, s, r) {
                ...
                B(this, c),
                    du(e)
                        ? ((e = fu((r = e), "x", 0)),
                          (i = fu(r, "y", 0)),
                          (n = fu(r, "width", void 0)),
                          (s = fu(r, "height", void 0)))
                        : du(n) && ((n = fu((r = n), "width", void 0)), (s = fu(r, "height", void 0))),
                    ((o = u.call(this, t, e, i, n, s, r)).type = "rexScrollableBlock"),
                    (o.child = void 0),
                    (o.childrenMask = void 0),
                    (o._childOY = 0),
                    (o.execeedTopState = !1),
                    (o.execeedBottomState = !1),
                    o.setScrollMode(fu(r, "scrollMode", !0)),
                    o.setClampMode(fu(r, "clamplChildOY", !0));
                var a = fu(r, "child", void 0),
                    h = fu(r, "expand", !0),
                    l = fu(r, "mask", void 0);
                return o.setChild(a, h, l), o;
            }
            return (
                w(c, [
                    {
                    ...
                    },
                    {
                        key: "setScrollMode",
                        value: function (t) {
                            return "string" == typeof t && (t = Aa[t.toLowerCase()]), (this.scrollMode = t), this;
                        },
                    },
                    {
                        key: "setClampMode",
                    ...
                    },
                    {
                        key: "childHeight",
                        get: function () {
                            return (0 === this.scrollMode ? Cn : kn)(this.child);
                        },
                    },
                    {
                        key: "childWidth",
                        get: function () {
                            return (0 === this.scrollMode ? kn : Cn)(this.child);
                        },
                    },
                    {
                        key: "topChildOY",
                    ...
                    },
                    {
                        ...
                        set: function (t) {
                            ...
                            this.clampChildOYMode &&
                                (this.instHeight > this.childHeight ? (t = 0) : n ? (t = e) : s && (t = i)),
    ...
    Object.assign(vu.prototype, cu),
        c.register("scrollableBlock", function (t) {
            var e = new vu(this.scene, t);
            return this.scene.add.existing(e), e;
        }),
        ut(window, "RexPlugins.UI.ScrollableBlock", vu);
    var pu = Phaser.Utils.Objects.GetValue,
        gu = (function () {
            t(d, nh);
            var c = e(d);
            function d(t, e) {
                ...
                var n = Fa(e),
                    s = pu(e, "panel", void 0);
                void 0 === s && (s = {}), (s.scrollMode = n), (s.clamplChildOY = pu(e, "clamplChildOY", !1));
                var r = new vu(t, s);
                t.add.existing(r);
                var o,
                    a,
                    h = pu(s, "width", void 0),
                    l = pu(s, "height", void 0);
                (a = 0 === n ? ((o = void 0 === h ? 1 : 0), void 0 === l) : ((o = void 0 === l ? 1 : 0), void 0 === h)),
                    (e.type = "rexScrollablePanel"),
                    (e.child = { gameObject: r, proportion: o, expand: a });
                var u = pu(e, "space", void 0);
                return (
                    u && (u.child = u.panel),
                    (i = c.call(this, t, e)).addChildrenMap("panel", i.childrenMap.child.child),
                    i
                );
            }
            return d;
        })();
    c.register("scrollablePanel", function (t) {
        var e = new gu(this.scene, t);
        return this.scene.add.existing(e), e;
    }),
        ut(window, "RexPlugins.UI.ScrollablePanel", gu);
    function yu(t, e, i, n) {
    ...
    function xu(t, e, i) {
        var n,
            s = Tu(i, "reverse", !1);
        if (yi(t[0]))
            if (s) for (r = (o = t.length) - 1; 0 <= r; r--) n = xu(t[r], e, i);
            else for (var r = 0, o = t.length; r < o; r++) n = xu(t[r], e, i);
        else n = Pu(t, e, i);
        return n;
    }
    var bu = { popUp: 0, fadeIn: 1, scaleDown: 0, fadeOut: 1 },
        ku = function (t, e) {
            t.popUp(e);
        },
        Cu = function (t, e) {
        ...
        Ou = /^\s*-?(\d*\.?\d+|\d+\.?\d*)(e[-+]?\d+)?\s*$/i,
        Tu = Phaser.Utils.Objects.GetValue,
        Pu = function (t, e, i) {
            var n,
                s = Tu(i, "argsConvert", void 0),
                r = Tu(i, "argsConvertScope", void 0),
                o = t[0];
            if (((Mu = yu(Mu, t, 1)), s)) {
                !0 === s && ((s = mu), (r = void 0));
                for (var a = 0, h = Mu.length; a < h; a++) Mu[a] = r ? s.call(r, Mu[a], t) : s(Mu[a], t);
            }
            return "string" == typeof o ? null == (n = e[o]) && (n = Tu(e, o, null)) : (n = o), n.apply(e, Mu);
        },
        Mu = [],
        Eu = (function () {
            t(s, Fh);
                ...
                w(s, [
                    {
                        ...
                        value: function (t) {
                            return (
                                (this.isRunning = Ha(t, "isRunning", !1)),
                                (this.state = Ha(t, "state", 0)),
                                (this.commands = Ha(t, "commands", [])),
                                (this.scope = Ha(t, "scope", void 0)),
                                this.setTimeUnit(Ha(t, "timeUnit", 0)),
                                this.setDtMode(Ha(t, "dtMode", 0)),
                                this.setTimeScale(Ha(t, "timeScale", 1)),
                                (this.index = Ha(t, "index", 0)),
                                (this.nextDt = Ha(t, "nextDt", 0)),
                                this.seek(Ha(t, "now", 0)),
                                (this.timeScale = Ha(t, "timeScale", 1)),
                                this
                            );
                        },
                    },
                    ...
                    },
                    {
                        key: "boot",
                        value: function () {
                            g(p(s.prototype), "boot", this).call(this);
                            var t,
                                e = ((t = this.parent), Kn(t) ? t.events : t.on ? t : void 0);
                            e && e.on("destroy", this.destroy, this);
                        },
                    },
                    {
                        key: "shutdown",
                        value: function () {
                            g(p(s.prototype), "shutdown", this).call(this),
                                (this.parent = void 0),
                                (this.scene = void 0),
                    ...
                    },
                    {
                        key: "startTicking",
                        value: function () {
                            g(p(s.prototype), "startTicking", this).call(this),
                    ...
                    },
                    {
                        key: "stopTicking",
                        value: function () {
                            g(p(s.prototype), "stopTicking", this).call(this),
                    ...
                    },
                    {
                        ...
                        value: function (t, e, i) {
                            this.stop();
                            var n = Ha(i, "timeUnit", void 0);
                            void 0 !== n && this.setTimeUnit(n);
                            var s = Ha(i, "dtMode", void 0);
                            return (
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            ...
                            for (;;) {
                                ...
                                if ((this.index++, (this.nextDt = this.getNextDt(this.nextDt)), this.nextDt > this.now))
                                    return this;
                            }
                        },
                    },
                    {
                        key: "complete",
                        value: function () {
                            g(p(s.prototype), "complete", this).call(this), (this.state = 2);
                        },
                    },
                    {
                        key: "getNextDt",
                    ...
                    },
                    {
                        key: "setDtMode",
                        value: function (t) {
                            return "string" == typeof t && (t = _u[t]), (this.dtMode = t), this;
                        },
                    },
                    {
                        key: "setTimeUnit",
                        value: function (t) {
                            return "string" == typeof t && (t = Bu[t]), (this.timeUnit = t), this;
                        },
                    },
                    {
                        key: "isPlaying",
        ...
        zu = [],
        Bu = { ms: 0, s: 1, sec: 1 },
        _u = { abs: 0, absolute: 0, inc: 1, increment: 1 },
        ...
        Du = (function () {
            ...
            function s(t, e) {
                ...
                return (
                    ...
                    i.setTransitInTime(ju(e, "duration.in", 200)),
                    i.setDisplayTime(ju(e, "duration.hold", 1200)),
                    i.setTransitOutTime(ju(e, "duration.out", 200)),
                    i.setTransitInCallback(ju(e, "transitIn", bu.popUp)),
                    i.setTransitOutCallback(ju(e, "transitOut", bu.scaleDown)),
                    (i.player = new Eu(_(i), { dtMode: 1 })),
                    (i.messages = []),
                    i.setVisible(!1),
                    i
                );
                ...
                w(s, [
                    {
                        ...
                        value: function (t) {
                            this.scene &&
                                ...
                                g(p(s.prototype), "destroy", this).call(this, t));
                        },
                    },
                    {
                        key: "setDisplayTime",
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            switch (("string" == typeof t && (t = bu[t]), t)) {
                                case bu.popUp:
                                    t = ku;
                                    break;
                                case bu.fadeIn:
    ...
    c.register("toast", function (t) {
        var e = new Du(this.scene, t);
        return this.scene.add.existing(e), e;
    }),
        ut(window, "RexPlugins.UI.Toast", Du);
    function Iu(s, r) {
    ...
    var Yu = {
            ...
            move: { show: Iu, hide: Iu },
            "move-panel": { show: Ru, hide: Ru },
        },
        Lu = Ii.prototype.setChildVisible,
        Fu = {
            setChildVisible: function (t, e) {
                if ("string" == typeof t) {
                    var i = t;
                    t = this.sizerChildren[i];
                } else i = no(this.sizerChildren, t);
                return void 0 === e && (e = this.currentChildKey === i), Lu.call(this, t, e), this;
            },
        },
        Au = {
            fadeChild: function (t, e, i) {
                var n;
                return (
                    "string" == typeof t ? ((n = t), (t = this.sizerChildren[n])) : (n = no(this.sizerChildren, t)),
                    void 0 === e && (e = 500),
            ...
            fadeChildPromise: function (t, e, i) {
                return (
                    ...
                    t._fade ? ps(t._fade) : Promise.resolve()
                );
            },
        },
        Xu = {
            moveChild: function (t, e, i, n) {
                var s;
                "string" == typeof t ? ((s = t), (t = this.sizerChildren[s])) : (s = no(this.sizerChildren, t)),
                    void 0 === e && (e = 500);
                var r,
                    o,
                    a,
                        ...
                        default:
                            if (l)
                                switch (this.previousChildKey) {
                                    case "leftSide":
                                    case "rightSide":
                                        n = kn(this.sizerChildren[this.previousChildKey]);
                                        break;
                                    case "topSide":
                                    case "bottomSide":
                                        n = Cn(this.sizerChildren[this.previousChildKey]);
                                        break;
                                    default:
                                        n = 0;
                                }
                                ...
                                switch (this.currentChildKey) {
                                    case "leftSide":
                                    case "rightSide":
                                        n = kn(this.sizerChildren[this.currentChildKey]);
                                        break;
                                    case "topSide":
                                    case "bottomSide":
                                        n = Cn(this.sizerChildren[this.currentChildKey]);
                                        break;
                                    default:
                                        n = 0;
                                }
            ...
            moveChildPromise: function (t, e, i, n) {
                return (
                    ...
                    t._easeMove ? ps(t._easeMove) : Promise.resolve()
                );
            },
        },
        Hu = {};
    Object.assign(Hu, Fu, Au, Xu);
    var Uu = Phaser.Utils.Objects.GetValue,
        Vu = (function () {
            t(C, oo);
            var k = e(C);
            function C(t, e) {
                var i;
                B(this, C),
                    ((i = k.call(this, t, e)).type = "rexSides"),
                    (i.childrenMap = i.sizerChildren),
                ...
                var n,
                    ...
                    a,
                    h,
                    l = Uu(e, "showChildCallback", void 0);
                if (l)
                    if (ms(l)) {
                        var u = Uu(e, "showChildCallbackScope", void 0);
                        i.on("showchild", l, u);
                        var c = Uu(e, "hideChildCallback", void 0),
                            d = Uu(e, "hideChildCallbackScope", void 0);
                        i.on("hidechild", c, d);
                    } else {
                        var f =
                            ((h = S("string" == typeof (n = l) ? [n] : n)),
                            (s = h[0]),
                            (r = h.slice(1)),
                            (a = Yu.hasOwnProperty(s)
                                ? ((o = Yu[s].show.apply(null, r)), Yu[s].hide.apply(null, r))
                                : (o = vt)),
                            { show: o, hide: a });
                        i.on("showchild", f.show), i.on("hidechild", f.hide);
                    }
                var v = Uu(e, "background", void 0),
                    p = Uu(e, "panel", void 0),
                    g = Uu(e, "leftSide", void 0),
                    y = Uu(e, "rightSide", void 0),
                    m = Uu(e, "topSide", void 0),
                    x = Uu(e, "bottomSide", void 0);
                if ((v && i.addBackground(v), p && i.add(p, "panel", "center", 0, !0), g)) {
                    var b = Uu(e, "expand.left", !0);
                    i.add(g, "leftSide", "left-top", 0, { height: b });
                }
                if (y) {
                    b = Uu(e, "expand.right", !0);
                    i.add(y, "rightSide", "right-top", 0, { height: b });
                }
                if (m) {
                    b = Uu(e, "expand.top", !0);
                    i.add(m, "topSide", "left-top", 0, { width: b });
                }
                if (x) {
                    b = Uu(e, "expand.bottom", !0);
                    i.add(x, "bottomSide", "left-bottom", 0, { width: b });
                }
                return i;
            }
            return (
    ...
    Object.assign(
        ...
        c.register("sides", function (t) {
            var e = new Vu(this.scene, t);
            return this.scene.add.existing(e), e;
        }),
        ut(window, "RexPlugins.UI.Sides", Vu),
        c.register("click", function (t, e) {
            return qn(t) || ((e = t), (t = this.scene)), new go(t, e);
        }),
        ut(window, "RexPlugins.UI.Click", go),
        c.register("tap", function (t, e) {
            return qn(t) || ((e = t), (t = this.scene)), new Jh(t, e);
        }),
        ut(window, "RexPlugins.UI.Tap", Jh),
        c.register("press", function (t, e) {
            return qn(t) || ((e = t), (t = this.scene)), new tl(t, e);
        }),
        ut(window, "RexPlugins.UI.Press", tl),
        c.register("swipe", function (t, e) {
            return qn(t) || ((e = t), (t = this.scene)), new dl(t, e);
        }),
        ut(window, "RexPlugins.UI.Swipe", dl);
    var Wu = Phaser.Utils.Objects.GetValue,
        Gu = (function () {
            t(o, Hh);
            var r = e(o);
            function o(t, e) {
                ...
                w(o, [
                    {
                        ...
                        value: function (t) {
                            return (
                                g(p(o.prototype), "resetFromJSON", this).call(this, t),
                                this.setDragThreshold(Wu(t, "threshold", 10)),
                                this
                            );
                        },
                    },
                    {
                        key: "onDragStart",
                        value: function () {
                            (this.state = Ju), 0 === this.dragThreshold && (this.state = Ku);
                        },
                    },
                    {
                        key: "onDragEnd",
                    ...
                    },
                    {
                        ...
                        value: function () {
                            switch (this.state) {
                                case Ju:
                                    this.pointer.getDistance() >= this.dragThreshold && (this.state = Ku);
                                    break;
                                case Ku:
                                    var t = this.pointer.position,
                                        e = this.pointer.prevPosition;
        ...
        Ju = "BEGIN",
        Ku = "RECOGNIZED";
    c.register("pan", function (t, e) {
        return qn(t) || ((e = t), (t = this.scene)), new Gu(t, e);
    }),
        ut(window, "RexPlugins.UI.Pan", Gu);
    var Zu = Phaser.Utils.Objects.GetValue,
        qu = Phaser.Utils.Array.SpliceOne,
        $u = Phaser.Math.Distance.Between,
        Qu = Phaser.Math.Angle.Between,
        tc = (function () {
            function n(t, e) {
                B(this, n);
                ...
                i < 2 && t.input.addPointer(2 - i),
                    (this.scene = t),
                    this.setEventEmitter(Zu(e, "eventEmitter", void 0)),
                    (this._enable = void 0),
                    (this.pointers = []),
                    (this.movedState = {}),
                    this.resetFromJSON(e),
                ...
                w(n, [
                    {
                        ...
                        value: function (t) {
                            return (
                                this.setEnable(Zu(t, "enable", !0)),
                                (this.bounds = Zu(t, "bounds", void 0)),
                                (this.tracerState = ic),
                        ...
                        value: function (t) {
                            if (
                                ...
                                switch (((this.movedState[t.id] = !1), this.pointers.push(t), this.tracerState)) {
                                    case ic:
                                        (this.tracerState = nc), this.onDrag1Start();
                                        break;
                                    case nc:
                                        (this.tracerState = sc), this.onDrag2Start();
                                }
                        },
                    },
                    {
                        ...
                        value: function (t) {
                            if (this.enable && (!this.bounds || this.bounds.contains(t.x, t.y))) {
                                ...
                                if (-1 !== e)
                                    switch ((delete this.movedState[t.id], qu(this.pointers, e), this.tracerState)) {
                                        case nc:
                                            (this.tracerState = ic), this.onDrag1End();
                                            break;
                                        case sc:
                                            (this.tracerState = nc), this.onDrag2End(), this.onDrag1Start();
                                    }
                            }
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function () {
                            return (
                                this.tracerState === sc && this.onDrag2End(),
                                (this.pointers.length = 0),
                                dt(this.movedState),
                                (this.tracerState = ic),
                                this
                    ...
                    },
                    {
                        key: "distanceBetween",
                        get: function () {
                            if (this.tracerState !== sc) return 0;
    ...
    var ec = {},
                ...
                w(o, [
                    {
                        ...
                        value: function (t) {
                            return (
                                g(p(o.prototype), "resetFromJSON", this).call(this, t),
                                this.setDragThreshold(oc(t, "threshold", 0)),
                                this
                            );
                        },
                    },
                    {
                        ...
                        value: function () {
                            (this.scaleFactor = 1),
                                ...
                                (this.state = lc),
                                0 === this.dragThreshold && (this.state = uc);
                        },
                    },
                    {
                        key: "onDrag2End",
        ...
        lc = "BEGIN",
        uc = "RECOGNIZED";
    c.register("pinch", function (t) {
        return new ac(this.scene, t);
    }),
        ut(window, "RexPlugins.UI.Pinch", ac);
    function cc(t, e, i, n) {
        return dc(t, e, i, n), (t.rotation += n), t;
    }
    var dc = Phaser.Math.RotateAround,
        fc = {},
        vc = Phaser.Utils.Objects.GetValue,
        pc = Phaser.Math.Angle.WrapDegrees,
        gc = Phaser.Math.Angle.ShortestBetween,
        yc = Phaser.Math.RadToDeg,
                ...
                w(o, [
                    {
                        ...
                        value: function (t) {
                            return (
                                g(p(o.prototype), "resetFromJSON", this).call(this, t),
                                this.setDragThreshold(vc(t, "threshold", 0)),
                                this
                            );
                        },
                    },
                    {
                        key: "onDrag2Start",
                        value: function () {
                            (this.prevAngle = pc(yc(this.angleBetween))),
                                (this.state = Cc),
                                0 === this.rotationThreshold && (this.state = wc);
                        },
                    },
                    {
                        key: "onDrag2End",
                            ...
                            switch (this.state) {
                                case Cc:
                                    if (
                                        ...
                                        (this.angle = gc(this.prevAngle, t)), (this.prevAngle = t), (this.state = wc);
                                    }
                                    break;
                                case wc:
                                    t = pc(yc(this.angleBetween));
                                    (this.angle = gc(this.prevAngle, t)),
                                        (this.prevAngle = t),
                    ...
                    },
                    {
                        key: "isRotation",
                        get: function () {
                            return this.state === wc;
                        },
                    },
                    {
                        key: "rotation",
                        get: function () {
                            return mc(this.angle);
                        },
                    },
                ]),
                o
        ...
        bc = {
            spinObject: function (t, e) {
                ...
                e.getWorldPoint(this.centerX, this.centerY, fc);
                var s = fc.x,
                    r = fc.y,
                    o = this.rotation;
                if (Array.isArray(t))
                    for (var a = t, h = 0, l = a.length; h < l; h++) ((t = a[h]).x += i), (t.y += n), cc(t, s, r, o);
                else (t.x += i), (t.y += n), cc(t, x, y, o);
                return this;
            },
        };
    Object.assign(xc.prototype, bc);
    var kc = "IDLE",
        Cc = "BEGIN",
        wc = "RECOGNIZED";
    c.register("rotate", function (t) {
        return new xc(this.scene, t);
    }),
        ut(window, "RexPlugins.UI.Rotate", xc);
    function Sc(e, i, t) {
        var n;
        if (void 0 === e) (e = t.texture.key), (i = t.frame.name);
        else if (Oc(e)) {
            var s = e;
            (e = Tc(s, "key", t.texture.key)), (i = Tc(s, "frame", t.frame.name));
    ...
    var Oc = Phaser.Utils.Objects.IsPlainObject,
        Tc = Phaser.Utils.Objects.GetValue,
        Pc = Phaser.Utils.Objects.GetValue,
        Mc = Phaser.Utils.Objects.GetAdvancedValue,
        Ec = (function () {
            t(s, fs);
            var n = e(s);
            function s(t, e) {
                ...
                w(s, [
                    {
                        ...
                        value: function (t) {
                            return (
                                this.setOrientation(Pc(t, "orientation", 0)),
                                this.setDelay(Mc(t, "delay", 0)),
                                this.setDuration(Mc(t, "duration", 500)),
                                this.setEase(Pc(t, "ease", "Sine")),
                                this.setFrontFace(Pc(t, "front", void 0)),
                                this.setBackFace(Pc(t, "back", void 0)),
                                this.setFace(Pc(t, "face", 0)),
                                this
                            );
                        },
                    },
                    ...
                    },
                    {
                        key: "setOrientation",
                        value: function (t) {
                            return "string" == typeof t && (t = zc[t]), (this.orientation = t), this;
                        },
                    },
                    {
                        key: "setDelay",
                    ...
                    },
                    {
                        key: "setFrontFace",
                        value: function (t, e) {
                            return (this.frontFaceCallback = Sc(t, e, this.gameObject)), this;
                        },
                    },
                    {
                        key: "setBackFace",
                        value: function (t, e) {
                            return (this.backFaceCallback = Sc(t, e, this.gameObject)), this;
                        },
                    },
                    {
                        key: "start",
                        value: function () {
                            ...
                            return (
                                (t[0 === this.orientation ? "scaleX" : "scaleY"] = { start: 1, to: 0 }),
                                g(p(s.prototype), "start", this).call(this, t),
                                this
                            );
                        },
                    ...
                    },
                    {
                        ...
                        set: function (t) {
                            "string" == typeof t && (t = Bc[t]),
                                0 === (this._face = t) && this.frontFaceCallback
                                    ? this.frontFaceCallback(this.gameObject)
                                    : 1 === t && this.backFaceCallback && this.backFaceCallback(this.gameObject);
                        },
                    },
                ]),
                s
        ...
        zc = { x: 0, horizontal: 0, y: 1, vertical: 1 },
        Bc = { front: 0, back: 1 };
    c.register("flip", function (t, e) {
        return new Ec(t, e);
    }),
        ut(window, "RexPlugins.UI.Flip", Ec);
    function _c(t, e, i) {
        var n, s;
        for (var r in (void 0 === i && (i = {}), t)) (n = t[r]), void 0 !== (s = Rc(e, r, n[1])) && (i[n[0]] = s);
        return i;
    }
    function jc(i, t, n) {
        function e(e) {
    ...
    var Dc = fi,
        Ic = vi,
        Rc = Phaser.Utils.Objects.GetValue,
        Yc = function (t) {
            t.stopPropagation();
        },
        Lc = Phaser.GameObjects.DOMElement,
        Fc = Phaser.Utils.Objects.IsPlainObject,
                ...
                B(this, v),
                    Fc(e)
                        ? ((e = Ac((r = e), "x", 0)),
                          ...
                          (n = Ac(r, "width", 0)),
                          (s = Ac(r, "height", 0)))
                        : Fc(n) && ((n = Ac((r = n), "width", 0)), (s = Ac(r, "height", 0))),
                    void 0 === r && (r = {});
                var h = Ac(r, "type", "text");
                "textarea" === h
                    ? ((a = document.createElement("textarea")).style.resize = "none")
                    : ((a = document.createElement("input")).type = h),
                    _c(Wc, r, a);
                var l = Ac(r, "style", void 0);
                l = _c(Gc, r, l);
                var u,
                    c = a.style;
                for (var d in r) d in Wc || d in Gc || (d in c && (l[d] = r[d]));
                return (
                    (l["box-sizing"] = "border-box"),
                    ((o = f.call(this, t, e, i, a, l)).type = "rexInputText"),
                    o.resize(n, s),
                    jc(_(o), a, Nc),
                    (u = a).addEventListener("touchstart", Yc, !1),
                    u.addEventListener("touchmove", Yc, !1),
                    u.addEventListener("touchend", Yc, !1),
                    u.addEventListener("mousedown", Yc, !1),
                    u.addEventListener("mouseup", Yc, !1),
                    u.addEventListener("mousemove", Yc, !1),
                    o
                );
            }
            return (
        ...
        Hc = {
            resize: function (t, e) {
                if (
                    (this.scene.scale.autoRound && ((t = Math.floor(t)), (e = Math.floor(e))),
                    this.width === t && this.height === e)
                )
                    return this;
    ...
    Object.assign(Xc.prototype, Hc);
    function Uc(t, e, i) {
        for (var n, s = 0, r = t.length; s < r; s++) if (((n = t[s]), xs(n, e, i))) return n.pointToChild(e, i);
        return null;
    }
    function Vc(t, e, i, n, s, r) {
        var o;
        (o = void 0 === s ? n : Uc(i, n, s)) && t.emit(e, o, r);
    }
    var Wc = {
            id: ["id", void 0],
            text: ["value", void 0],
        ...
        Nc = { textchange: "oninput", click: "onclick", dblclick: "ondblclick", focus: "onfocus", blur: "onblur" },
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            void 0 !== $c && $c.close(),
                                ($c = this),
                                ms(t) && ((e = t), (t = void 0)),
                                void 0 === e && (e = Zc(t, "onClose", void 0));
                            var i = Zc(t, "onTextChanged", void 0);
                            return (
                                (this.inputText = (function (t, e) {
                                    void 0 === e && (e = {});
                                    var i = t.scene,
                                        n = t.style,
                                        s = Jc(e, "backgroundColor", n.backgroundColor);
                                    null === s && (s = "transparent"),
                                        (e.text = Jc(e, "text", t.text)),
                                        (e.fontFamily = Jc(e, "fontFamily", n.fontFamily)),
                                        (e.fontSize = Jc(e, "fontSize", n.fontSize)),
                                        (e.color = Jc(e, "color", n.color)),
                                        (e.backgroundColor = s),
                                        (e.align = Jc(e, "align", Kc(n)));
                                    var r = new Xc(i, t.x, t.y, Jc(e, "width", t.width), Jc(e, "height", t.height), e);
        ...
        ed = function (t) {
            var e = Uc(this.input.targetSizers, t.x, t.y),
        ...
        sd = Phaser.Utils.Objects.GetValue,
        rd = Phaser.Utils.Objects.GetValue,
        od = Phaser.Utils.Objects.GetValue,
        ad = (function () {
            t(s, Phaser.Plugins.ScenePlugin);
            var n = e(s);
            function s(t, e) {
                var i;
                return B(this, s), ((i = n.call(this, t, e)).add = new c(t)), i;
            }
            return (
                w(s, [
                    {
        ...
        hd = {
            ...
            isShown: Co,
            edit: function (t, e, i) {
                return t._edit || (t._edit = new qc(t)), t._edit.open(e, i), t._edit;
            },
            isInTouching: ys,
            waitEvent: vs,
            waitComplete: ps,
            setChildrenInteractive: function (t, e) {
                return (
                    t.setInteractive(),
                    (t.eventEmitter = od(e, "eventEmitter", t)),
                    (t.input.targetSizers = od(e, "targets", [t])),
                    (t.input.eventNamePrefix = od(e, "inputEventPrefix", "child.")),
                    function (t) {
                        var e = Qc(t, "click", void 0);
                        !1 !== e &&
                            (void 0 === e && (e = {}),
                            e.hasOwnProperty("threshold") || (e.threshold = 10),
                            (this._click = new go(this, e)),
                            this._click.on(
                                "click",
                                function (t, e, i) {
                                    Vc(
                    ...
                    function (t) {
                        !1 !== td(t, "over", void 0) &&
                            this.on("pointermove", ed, this).on("pointerover", ed, this).on("pointerout", id, this);
                    }.call(t, e),
                    function (t) {
                        var e = nd(t, "tap", void 0);
                        !1 !== e &&
                            ((this._tap = new Jh(this, e)),
                            this._tap.on(
                                "tap",
                                function (t, e, i) {
                                    Vc(
                                        this.eventEmitter,
                                        "".concat(this.input.eventNamePrefix).concat(t.tapsCount, "tap"),
                                        this.input.targetSizers,
                                        t.x,
                                        t.y,
                                        i,
                    ...
                    function (t) {
                        var e = sd(t, "press", void 0);
                        !1 !== e &&
                            ((this._press = new tl(this, e)),
                            this._press
                                .on(
                                    "pressstart",
                                    function (t, e, i) {
                    ...
                    function (t) {
                        var e = rd(t, "swipe", void 0);
                        !1 !== e &&
                            (void 0 === e && (e = {}),
                            (e.dir = "4dir"),
                            (this._swipe = new dl(this, e)),
                            this._swipe.on(
                                "swipe",
                                function (t, e, i) {
                                    var n = t.left ? "left" : t.right ? "right" : t.up ? "up" : "down";
    ...
    return Object.assign(ad.prototype, hd), ad;
});
